...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.entries.*.contextLimits.memoryGetDefaultLines": "Agent memory_get Line Window",
  "agents.entries.*.contextLimits.toolResultMaxChars": "Agent Tool Result Max Chars",
  ...
  "ui.prefs.chatMessageMaxWidth": "Control UI Chat Message Max Width",
  ...
  "memory.search.qmd.extraCollections.name": "QMD Extra Collection Name",
  "memory.search.qmd.extraCollections.pattern": "QMD Extra Collection Pattern",
