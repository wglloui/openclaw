...
export const tr: TranslationMap = {
  common: {
    ...
    refresh: "Yenile",
    retry: "Tekrar dene",
    staleData: "Güncel olmayan veriler gösteriliyor.",
  ...
  channels: {
    ...
    hub: {
      connectedTitle: "Kanallarınız",
      addTitle: "Kanal ekle",
      addSubtitle: "Bir hizmet seçin ve yönlendirmeli kurulumu izleyin.",
      updatedAgo: "{ago} güncellendi",
      noneConnected: "Henüz bağlı kanal yok. Başlamak için aşağıdan bir kanal seçin.",
      partialSnapshot:
        "Bazı kanal kontrolleri, kullanıcı arayüzü için ayrılan süre dolmadan tamamlanamadı.",
      stateRunning: "Çalışıyor",
      stateConfigured: "Yapılandırıldı",
      stateAttention: "İlgilenilmesi gerekiyor",
      setUp: "Kur",
      guidedSetup: "Adım adım yönlendirmeli kurulum",
      openDetails: "Ayrıntıları aç",
      lastMessageAgo: "Son mesaj {ago}",
      browseAllTitle: "Daha fazla kanal…",
      browseAllSubtitle: "Yüklenebilir eklentiler dâhil mevcut tüm kanallara göz atın.",
      runSetup: "Kurulumu çalıştır",
      saveBeforeSetup:
        "Kaydedilmemiş kanal yapılandırması değişiklikleriniz var. Yönlendirmeli kurulumu çalıştırmadan önce bunları kaydedin veya yeniden yükleyin.",
    },
    pairing: {
      title: "DM erişim istekleri",
      subtitle:
        "Eşleştirme korumalı kanallara doğrudan mesaj göndermek için bekleyen kişileri inceleyin.",
      channelFilter: "Kanal",
      accountFilter: "Hesap",
      ...
      approve: "Onayla",
      dismiss: "Yoksay",
      approveAria: "{sender} kişisini {channel} kanalı, {account} hesabı için onayla",
      dismissAria: "{sender} kişisini {channel} kanalı, {account} hesabı için yoksay",
      requested: "İstek zamanı: {ago}",
      expires: "Süre bitişi: {ago}",
      senderDetails: "Gönderen ayrıntıları",
      missingPermission:
        "Bu bağlantının operator.pairing erişimi yok, bu nedenle DM istekleri incelenemez.",
      noAccounts: "Yapılandırılmış hiçbir kanal hesabı DM gönderen eşleştirmesi kullanmıyor.",
      noRequests: "Bekleyen DM erişim isteği yok.",
      noFilteredRequests: "Bu filtrelere uyan bekleyen istek yok.",
      limits:
        "İstekler {minutes} dakika sonra sona erer. Her kanal hesabı en fazla {count} bekleyen istek tutabilir.",
      detailTitle: "DM erişimi",
      detailSubtitle: "Kişilerin doğrudan mesajları aracıya ulaşmadan önce onaylanmaları gerekir.",
      pendingCount: "{count} beklemede",
      noPending: "Bekleyen istek yok",
      review: "İstekleri incele",
      approveDialogTitle: "DM erişimini onayla",
      dismissDialogTitle: "DM erişim isteğini yoksay",
      approveExplanation:
        "Bu, gönderenin aracıyla doğrudan mesajlarda konuşmasını sağlar. Grup erişimi vermez.",
      dismissExplanation:
        "Bu, mevcut isteği kaldırır ancak göndereni engellemez. Daha sonra tekrar erişim isteyebilirler.",
      notifyRequester: "Onaydan sonra isteği yapanı bilgilendir",
      makeCommandOwner: "Bu göndereni ilk komut sahibi de yap",
      commandOwnerHelp:
        "Komut sahipleri ayrıcalıklı komutlar çalıştırabilir ve tehlikeli eylemleri onaylayabilir. Bu seçenek yalnızca hiçbir sahip yapılandırılmadığında kullanılabilir.",
      commandOwnerNeedsAdmin:
        "Hiçbir komut sahibi yapılandırılmadı. İlk sahibi atamak için bu bağlantı operator.admin gerektirir.",
      approvedNotice: "DM erişimi onaylandı.",
      approvedOwnerNotice: "DM erişimi onaylandı ve ilk komut sahibi yapılandırıldı.",
      approvedNotificationFailedNotice:
        "DM erişimi onaylandı, ancak isteği yapan bildirimi iletilemedi.",
      approvedOwnerFailedNotice: "DM erişimi onaylandı, ancak ilk komut sahibi yapılandırılamadı.",
      approvedFollowupsFailedNotice:
        "DM erişimi onaylandı, ancak isteği yapan bildirimi ve komut sahibi kurulumunun ikisi de başarısız oldu.",
      dismissedNotice: "DM erişim isteği yoksayıldı. Gönderen tekrar erişim isteyebilir.",
    },
    setup: {
      dialogLabel: "{channel} kanalını kur",
      title: "{channel} kanalını kur",
      genericTitle: "bir kanal",
      subtitle: "Kısa bir yönlendirmeli kurulum — daha sonra her şeyi ince ayarlayabilirsiniz.",
      starting: "Kurulum başlatılıyor…",
      working: "Çalışıyor…",
      sessionExpired:
        "Bu kurulum oturumu Gateway yeniden başlatıldıktan sonra sona erdi. Bu iletişim kutusunu kapatın, ardından kanal kurulumunu tekrar başlatın.",
      continue: "Devam et",
      finish: "Bitir",
      copyText: "Kopyala",
      ...
      whatsappQrLoading: "QR kodu oluşturuluyor…",
      whatsappQrHint: "Eşleştirme kodu oluşturmak için QR'ı Göster'e tıklayın.",
      whatsappLinked: "WhatsApp bağlandı ve hazır.",
      regenerateQr: "Yeni QR kodu",
      linkLater: "Daha sonra bağla",
    },
    config: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Kayıtlı hiçbir WhatsApp oturumu temizlenmedi. Zaten mevcut olmayabilir veya kimlik doğrulama dizini elle temizlenmesi gerekebilir.",
    },
  ...
  agentChip: {
    ...
    agents: "Ajanlar",
    openChat: "{name} ile sohbet et",
    offlineOpenSettings: "Çevrimdışı — Ayarları aç",
    switchAgent: "Aracıyı değiştir",
    working: "Çalışıyor…",
    ready: "Sohbete hazır",
  ...
  newSession: {
    ...
    places: "Yerler",
    recentFolders: "Son kullanılanlar",
    runsOn: "{place} üzerinde çalışır",
    ...
    worktree: "Worktree",
    checkingGit: "Git kullanılabilirliği kontrol ediliyor…",
    gitCheckUnavailable: "Bu klasör için Git doğrulanamadı. Yeniden denemek için tekrar seçin.",
  ...
  sessionsView: {
    ...
    global: "Genel",
    unknown: "Bilinmiyor",
    sessionState: "Konu durumu",
    all: "Tümü",
    sessionArchived: "Konu arşivlendi",
    sessionsArchived: "{count} konu arşivlendi",
    deleteAllArchived: "Tüm arşivlenenleri sil…",
    deleteAllArchivedConfirm: "{count} arşivlenmiş konu ve dökümleri silinsin mi?",
    ...
    runFailedReason: "Çalıştırma başarısız: {reason}",
    ...
    showChildSessions: "{session} için {count} alt oturumu göster",
    hideChildSessions: "{session} için {count} alt oturumu gizle",
    childSessions: "Alt oturumlar",
    showMoreChildren: "{count} tane daha göster",
    archived: "Arşivlendi",
    pinned: "Sabitlenmiş",
    unread: "Unread",
    ...
    cloudWorkerDescendantConflict: "Bulut işçisi alt öğesi: 1 çalışma alanı çakışması",
    cloudWorkerDescendantConflicts: "Bulut işçisi alt öğeleri: {count} çalışma alanı çakışması",
    ...
    invalidEmojiIcon: "Tam olarak bir emoji girin.",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileIdentity: "Gateway profiliniz",
      assistantIdentity: "Asistan kimliği",
      displayName: "Görünen ad",
      displayNamePlaceholder: "Adınız",
      saveProfile: "Adı kaydet",
      saving: "Kaydediliyor…",
      uploading: "İşleniyor…",
      profileHint:
        "JPEG, PNG veya WebP. Görseller ortadan kırpılır ve 512px'e yeniden boyutlandırılır.",
      profileLoadFailed: "Profiliniz yüklenemedi.",
      profileSaveFailed: "Profiliniz kaydedilemedi.",
      avatarInvalid: "Geçerli bir JPEG, PNG veya WebP görseli seçin.",
      avatarTooLarge: "İşlenen avatar hâlâ çok büyük.",
  ...
  configView: {
    ...
    syncedHint: "Cihazlarınız arasında Gateway üzerinden eşitlenir.",
    notifications: {
    ...
    sidebarPrefs: {
      title: "Kenar Çubuğu",
      hint: "Oturumlar çalışırken neyin görüneceğini seçin.",
      liveActivity: "Kenar çubuğunda canlı aracı etkinliğini göster",
      liveActivityHint: "Çalışan oturumların altında en son asistan veya araç etkinliğini göster.",
    },
    sessionObserver: {
      title: "Oturum gözlemcisi",
      hint: "Uzun süreli oturumları küçük bir yardımcı modelle özetleyin.",
      toggle: "Oturum gözlemcisi",
      toggleHint: "Abone olunan Control UI oturumları için canlı durum özetleri oluşturun.",
      resolvedModel: "Çözümlenen küçük model",
      modelAuto: "otomatik ({model})",
      modelConfigured: "yapılandırıldı ({model})",
      modelDisabled: "devre dışı",
      modelUnavailable: "kullanılamıyor (küçük model yok)",
      modelPicker: "Küçük model",
      modelPickerHint: "Gözlemci özetleri ve diğer kısa yardımcı görevler için kullanılır.",
      modelCatalogUnavailable: "Açık model kataloğu kullanılamıyor",
      auto: "Otomatik (sağlayıcı varsayılanı)",
      disabled: "Devre dışı",
      toggleNote: "Control UI oturum gözlemcisini güncelle",
      modelNote: "Varsayılan yardımcı modeli güncelle",
    },
    connection: {
      title: "Bağlantı",
      gateway: "Gateway",
    ...
    rawDraftPendingFormTitle:
      "Kaydedilmemiş ham yapılandırma düzenlemeleri var — Form görünümüne geçmeden önce kaydedin veya iptal edin.",
    rawDraftBlocksFormEdit:
      "Kaydedilmemiş ham yapılandırma düzenlemeleri ayrıştırılamadı; ayarları değiştirmeden önce Raw düzenleyicide çözümleyin.",
  ...
  execApproval: {
    ...
    otherPending: "Diğer bekleyen istekler",
    reviewRequest: "{agent} onayını inceleyin: {command}",
    agentPendingOne: "{count} bekleyen onay",
    agentPending: "{count} bekleyen onay",
  ...
  terminal: {
    ...
    uploadProgress: "{total} öğeden {current} tanesi yükleniyor",
    ...
    noSessions: "Canlı terminal oturumu yok",
    currentSession: "geçerli",
    sessionAttached: "bağlı",
  ...
  subtitles: {
    ...
    apps: "Telefon, saat, masaüstü ve tarayıcı için yardımcı uygulamalar.",
    approvals: "Son exec, eklenti ve sistem aracısı onayları.",
    ...
    modelSetup: "Doğrulanmış bir AI modeline bağlanın",
    modelProviders: "Configured providers with plan, quota, and cost.",
    memoryImport: "Codex ve Claude Code belleğini bir aracı çalışma alanına aktarın.",
    notifications: "Gateway'inizden gelen tarayıcı anlık bildirimleri.",
    security: "Gateway kimlik doğrulaması, exec ilkesi, araç profili ve onaylar.",
    advanced: "Kalan tüm yapılandırma bölümleri ve ham dosya düzenleyicisi.",
  ...
  modelSetup: {
    ...
    candidates: {
      ...
      recommended: "Önerilen",
      credentialsReady: "Kimlik bilgileri hazır",
      signInNeeded: "Oturum açılması gerekiyor",
      detected: "Algılandı",
      testAndUse: "Test et ve kullan",
    ...
    manual: {
      ...
      accessValue: "API anahtarı veya token",
      accessValuePlaceholder: "Bir API anahtarı veya token yapıştırın",
      connect: "Bağlan",
    ...
    failure: {
      auth: "Kimlik doğrulama başarısız oldu",
      rateLimit: "Hız sınırı aşıldı",
      billing: "Faturalandırma sorunu",
      timeout: "Zaman aşımına uğradı",
      format: "Geçersiz yanıt",
      unavailable: "Kullanılamıyor",
      unknown: "Bağlantı başarısız oldu",
    },
    errors: {
      requestFailed: "Model kurulum isteği başarısız oldu.",
      activationFailed: "Model etkinleştirilemedi.",
    },
    wizard: {
      ...
      continue: "Devam et",
      submit: "Gönder",
      openSignIn: "Oturum açma sayfasını aç",
      copy: "Kopyala",
      expires: "{count} dakika içinde sona erer",
      cancelled: "Sağlayıcıda oturum açma iptal edildi.",
      sessionExpired:
        "Bu kurulum oturumu, Gateway yeniden başlatıldıktan sonra sona erdi. Bu iletişim kutusunu kapatın, ardından model kurulumunu tekrar başlatın.",
      notComplete: "Oturum açma tamamlandı ancak model kurulumu henüz tamamlanmadı.",
    },
  },
  memoryImport: {
    unknownCollection: "Bellek koleksiyonu",
    claudeCode: "Claude Code",
    fileCountOne: "{count} dosya",
    fileCount: "{count} dosya",
    alreadyImported: "{count} mevcut",
    ready: "Hazır",
    existing: "Mevcut",
    importComplete: "İçe aktarma tamamlandı",
    importIncomplete: "İçe aktarma tamamlanmadı",
    importedCount: "{count} dosya içe aktarıldı",
    importedWithIssues: "{migrated} içe aktarıldı · {errors} başarısız · {conflicts} çakışma",
    reportSaved: "rapor kaydedildi",
    recoveryFile: "Kurtarma dosyası",
    recoveryJournal: "Kurtarma günlüğü",
    itemBackup: "Öğe yedeği",
    codexDescription: "Birleştirilmiş Codex bellek dosyaları.",
    claudeDescription: "Claude Code proje başına otomatik bellek dosyaları.",
    providerFallback: "Asistan belleğini bu aracı çalışma alanına aktarın.",
    reviewFiles: "Dosyaları incele",
    notFound: "Bulunamadı",
    noMemoryFound: "Bu bilgisayarda içe aktarılabilir bellek bulunamadı.",
    source: "Kaynak",
    destination: "Hedef",
    selectedCount: "{count} seçili",
    selectAtLeastOne: "En az bir dosya seçin",
    importSelected: "Seçilenleri içe aktar",
    confirmTitle: "{provider} sağlayıcısından içe aktarılsın mı?",
  ...
  onboarding: {
    memoryImport: {
      ...
      importingProvider: "İçe aktarılıyor…",
      providerResult: "{migrated} taşındı, {skipped} atlandı",
      providerIncomplete:
        "{migrated} taşındı, {skipped} atlandı, {errors} başarısız oldu, {conflicts} çakışma oluştu",
      providerError: "İçe aktarma başarısız oldu: {error}",
  ...
  custodian: {
    ...
    history: {
      ...
      invalidEdit: "Bu manuel düzenleme yapılandırma doğrulamasını geçemedi.",
      opaqueChange:
        "Görünür yapılandırma yolu değişiklikleri olmadan biçimlendirme veya yorumlar değişti.",
      sources: {
    ...
    nudge: {
      configReload: "Yapılandırma yeniden yüklemesi durdu — ne olduğunu bana sorun",
      channelAuth: "{channel} kimlik doğrulaması bozuldu — ne olduğunu bana sorun",
      channelDisconnected: "{channel} bağlantısı kesildi — ne olduğunu bana sorun",
  ...
  mcpServers: {
    ...
    addedSuccess: "{name} MCP sunucusu eklendi.",
    enabledSuccess: "{name} MCP sunucusu etkinleştirildi.",
    disabledSuccess: "{name} MCP sunucusu devre dışı bırakıldı.",
    removedSuccess: "{name} MCP sunucusu kaldırıldı.",
    configUnavailable: "Yapılandırma kullanılamıyor; yenileyip tekrar deneyin.",
    connectRequired: "MCP sunucularını değiştirmek için Gateway'e bağlanın.",
    adminRequired: "MCP sunucusu değişiklikleri operator.admin erişimi gerektirir.",
    enable: "Etkinleştirin:",
    disable: "Devre dışı bırak",
    removeNamed: "{name} cihazını kaldır",
    working: "Çalışıyor…",
  },
  mcpPage: {
  ...
  labsPage: {
    intro:
      "Labs, sürümler arasında değişebilecek, bozulabilecek veya kaybolabilecek deneysel yetenekler içerir.",
    sectionTitle: "Deneysel özellikler",
    sectionDescription:
      "Değişiklikler hemen kaydedilir ve gelecekteki aracı çalıştırmalarına uygulanır.",
    documentation: "Belgeler",
    restartRequired: "Gateway yeniden başlatması gerekiyor.",
    saveErrorTitle: "Özellik güncellenemedi",
    saveFailed: "Özellik ayarı kaydedilemedi.",
    codeMode: {
      title: "Kod Modu",
      description:
        "Aracıların araçları kompakt, korumalı JavaScript iş akışlarında birleştirmesine izin verin.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    havePhone: "Uygulamaya zaten sahip misiniz?",
    pairDevice: "Cihazınızı eşleştirin",
    sectionWatch: "Bileğinizde",
    sectionDesktop: "Masaüstünüzde",
    sectionBrowser: "Tarayıcınızda",
    sectionCommunity: "Topluluk",
    badgeBundledIos: "iOS uygulamasıyla birlikte gelir",
    badgeBundledAndroid: "Android uygulamasıyla birlikte gelir",
    ctaAppStore: "App Store",
    ctaPlayStore: "Google Play",
    ctaDownload: "İndir",
    ctaDocs: "Belgeler",
    ctaSetupGuide: "Kurulum kılavuzu",
    ctaOpenPlugins: "Eklentileri Aç",
    ctaBrowseClawHub: "ClawHub'a Göz At",
    linkDiscord: "Discord topluluğu",
    linkDocs: "Belgeler",
    cards: {
      ios: {
        title: "iPhone",
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Bileğinizden hızlı bakış sohbetleri ve hızlı yanıtlar.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      macos: {
        title: "macOS",
        desc: "Gateway'iniz için menü çubuğu eşlik uygulaması — bildirimler, onaylar, hızlı sohbet.",
      },
      windows: {
        title: "Windows",
      ...
      linux: {
        title: "Linux",
        desc: "Yerel masaüstü uygulaması — .deb ve AppImage sürümleri.",
      },
      chrome: {
  ...
  presence: {
    rosterLabel: "Çevrimiçi olanları göster",
    rosterTitle: "Çevrimiçi",
    serverRegion: "Sunucu",
    you: "siz",
  },
  profilePage: {
    ...
    identity: {
      ...
      notSet: "Kimlik ayarlanmadı.",
      setIdentity: "Kimliği ayarla",
      avatar: "Avatar",
      avatarDescription:
        "PNG, JPEG veya WebP. Görüntüler 256 × 256 veya daha küçük boyuta yeniden boyutlandırılır.",
      chooseAvatar: "Görsel seç",
      processingAvatar: "İşleniyor…",
      displayName: "Görünen ad",
      displayNameDescription: "Bu gateway'i kullanan diğer kişilere gösterilir.",
      linkedEmails: "Bağlı e-postalar",
      linkedEmailsDescription: "Bu profile bağlı e-posta adresleri.",
      openSettings: "{name} için kimlik ayarlarını aç",
      avatarErrors: {
        invalid: "Bu görsel işlenemedi.",
        sourceTooLarge: "10 MB veya daha küçük bir görsel seçin.",
        tooLarge: "İşlenen avatar 512 KB'tan büyük.",
      },
    },
  },
  tasksPage: {
  ...
  skillWorkshop: {
    ...
    history: {
      eyebrow: "Geçmiş çalışmalar",
      title: "Yeniden kullanılabilir iş akışlarını bulun",
      body: "Kapsamlı oturumları en yeniden en eskiye doğru inceleyin. Yalnızca güçlü kurtarma kalıpları veya tekrarlanan araç çağrılarını azaltan iş akışları bekleyen önerilere dönüşür.",
      findIdeas: "Beceri fikirleri bul",
      scanEarlier: "Önceki çalışmaları tara",
      scanNew: "Yeni çalışmaları tara",
      scanning: "Oturumlar inceleniyor…",
      loading: "Geçmiş yükleniyor…",
      pendingOnly: "Yalnızca bekleyen öneriler · yapılandırılmış modelinizi kullanır",
      reviewed: "{count} oturum incelendi",
      found: "{count} fikir bulundu",
      noSessions: "Bu zaman aralığında kapsamlı bir oturum bulunamadı.",
      today: "bugün",
    },
    today: {
  ...
  gatewayLogs: {
    title: "Günlükler",
    subtitle: "Gateway dosya günlükleri (JSONL).",
    exportButton: "{label} dışa aktar",
    exportLabels: {
      filtered: "filtrelenmiş",
      visible: "görünür",
    },
    ...
    autoFollow: "Otomatik takip",
    file: "Dosya: {file}",
    truncated: "Günlük çıktısı kısaltıldı; en son bölüm gösteriliyor.",
  ...
  board: {
    label: "İş parçacığı panosu",
    tabsLabel: "Pano sekmeleri",
    moreTabs: "Daha fazla pano sekmesi",
    gridLabel: "Pano bileşenleri",
    emptyTitle: "Boş bir pano, çalışmaya hazır",
    emptyHint: "Aracınız buraya bileşenler sabitleyebilir — bir durum kartı istemeyi deneyin.",
    actionFailed: "Pano değişikliği kaydedilemedi.",
    actionInProgress: "Başka bir pano değişikliği hâlâ kaydediliyor.",
    announcement: {
      moved: "{title} taşındı.",
      resized: "{title} yeniden boyutlandırıldı.",
      removed: "{title} kaldırıldı.",
      granted: "Bileşen erişimine izin verildi.",
      rejected: "Bileşen erişimi reddedildi.",
    },
    widget: {
      cellLabel:
        "Pano bileşeni: {title}. Gezinmek için ok tuşlarını kullanın. Taşımak için Alt tuşunu basılı tutup bir ok tuşuna basın.",
      moveHandle: "{title} öğesini taşı",
      resizeHandle: "{title} öğesini yeniden boyutlandır",
      menuLabel: "Bileşen seçenekleri",
      moveToTab: "Sekmeye taşı",
      noOtherTabs: "Başka sekme yok",
      ...
      rejectedDetail: "Bu widget kaldırılana veya değiştirilene kadar etkin olmayacak.",
      appLoading: "Uygulama geri yükleniyor…",
      appStaleTitle: "Bu sabitlenmiş uygulama güncel değil",
      ...
      sandboxUnavailable: "Widget sandbox ana makinesi kullanılamıyor.",
      frameAuthorizationFailed:
        "Tekrarlanan yenileme denemelerinden sonra widget yetkilendirmesi başarısız oldu.",
      sandboxOriginRequired:
        "Tekrarlanan yenileme denemelerinden sonra widget yetkilendirmesi başarısız oldu. Gateway, widget sandbox bağlantı noktasını yönlendirmeyen bir ters proxy veya tünel arkasında çalışıyorsa, mcp.apps.sandboxOrigin değerini sandbox dinleyicisine yönlendirilen özel bir genel kaynağa ayarlayın.",
      errorTitle: "Bu widget yüklenemedi",
      errorDetail: "Sorun bu kartla sınırlıdır.",
      actionErrorTitle: "Widget değişikliği başarısız oldu",
      actionErrorDetail: "Pano önceki widget durumunu korudu.",
      errorShow: "Ayrıntıları göster",
      kindMcp: "MCP",
      kindHtml: "HTML",
      kindPlugin: "Eklenti",
      pluginLoading: "Eklenti bileşeni yükleniyor…",
      disabledPlugin: "Devre dışı bırakılmış eklentiden bileşen {pluginId}",
    },
  },
  workboard: {
    widget: {
      cardLabel: "Workboard kartı",
      summaryLabel: "Workboard özeti",
      loading: "Workboard yükleniyor…",
      cardIdRequired: "Bu bileşen bir cardId prop'una ihtiyaç duyar.",
      cardMissing: "Bu Workboard kartı artık kullanılamıyor.",
      unassigned: "Atanmamış",
      openBoard: "Panoyu aç",
      statusCounts: "Duruma göre kartlar",
      noActiveCards: "Hazır veya çalışan kart yok.",
    },
    ...
    dashboardTitle: "Pano",
    dashboardEmpty: "Henüz pano yok — çalışan aracı bileşenleri sabitleyebilir.",
    openSession: "Oturumu aç",
  ...
  attention: {
    ...
    pendingApproval: "{count} bekleyen onay",
    pendingApprovals: "{count} bekleyen onay",
  },
  approvalHistory: {
    description:
      "Bu gateway tarafından kaydedilen terminal exec, eklenti ve sistem aracısı onayları; en yeniler önce.",
    loading: "Onay geçmişi yükleniyor…",
    loadingMore: "Yükleniyor…",
    loadMore: "Daha fazla yükle",
    empty: "Son 30 günlük dönem içinde sonuçlandırılmış onay yok.",
    retention: "Onay geçmişi, son 30 günlük dönemi kapsar.",
    offline: "Onay geçmişini yüklemek için gateway'e bağlanın.",
    invalidResponse: "Gateway, geçersiz bir onay geçmişi yanıtı döndürdü.",
    unknown: "Bilinmiyor",
    notApplicable: "Yok",
    columns: {
      ...
      request: "İstek",
      decision: "Karar",
      reason: "Sonuçlandırma nedeni",
      source: "Kaynak aracı / oturum",
      resolver: "Sonuçlandıran",
    },
    kinds: {
      exec: "Exec",
      plugin: "Eklenti",
      systemAgent: "Sistem aracısı",
    },
    statuses: {
    ...
    reasons: {
      user: "Kullanıcı kararı",
      timeout: "Zaman aşımına uğradı",
      malformedVerdict: "Hatalı biçimlendirilmiş karar",
      noRoute: "Rota yok",
      runAborted: "Çalıştırma iptal edildi",
      gatewayRestart: "Gateway yeniden başlatıldı",
      storageCorrupt: "Depolama alanı bozuk",
    },
  },
  palette: {
  ...
  modelProviders: {
    ...
    credentials: {
      ...
      envKey: "Ortamdan alınan API anahtarı",
      envKeyNamed: "Ortamdan alınan API anahtarı ({name})",
      profileKey: "API anahtarı profilleri: {count}",
      none: "Yapılandırılmamış",
    },
    apiKey: {
      label: "API anahtarı",
      placeholder: "Sağlayıcı API anahtarını girin",
      replacePlaceholder: "Gizli anahtar kaydedildi. Değiştirmek için yeni bir anahtar girin.",
      set: "API anahtarını ayarla",
      replace: "Anahtarı değiştir",
      remove: "Anahtarı kaldır",
      saved: "Gizli anahtar kaydedildi.",
      removed: "API anahtarı kaldırıldı.",
      authModeBlocked:
        'Kimlik doğrulama modu "{mode}" iken API anahtarı değişiklikleri kullanılamaz.',
    },
    probe: {
      test: "Bağlantıyı test et",
      testing: "Test ediliyor…",
      unavailable: "Bağlantı testi için daha yeni bir gateway gereklidir.",
      latency: "{ms} ms",
      status: {
        ok: "Bağlı",
        auth: "Kimlik doğrulama başarısız oldu",
        rate_limit: "Hız sınırına ulaşıldı",
        billing: "Faturalandırma sorunu",
        timeout: "Zaman aşımına uğradı",
        format: "Geçersiz yanıt",
        unknown: "Bağlantı başarısız oldu",
    ...
    logout: {
      action: "Çıkış yap",
      confirm:
        "{provider} oturumu kapatılsın mı? Kaydedilmiş OAuth ve token profilleri kaldırılacak.",
      loggingOut: "Çıkış yapılıyor…",
      done: "Çıkış yapıldı.",
    },
    add: {
      title: "Sağlayıcı ekle",
      subtitle: "Bilinen bir model sağlayıcısı seçin ve API anahtarını kaydedin.",
      action: "Sağlayıcı ekle",
      none: "Bilinen tüm sağlayıcılar zaten yapılandırılmış.",
      provider: "Sağlayıcı",
      selectProvider: "Bir sağlayıcı seçin",
      save: "Sağlayıcıyı kaydet",
      saved: "{provider} sağlayıcısı eklendi.",
    },
    defaults: {
      title: "Varsayılan modeller",
      subtitle: "Birincil modeli, sıralı yedek modelleri ve yardımcı modeli seçin.",
      primary: "Varsayılan model",
      utility: "Yardımcı model",
      automatic: "Otomatik (sağlayıcı varsayılanı)",
      disabled: "Devre dışı",
      savedSelection: "Kaydedilen seçim",
      fallbacks: "Yedekler",
      noFallbacks: "Yedek model yapılandırılmamış.",
      unsaved: "Kaydedilmemiş değişiklikler",
      addFallback: "Yedek model ekle",
      selectModel: "Bir model seçin",
      selectFallback: "Bir yedek model seçin",
      noModels: "Varsayılan modelleri seçmeden önce bir sağlayıcı yapılandırın.",
      saved: "Varsayılan modeller kaydedildi.",
    },
    readOnly: {
      disconnected: "Model ayarlarını değiştirmek için Gateway'e bağlanın.",
      adminRequired:
        "Yalnızca göz atabilirsiniz. Model değişiklikleri operator.admin erişimi gerektirir.",
    },
    notes: {
      saveKey: "Control UI üzerinden {provider} için API anahtarını kaydedin",
      removeKey: "Control UI üzerinden {provider} API anahtarını kaldırın",
      addProvider: "Control UI üzerinden {provider} model sağlayıcısını ekleyin",
      defaultModel: "Control UI üzerinden varsayılan model seçimini güncelleyin",
    },
  },
  usage: {
    common: {
    ...
    details: {
      ...
      loadFailed: "{detail} yüklenemedi: {error}",
  ...
  chat: {
    ...
    startupStatus: {
      ...
      provisioningEnvironment: "Ortam sağlanıyor…",
    ...
    board: {
      ...
      chatFace: "Sohbet",
      dashboardFace: "Pano",
      dockMenu: "Sohbet yuvası: {dock}",
      dockLeft: "Sohbeti sola yerleştir",
      dockRight: "Sohbeti sağa yerleştir",
      dockBottom: "Sohbeti alta yerleştir",
      dockHidden: "Sohbeti gizle",
      resizeDock: "Sohbet panelini yeniden boyutlandır",
      reopenChat: "Sohbeti göster",
      workboardCard: "Çalışma panosu kartı: {title}, {status}",
      defaultTab: "Ana",
      mockPlaceholder: "Pano görünümü dikişi · {tabs} sekme · {widgets} widget",
      mockOverview: "Genel Bakış",
      mockResearch: "Araştırma",
      mockSessionStatus: "İş parçacığı durumu",
      mockRecentFindings: "Son bulgular",
      mockSourceMap: "Kaynak haritası",
      resetTitle: "Konuşma sıfırlansın mı?",
      resetDescription: "Konuşma bağlamı sıfırlanır. Panonuz korunur.",
    },
    catalog: {
    ...
    workspaceConflict: {
      ...
      inspectCloud: "İlk bulut sürümünü incele",
      takeCloud: "İlk bulut sürümünü al",
      copyInspectCommand: "Bulut inceleme komutunu kopyala",
      copyTakeCommand: "take-cloud komutunu kopyala",
      commandHelp:
      ...
      eventTitleMany: "Bulut sonucu {count} çakışmayla uygulandı",
      eventDescription:
        "Bu yollar için yerel sürümler korundu; diğer bulut değişiklikleri uygulandı.",
    },
    compaction: {
    ...
    progressLabels: {
      shelling: "Kabuklanıyor",
      scuttling: "Yana doğru ilerliyor",
      clawing: "Pençeliyor",
      pinching: "Kıskaçlıyor",
      molting: "Kabuk değiştiriyor",
      bubbling: "Kabarcıklanıyor",
      tiding: "Dalgalanıyor",
      reefing: "Resifleniyor",
      cracking: "Çatlıyor",
      sifting: "Elendi",
      brining: "Salamuralanıyor",
      nautiling: "Notiluslaşıyor",
      krilling: "Krilleniyor",
      barnacling: "Midyeleniyor",
      lobstering: "Istakozlanıyor",
      tidepooling: "Gelgit havuzunda dolaşıyor",
      pearling: "İncileşiyor",
      snapping: "Şaklatıyor",
      surfacing: "Yüzeye çıkıyor",
    },
    turnRecap: {
      doneIn: "{duration} içinde tamamlandı",
      tokens: "{count} token",
      tokensOne: "1 token",
    },
    commands: {
    ...
    sidebar: {
      ...
      updateMacAndGateway: "Mac uygulamasını + Gateway'i güncelle",
    ...
    questions: {
      ...
      skipping: "Atlanıyor…",
      skipped: "Atlandı",
      collapse: "Soruyu daralt",
      expand: "Soruyu genişlet",
      eyebrow: "Soru",
      cardLabel: "Asistandan gelen soru",
      summaryLabel: "Soru sonucu",
      timeRemaining: "Kalan süre",
      ownAnswer: "Kendi yanıtınız…",
      ownAnswerFor: "{header} için kendi yanıtınız",
      submitting: "Gönderiliyor…",
      submitFailed: "Gönderilemedi: {error}",
      answered: "Yanıtlandı",
      answeredElsewhere: "Başka yerde yanıtlandı",
      unavailable: "Kullanılamıyor",
      expired: "Süresi doldu",
      cancelled: "İptal edildi",
    },
    imageLightbox: {
      ...
      open: "{title} görselini aç",
      openOriginal: "Orijinali aç",
      close: "Görsel önizlemesini kapat",
      untitled: "Görsel",
    },
    messages: {
      activity: "Etkinlik",
      ...
      hide: "Gizle",
      hideConfirm: "Bu mesaj bu tarayıcıda gizlensin mi? Aracı yine de görebilir.",
      hideMessage: "Mesajı gizle",
      hideTooltip: "Yalnızca bu tarayıcıda gizle",
      ...
      rewindUnavailable: "Aracı çalışırken geri sarma kullanılamaz",
      forkUnavailable: "Aracı çalışırken çatallama kullanılamaz",
    ...
    observer: {
      title: "Oturum gözlemcisi",
      expand: "Oturum gözlemcisini genişlet",
      collapse: "Oturum gözlemcisini daralt",
      hide: "Oturum gözlemcisini gizle",
      show: "Oturum gözlemcisini göster",
      plan: "Plan",
      progress: "{total} / {completed}",
      pullRequests: "Çekme istekleri",
      running: "Çalışıyor",
      checksPassing: "{count} geçti",
      checksFailing: "{count} başarısız",
      checksPending: "{count} çalışıyor",
      askLabel: "Bu oturum hakkında sor",
      askPlaceholder: "Neden bunu yapıyor?",
      askSubmit: "Sor",
      askPending: "Gözlemler kontrol ediliyor…",
      askBusy: "Gözlemci zaten bir soruyu yanıtlıyor.",
      askUnavailable: "Gözlemci şu anda yanıt veremiyor.",
      boardCurrentStatus: "Mevcut durum",
      boardTimeline: "Sağlık zaman çizelgesi",
      boardCurrentRun: "Mevcut çalışma",
      boardPreviousRun: "Önceki çalışma",
      boardUnknownRun: "Tanımlanamayan çalışma",
      boardSinceYouLeft: "Ayrıldığınızdan beri",
      health: {
        "on-track": "Yolunda",
        grinding: "Çalışıyor",
        stuck: "Takıldı",
        "waiting-on-user": "Sizi bekliyor",
    ...
    composer: {
      ...
      cameraAccessFailed: "Kameraya erişilemiyor.",
      cameraBusy: "Kamera meşgul veya tarayıcı tarafından kullanılamıyor.",
      cameraFallback: "Kamera {number}",
      cameraInput: "Kamera",
      cameraListUnsupported: "Bu tarayıcı kameraları listeleyemiyor.",
      cameraNoneFound: "Kamera bulunamadı.",
      cameraPageInactive: "Bu sayfa etkin değilken kameralar kullanılamaz.",
      ...
      microphoneAppliesNextSession:
        "Değişiklikler bir sonraki Talk oturumunuzu başlattığınızda uygulanır.",
      microphoneListUnsupported: "Bu tarayıcı mikrofon girişlerini listeleyemiyor.",
      noCameras: "Ek kamera bulunamadı",
      ...
      holdToRecordSetting: "Dikte etmek için mikrofon düğmesini basılı tutun",
      holdToRecordSettingDescription:
        "Oluşturucu mikrofon düğmesini basılı tutun, konuşun, ardından metni göndermeden eklemek için bırakın.",
      dictationAudioUnsupported: "Gateway desteklenmeyen bir dikte ses biçimi döndürdü.",
      dictationBrowserAudioUnsupported: "Bu tarayıcı 8 kHz'de dikte sesi yakalayamaz.",
      dictationConnecting: "Dikte başlatılıyor…",
      dictationDisconnected: "Gateway bağlantısı kesildiği için dikte durduruldu.",
      dictationFailed: "Dikte başarısız oldu.",
      dictationFinalizing: "Dikte tamamlanıyor…",
      dictationFinalizationTimedOut: "Son kısmi transkript tamamlanmadan önce dikte durduruldu.",
      dictationProviderUnavailable:
        "Dikte için yapılandırılmış bir transkripsiyon sağlayıcısı yok.",
      dictationRecording: "Kaydediliyor {elapsed}",
      dictationReleaseToInsert: "Dikteyi eklemek için bırakın",
      ...
      selectedCameraUnavailable:
        "Seçilen kamera kullanılamıyor. Başka bir kamera veya Sistem varsayılanı seçin.",
      ...
      systemDefaultCamera: "Sistem varsayılanı",
    ...
    toolCards: {
      ...
      widgetExportRerender:
        "Bu widget'ın görüntü olarak dışa aktarılması için yeniden oluşturulması gerekiyor.",
      widgetExportFailed: "Widget dışa aktarma başarısız oldu. Yeniden deneyin.",
      pinToDashboard: "Panoya sabitle",
      pinToDashboardPending: "Sabitleniyor…",
      pinnedToDashboard: "Sabitlenmiş",
    ...
    backgroundTasks: {
      ...
      prompt: "İstem",
      output: "Çıktı",
      promptUnavailable: "İstem kullanılamıyor.",
      outputPending: "Henüz çıktı yok.",
    },
    sessionDiff: {
      title: "Değişiklikler",
    ...
    sessionDiscussion: {
      ...
      hide: "Tartışmayı gizle",
      disconnected: "Gateway bağlantısı kesildi.",
      loading: "Tartışma yükleniyor…",
      opening: "Tartışma açılıyor…",
      requiresWriteAccess: "Bu tartışmayı açmak için operatör yazma erişimi gerekir.",
      openExternal: "Tartışmayı yeni bir sekmede aç",
      frameTitle: "Oturum tartışması",
      unavailable: "Bu tartışma gömülemiyor.",
    },
    workspaceFiles: {
  ...
  cron: {
    ...
    form: {
      ...
      script: "Betik",
      readOnlyPayloadHelp:
        "Bu yük Control UI dışında oluşturuldu. İçeriği salt okunur kalır ve diğer değişiklikleri kaydettiğinizde korunur.",
