...
export const uk: TranslationMap = {
  common: {
    ...
    refresh: "Оновити",
    retry: "Повторити",
    staleData: "Відображаються застарілі дані.",
  ...
  channels: {
    ...
    pairing: {
      title: "Запити на доступ до особистих повідомлень",
      subtitle:
        "Перегляньте людей, які очікують дозволу надсилати особисті повідомлення до каналів із захистом парування.",
      channelFilter: "Канал",
      accountFilter: "Обліковий запис",
      allChannels: "Усі канали",
      allAccounts: "Усі облікові записи",
      approve: "Схвалити",
      dismiss: "Відхилити",
      approveAria: "Схвалити {sender} для {channel}, обліковий запис {account}",
      dismissAria: "Відхилити {sender} для {channel}, обліковий запис {account}",
      requested: "Запитано {ago}",
      expires: "Спливає {ago}",
      senderDetails: "Дані відправника",
      missingPermission:
        "Це з'єднання не має доступу operator.pairing, тому запити на особисті повідомлення неможливо переглянути.",
      noAccounts:
        "Жоден налаштований обліковий запис каналу не використовує парування відправників особистих повідомлень.",
      noRequests: "Немає запитів на доступ до особистих повідомлень, що очікують.",
      noFilteredRequests: "Немає запитів, що очікують і відповідають цим фільтрам.",
      limits:
        "Запити спливають через {minutes} хв. Кожен обліковий запис каналу може мати до {count} запитів, що очікують.",
      detailTitle: "Доступ до особистих повідомлень",
      detailSubtitle:
        "Користувачів потрібно схвалити, перш ніж їхні прямі повідомлення досягнуть агента.",
      pendingCount: "{count} в очікуванні",
      noPending: "Немає запитів в очікуванні",
      review: "Переглянути запити",
      approveDialogTitle: "Схвалити доступ до прямих повідомлень",
      dismissDialogTitle: "Відхилити запит на доступ до прямих повідомлень",
      approveExplanation:
        "Це дозволяє відправнику спілкуватися з агентом у прямих повідомленнях. Це не надає доступу до груп.",
      dismissExplanation:
        "Це видаляє поточний запит, але не блокує відправника. Він може повторно запитати доступ пізніше.",
      notifyRequester: "Сповістити запитувача після схвалення",
      makeCommandOwner: "Також зробити цього відправника першим власником команд",
      commandOwnerHelp:
        "Власники команд можуть виконувати привілейовані команди та схвалювати небезпечні дії. Ця опція доступна лише поки не налаштовано жодного власника.",
      commandOwnerNeedsAdmin:
        "Власника команд не налаштовано. Це з'єднання потребує operator.admin, щоб призначити першого власника.",
      approvedNotice: "Доступ до прямих повідомлень схвалено.",
      approvedOwnerNotice:
        "Доступ до прямих повідомлень схвалено, і першого власника команд налаштовано.",
      approvedNotificationFailedNotice:
        "Доступ до прямих повідомлень схвалено, але сповіщення запитувачу не вдалося доставити.",
      approvedOwnerFailedNotice:
        "Доступ до прямих повідомлень схвалено, але першого власника команд не вдалося налаштувати.",
      approvedFollowupsFailedNotice:
        "Доступ до прямих повідомлень схвалено, але сповіщення запитувача та налаштування власника команд обидва не вдалися.",
      dismissedNotice:
        "Запит на доступ до прямих повідомлень відхилено. Відправник може повторно запитати доступ.",
    },
    setup: {
      ...
      working: "Працює…",
      sessionExpired:
        "Ця сесія налаштування завершилася після перезапуску Gateway. Закрийте це вікно, потім знову почніть налаштування каналу.",
      continue: "Продовжити",
      finish: "Завершити",
      copyText: "Копіювати",
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Жодну збережену сесію WhatsApp не очищено. Вона може вже бути відсутня, або її каталог автентифікації потребує ручного очищення.",
    },
  ...
  agentChip: {
    ...
    agents: "Агенти",
    openChat: "Чат з {name}",
    offlineOpenSettings: "Не в мережі — відкрити налаштування",
    switchAgent: "Змінити агента",
    working: "Працює…",
  ...
  newSession: {
    ...
    places: "Місця",
    recentFolders: "Нещодавні",
    runsOn: "Виконується на {place}",
    ...
    gitCheckUnavailable:
      "Не вдалося перевірити Git для цієї теки. Виберіть її знову, щоб повторити спробу.",
  ...
  sessionsView: {
    ...
    global: "Глобально",
    unknown: "Невідомо",
    sessionState: "Стан гілки",
    all: "Усі",
    sessionArchived: "Тему заархівовано",
    sessionsArchived: "Заархівовано {count} тем",
    deleteAllArchived: "Видалити всі заархівовані…",
    deleteAllArchivedConfirm: "Видалити {count} заархівованих тем та їхні транскрипти?",
    ...
    runFailedReason: "Запуск не вдався: {reason}",
    ...
    lastActive: "Остання активність {time}",
    surface: "Поверхня",
    subject: "Тема",
    room: "Кімната",
    space: "Простір",
    ...
    showChildSessions: "Показати дочірні сеанси ({count}) для {session}",
    hideChildSessions: "Приховати дочірні сеанси ({count}) для {session}",
    childSessions: "Дочірні сеанси",
    showMoreChildren: "Показати ще {count}",
    archived: "Архівовано",
    pinned: "Закріплено",
    unread: "Unread",
    ...
    cloudWorkerDescendantConflict: "Дочірній хмарний воркер: 1 конфлікт робочого простору",
    cloudWorkerDescendantConflicts: "Дочірні хмарні воркери: {count} конфліктів робочого простору",
    ...
    invalidEmojiIcon: "Введіть рівно один емодзі.",
    removeIcon: "Видалити піктограму",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileIdentity: "Ваш профіль Gateway",
      assistantIdentity: "Ідентичність асистента",
      displayName: "Відображуване ім'я",
      displayNamePlaceholder: "Ваше ім'я",
      saveProfile: "Зберегти ім'я",
      saving: "Збереження…",
      uploading: "Обробка…",
      profileHint:
        "JPEG, PNG або WebP. Зображення обрізаються по центру та масштабуються до 512px.",
      profileLoadFailed: "Не вдалося завантажити ваш профіль.",
      profileSaveFailed: "Не вдалося зберегти ваш профіль.",
      avatarInvalid: "Виберіть коректне зображення JPEG, PNG або WebP.",
      avatarTooLarge: "Оброблений аватар усе ще завеликий.",
  ...
  configView: {
    categories: {
      ...
      security: "Конфіденційність і безпека",
      automation: "Автоматизація",
    ...
    syncedHint: "Синхронізовано між вашими пристроями через Gateway.",
    notifications: {
    ...
    sidebarPrefs: {
      title: "Бічна панель",
      hint: "Виберіть, що відображатиметься під час виконання сеансів.",
      liveActivity: "Показувати активність агента наживо в бічній панелі",
      liveActivityHint:
        "Показувати останню активність асистента чи інструмента під активними сеансами.",
    },
    sessionObserver: {
      title: "Спостерігач сеансів",
      hint: "Підсумовуйте тривалі сеанси за допомогою невеликої допоміжної моделі.",
      toggle: "Спостерігач сеансів",
      toggleHint: "Генерувати оперативні зведення статусу для підписаних сеансів Control UI.",
      resolvedModel: "Визначена невелика модель",
      modelAuto: "авто ({model})",
      modelConfigured: "налаштовано ({model})",
      modelDisabled: "вимкнено",
      modelUnavailable: "недоступно (немає невеликої моделі)",
      modelPicker: "Невелика модель",
      modelPickerHint:
      ...
      auto: "Авто (за замовчуванням провайдера)",
      disabled: "Вимкнено",
      toggleNote: "Оновити спостерігач сеансів Control UI",
    ...
    rawDraftPendingFormTitle:
      "Незбережені зміни в Raw-редакторі — збережіть або скасуйте їх перед переходом до Form.",
    rawDraftBlocksFormEdit:
      "Незбережені зміни в Raw-редакторі не вдалося розібрати; виправте їх у Raw-редакторі перед зміною налаштувань.",
    invalidConfig:
  ...
  execApproval: {
    ...
    otherPending: "Інші запити в очікуванні",
    reviewRequest: "Перевірте схвалення від {agent}: {command}",
    agentPendingOne: "{count} схвалення очікує",
    agentPending: "{count} схвалень очікують",
  ...
  terminal: {
    ...
    noSessions: "Немає активних сеансів термінала",
    currentSession: "поточний",
    sessionAttached: "підключено",
  ...
  tabs: {
    ...
    modelSetup: "Налаштування моделі",
  ...
  subtitles: {
    ...
    apps: "Супутні додатки для телефона, годинника, комп'ютера та браузера.",
    ...
    modelSetup: "Підключіть перевірену модель ШІ",
    modelProviders: "Configured providers with plan, quota, and cost.",
    memoryImport: "Перенесіть пам’ять Codex і Claude Code до робочого простору агента.",
    notifications: "Push-сповіщення браузера від вашого gateway.",
    security: "Автентифікація Gateway, політика exec, профіль інструментів і схвалення.",
    advanced: "Усі інші розділи конфігурації, а також редактор необробленого файлу.",
  ...
  modelSetup: {
    ...
    candidates: {
      ...
      recommended: "Рекомендовано",
      credentialsReady: "Облікові дані готові",
      signInNeeded: "Потрібно ввійти",
      detected: "Виявлено",
      testAndUse: "Перевірити й використовувати",
    ...
    empty: {
      ...
      intro:
        "Наявного доступу до AI не виявлено. Встановіть один з цих інструментів, а потім перевірте знову.",
    },
    unavailable: {
    ...
    failure: {
      ...
      rateLimit: "Перевищено ліміт запитів",
    ...
    errors: {
      requestFailed: "Не вдалося виконати запит на налаштування моделі.",
      activationFailed: "Не вдалося активувати модель.",
    },
    wizard: {
      dialogLabel: "Вхід через постачальника",
      title: "Увійти через постачальника",
      starting: "Починається вхід через постачальника…",
      checking: "Перевіряємо налаштування вашої моделі…",
      working: "Працює…",
      continue: "Продовжити",
      submit: "Надіслати",
      openSignIn: "Відкрити сторінку входу",
      copy: "Копіювати",
      expires: "Термін дії спливає через {count} хв",
      cancelled: "Вхід до постачальника скасовано.",
      sessionExpired:
        "Ця сесія налаштування завершилася після перезапуску Gateway. Закрийте це вікно, а потім знову почніть налаштування моделі.",
      notComplete: "Вхід завершено, але налаштування моделі ще не завершено.",
    },
  },
  memoryImport: {
  ...
  custodian: {
    ...
    history: {
      ...
      invalidEdit: "Це ручне редагування не пройшло перевірку конфігурації.",
      opaqueChange: "Форматування або коментарі змінено без видимих змін шляхів конфігурації.",
      sources: {
    ...
    nudge: {
      configReload: "Перезавантаження конфігурації зупинено — запитайте мене, що сталося",
      channelAuth: "Автентифікація {channel} погіршилася — запитайте мене, що сталося",
      channelDisconnected: "{channel} щойно відключився — запитайте мене, що сталося",
  ...
  mcpServers: {
    ...
    addedSuccess: "Додано MCP-сервер {name}.",
    enabledSuccess: "Увімкнено MCP-сервер {name}.",
    disabledSuccess: "Вимкнено MCP-сервер {name}.",
    removedSuccess: "Видалено MCP-сервер {name}.",
    configUnavailable: "Конфігурація недоступна; оновіть і спробуйте знову.",
    connectRequired: "Підключіться до gateway, щоб змінити MCP-сервери.",
    adminRequired: "Зміни MCP-серверів потребують доступу operator.admin.",
    enable: "Увімкніть",
    disable: "Вимкнути",
  ...
  labsPage: {
    intro:
      "Labs містить експериментальні можливості, які можуть змінюватися, ламатися або зникати між випусками.",
    sectionTitle: "Експериментальні функції",
    sectionDescription: "Зміни зберігаються негайно й застосовуються до майбутніх запусків агента.",
    documentation: "Документація",
    restartRequired: "Потрібно перезапустити Gateway.",
    saveErrorTitle: "Не вдалося оновити функцію",
    saveFailed: "Не вдалося зберегти налаштування функції.",
    codeMode: {
      title: "Режим коду",
      description:
        "Дозвольте агентам поєднувати інструменти в компактних, ізольованих робочих процесах JavaScript.",
    },
    swarm: {
      title: "Рій",
  ...
  appsPage: {
    ...
    havePhone: "Вже маєте застосунок?",
    pairDevice: "Спарувати пристрій",
    sectionWatch: "На зап’ясті",
    sectionDesktop: "На комп’ютері",
    sectionBrowser: "У браузері",
    sectionCommunity: "Спільнота",
    badgeBundledIos: "У комплекті із застосунком для iOS",
    badgeBundledAndroid: "Входить до складу програми для Android",
    ctaAppStore: "App Store",
    ctaPlayStore: "Google Play",
    ctaDownload: "Завантажити",
    ctaDocs: "Документація",
    ctaSetupGuide: "Посібник із налаштування",
    ctaOpenPlugins: "Відкрити плагіни",
    ctaBrowseClawHub: "Огляд ClawHub",
    linkDiscord: "Спільнота Discord",
    linkDocs: "Документація",
    cards: {
      ios: {
        title: "iPhone",
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Швидкий перегляд чатів і миттєві відповіді просто із зап'ястка.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      macos: {
        title: "macOS",
        desc: "Компаньйон у рядку меню для вашого Gateway — сповіщення, підтвердження, швидкий чат.",
      },
      windows: {
        title: "Windows",
      ...
      linux: {
        title: "Linux",
        desc: "Нативний застосунок для робочого столу — збірки .deb та AppImage.",
      },
      chrome: {
  ...
  presence: {
    rosterLabel: "Показати, хто онлайн",
    rosterTitle: "Онлайн",
    serverRegion: "Сервер",
    you: "ви",
  },
  profilePage: {
    ...
    identity: {
      ...
      notSet: "Ідентичність не встановлено.",
      setIdentity: "Встановити ідентичність",
      avatar: "Аватар",
      avatarDescription: "PNG, JPEG або WebP. Зображення масштабуються до 256 × 256 або менше.",
      chooseAvatar: "Вибрати зображення",
      processingAvatar: "Обробка…",
      displayName: "Відображуване ім'я",
      displayNameDescription: "Показується іншим людям, які використовують цей gateway.",
      linkedEmails: "Пов'язані електронні адреси",
      linkedEmailsDescription: "Електронні адреси, підключені до цього профілю.",
      openSettings: "Відкрити налаштування ідентифікації для {name}",
      avatarErrors: {
        invalid: "Не вдалося обробити це зображення.",
        sourceTooLarge: "Виберіть зображення розміром 10 МБ або менше.",
        tooLarge: "Оброблений аватар більший за 512 КБ.",
      },
    },
  },
  tasksPage: {
  ...
  gatewayLogs: {
    title: "Журнали",
    subtitle: "Файлові журнали Gateway (JSONL).",
    exportButton: "Експортувати {label}",
    exportLabels: {
      filtered: "відфільтровані",
      visible: "видимо",
    },
    filter: "Фільтр",
    searchPlaceholder: "Пошук у журналах",
    autoFollow: "Автостеження",
    file: "Файл: {file}",
    truncated: "Вивід журналу скорочено; показано останній фрагмент.",
  ...
  board: {
    label: "Панель тем",
    tabsLabel: "Вкладки панелі",
    moreTabs: "Більше вкладок панелі",
    gridLabel: "Віджети інформаційної панелі",
    emptyTitle: "Чиста панель, готова до роботи",
    emptyHint: "Ваш агент може закріпити тут віджети — спробуйте запросити картку стану.",
    actionFailed: "Не вдалося зберегти зміну інформаційної панелі.",
    actionInProgress: "Ще зберігається інша зміна інформаційної панелі.",
    announcement: {
      moved: "Переміщено {title}.",
      resized: "Змінено розмір {title}.",
      removed: "Вилучено {title}.",
      granted: "Доступ до віджета дозволено.",
      rejected: "Доступ до віджета відхилено.",
    },
    widget: {
      cellLabel:
        "Віджет інформаційної панелі: {title}. Використовуйте клавіші зі стрілками для навігації. Утримуйте Alt і натисніть клавішу зі стрілкою, щоб перемістити його.",
      moveHandle: "Перемістити {title}",
      resizeHandle: "Змінити розмір {title}",
      menuLabel: "Параметри віджета",
      moveToTab: "Перемістити на вкладку",
      noOtherTabs: "Немає інших вкладок",
      resize: "Змінити розмір",
      autoHeight: "Автоматична висота",
      remove: "Видалити",
      ...
      rejectedDetail: "Цей віджет залишається неактивним, доки його не буде видалено або замінено.",
      appLoading: "Відновлення застосунку…",
      appStaleTitle: "Цей закріплений застосунок застарів",
      appStaleDetail: "Його сервер, ресурс або початкова транскрипція більше недоступні.",
      retry: "Повторити",
      frameResolverMissing: "Вміст віджета недоступний.",
      sandboxUnavailable: "Хост пісочниці віджета недоступний.",
      frameAuthorizationFailed: "Не вдалося авторизувати віджет після повторних спроб оновлення.",
      sandboxOriginRequired:
        "Не вдалося авторизувати віджет після повторних спроб оновлення. Якщо gateway працює за зворотним проксі або тунелем, який не маршрутизує порт пісочниці віджета, установіть mcp.apps.sandboxOrigin на окреме публічне джерело, маршрутизоване до слухача пісочниці.",
      errorTitle: "Не вдалося завантажити цей віджет",
      errorDetail: "Проблема обмежена цією карткою.",
      actionErrorTitle: "Не вдалося змінити віджет",
      actionErrorDetail: "Панель зберегла попередній стан віджета.",
      errorShow: "Показати деталі",
      kindMcp: "MCP",
      kindHtml: "HTML",
      kindPlugin: "Плагін",
      pluginLoading: "Завантаження віджета плагіна…",
      disabledPlugin: "Віджет вимкненого плагіна {pluginId}",
    },
  },
  workboard: {
    widget: {
      cardLabel: "Картка Workboard",
      summaryLabel: "Підсумок Workboard",
      loading: "Завантаження Workboard…",
      cardIdRequired: "Цьому віджету потрібен параметр cardId.",
      cardMissing: "Ця картка Workboard більше недоступна.",
      unassigned: "Не призначено",
      openBoard: "Відкрити дошку",
      statusCounts: "Картки за статусом",
      noActiveCards: "Немає готових або запущених карток.",
    },
    ...
    dashboardEmpty: "Ще немає панелі — робочий агент може закріплювати віджети.",
  ...
  modelProviders: {
    ...
    globalUsage: "Глобальне використання та вартість",
  ...
  usage: {
    ...
    details: {
      ...
      loadFailed: "Не вдалося завантажити {detail}: {error}",
  ...
  chat: {
    ...
    startupStatus: {
      ...
      provisioningEnvironment: "Підготовка середовища…",
    ...
    sessionHeader: {
      ...
      renameAria: "Перейменувати сесію {title}",
      renameInputAria: "Назва сесії",
      renameInputPlaceholder: "Назва сесії",
      workspaceAria: "Дії робочого простору для {workspace}",
      revealFinder: "Показати у Finder",
      revealFileExplorer: "Показати у File Explorer",
      revealFileManager: "Відкрити у файловому менеджері",
      ...
      untitledBranch: "Гілка без назви",
    ...
    board: {
      ...
      dockMenu: "Панель чату: {dock}",
      dockLeft: "Закріпити чат ліворуч",
      dockRight: "Закріпити чат праворуч",
      dockBottom: "Закріпити чат знизу",
      dockHidden: "Сховати чат",
      resizeDock: "Змінити розмір панелі чату",
      reopenChat: "Показати чат",
      workboardCard: "Картка робочої дошки: {title}, {status}",
      defaultTab: "Головна",
      mockPlaceholder: "Перегляд дошки · {tabs} вкладок · {widgets} віджетів",
      mockOverview: "Огляд",
      mockResearch: "Дослідження",
      mockSessionStatus: "Статус потоку",
      mockRecentFindings: "Останні висновки",
      mockSourceMap: "Карта джерел",
      resetTitle: "Скинути розмову?",
      resetDescription: "Контекст розмови скидається. Ваш дашборд залишається.",
    },
    catalog: {
    ...
    followUpModeServer: "Типове значення сервера ({mode})",
    followUpModeLoading: "завантаження…",
    ...
    workspaceConflict: {
      ...
      inspectCloud: "Перевірити першу хмарну версію",
      takeCloud: "Взяти першу хмарну версію",
      copyInspectCommand: "Копіювати команду перевірки хмари",
      copyTakeCommand: "Копіювати команду take-cloud",
      commandHelp:
      ...
      eventTitleMany: "Хмарний результат застосовано з {count} конфліктами",
      eventDescription: "Для цих шляхів збережено локальні версії; інші хмарні зміни застосовано.",
    },
    compaction: {
    ...
    questions: {
      ...
      skipping: "Пропускання…",
      skipped: "Пропущено",
      collapse: "Згорнути запитання",
      expand: "Розгорнути запитання",
      eyebrow: "Запитання",
      cardLabel: "Запитання від асистента",
      summaryLabel: "Результат запитання",
      timeRemaining: "Залишилось часу",
      ownAnswer: "Ваша власна відповідь…",
      ownAnswerFor: "Ваша власна відповідь на {header}",
      submitting: "Надсилання…",
      submitFailed: "Не вдалося надіслати: {error}",
      answered: "Відповідь отримано",
      answeredElsewhere: "Відповідь надано в іншому місці",
      unavailable: "Недоступно",
      expired: "Застарів",
      cancelled: "Скасовано",
    },
    imageLightbox: {
      ...
      open: "Відкрити зображення {title}",
      openOriginal: "Відкрити оригінал",
      close: "Закрити попередній перегляд зображення",
      untitled: "Зображення",
    },
    messages: {
      activity: "Активність",
      copySelection: "Копіювати",
      forkFromHere: "Відгалузити звідси",
      hide: "Приховати",
      hideConfirm: "Приховати це повідомлення в цьому браузері? Агент усе одно його бачить.",
      hideMessage: "Приховати повідомлення",
      hideTooltip: "Приховати лише в цьому браузері",
      ...
      rewindUnavailable: "Перемотування недоступне, поки агент працює",
      forkUnavailable: "Розгалуження недоступне, поки агент працює",
    ...
    observer: {
      title: "Спостерігач сеансу",
      expand: "Розгорнути спостерігач сеансу",
      collapse: "Згорнути спостерігач сеансу",
      hide: "Приховати спостерігач сеансу",
      show: "Показати спостерігач сеансу",
      plan: "План",
      progress: "{completed} з {total}",
      ...
      askUnavailable: "Спостерігач наразі не може відповісти.",
      boardCurrentStatus: "Поточний статус",
      boardTimeline: "Хронологія стану",
      boardCurrentRun: "Поточний запуск",
      boardPreviousRun: "Попередній запуск",
      boardUnknownRun: "Невизначений запуск",
      boardSinceYouLeft: "Відколи ви пішли",
      health: {
        "on-track": "За планом",
        grinding: "Працює",
        stuck: "Застряг",
        "waiting-on-user": "Очікує на вас",
        "wrapping-up": "Завершує",
        done: "Готово",
        failed: "Не пройдено",
      },
    },
    ...
    composer: {
      ...
      cameraAccessFailed: "Не вдалося отримати доступ до камери.",
      cameraBusy: "Камера зайнята або недоступна для браузера.",
      cameraFallback: "Камера {number}",
      cameraInput: "Камера",
      cameraListUnsupported: "Цей браузер не може переглядати список камер.",
      cameraNoneFound: "Камеру не знайдено.",
      cameraPageInactive: "Камери недоступні, поки ця сторінка неактивна.",
      cameraPermissionBlocked:
        "Доступ до камери заблоковано. Дозвольте доступ до камери й мікрофона в налаштуваннях сайту в браузері.",
      cameraPreview: "Перегляд камери",
      ...
      microphoneAppliesNextSession: "Зміни застосуються під час наступного сеансу Talk.",
      microphoneListUnsupported: "Цей браузер не може показати список входів мікрофона.",
      noCameras: "Додаткові камери не знайдено",
      ...
      holdToRecordSetting: "Утримуйте кнопку мікрофона для диктування",
      holdToRecordSettingDescription:
        "Утримуйте кнопку мікрофона в полі вводу, говоріть, а потім відпустіть, щоб вставити текст без надсилання.",
      dictationAudioUnsupported: "Gateway повернув непідтримуваний формат аудіо для диктування.",
      dictationBrowserAudioUnsupported:
        "Цей браузер не може захоплювати аудіо диктування на частоті 8 кГц.",
      dictationConnecting: "Запуск диктування…",
      dictationDisconnected: "Диктування зупинено, оскільки Gateway відключився.",
      dictationFailed: "Помилка диктування.",
      dictationFinalizing: "Завершення диктування…",
      dictationFinalizationTimedOut:
        "Диктування зупинено до того, як вдалося завершити останній частковий транскрипт.",
      dictationProviderUnavailable:
        "Для диктування не налаштовано жодного постачальника транскрипції.",
      dictationRecording: "Запис {elapsed}",
      dictationReleaseToInsert: "Відпустіть, щоб вставити диктування",
      ...
      selectedCameraUnavailable:
        "Вибрана камера недоступна. Виберіть іншу камеру або Системну за замовчуванням.",
      ...
      systemDefaultCamera: "Системний за замовчуванням",
    ...
    toolCards: {
      ...
      widgetActions: "Дії віджета",
      copyToClipboard: "Копіювати в буфер обміну",
      downloadFile: "Завантажити файл",
      widgetExportRerender:
        "Цей віджет потрібно повторно відобразити, щоб експортувати як зображення.",
      widgetExportFailed: "Не вдалося експортувати віджет. Спробуйте ще раз.",
      pinToDashboard: "Закріпити на панелі",
      pinToDashboardPending: "Закріплення…",
      pinnedToDashboard: "Закріплено",
    ...
    backgroundTasks: {
      ...
      expandTask: "Показати деталі для {title}",
      collapseTask: "Приховати деталі для {title}",
      detailLoading: "Завантаження деталей завдання…",
      detailFailed: "Не вдалося завантажити деталі завдання.",
      prompt: "Запит",
      output: "Результат",
      promptUnavailable: "Запит недоступний.",
      outputPending: "Результату ще немає.",
    },
    sessionDiff: {
      title: "Зміни",
    ...
    sessionDiscussion: {
      ...
      requiresWriteAccess: "Щоб відкрити це обговорення, потрібен доступ оператора на запис.",
      openExternal: "Відкрити обговорення в новій вкладці",
      frameTitle: "Обговорення сеансу",
      unavailable: "Це обговорення не можна вбудувати.",
    },
    workspaceFiles: {
  ...
  cron: {
    ...
    form: {
      ...
      summaryEverySecondOne: "Виконується щосекунди",
      ...
      summaryEverySeconds: "Виконується кожні {amount} секунд",
      ...
      script: "Скрипт",
      readOnlyPayloadHelp:
        "Це корисне навантаження було створено поза Control UI. Його вміст залишається доступним лише для читання й зберігається під час збереження інших змін.",
