...
export const id: TranslationMap = {
  ...
  chat: {
    ...
    observer: {
      title: "Pengamat sesi",
      expand: "Perluas pengamat sesi",
      collapse: "Ciutkan pengamat sesi",
      hide: "Sembunyikan pengamat sesi",
      show: "Tampilkan pengamat sesi",
      plan: "Rencana",
      ...
      askLabel: "Tanya tentang sesi ini",
      askPlaceholder: "Mengapa melakukan itu?",
      askSubmit: "Tanya",
      askPending: "Memeriksa observasi…",
      askBusy: "Observer sedang menjawab pertanyaan.",
      askUnavailable: "Observer tidak dapat menjawab saat ini.",
    ...
    backgroundTasks: {
      ...
      collapseTask: "Sembunyikan detail untuk {title}",
