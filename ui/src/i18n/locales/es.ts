...
export const es: TranslationMap = {
  common: {
    ...
    refresh: "Actualizar",
    retry: "Reintentar",
    staleData: "Se están mostrando datos desactualizados.",
    reload: "Recargar",
    reset: "Restablecer",
    restore: "Restaurar",
  ...
  channels: {
    ...
    pairing: {
      title: "Solicitudes de acceso a MD",
      subtitle:
        "Revisa a las personas que esperan para enviar mensajes directos a canales protegidos por emparejamiento.",
      channelFilter: "Canal",
      ...
      approve: "Aprobar",
      dismiss: "Descartar",
      approveAria: "Aprobar a {sender} para {channel}, cuenta {account}",
      dismissAria: "Descartar a {sender} para {channel}, cuenta {account}",
      requested: "Solicitado {ago}",
      expires: "Vence {ago}",
      senderDetails: "Detalles del remitente",
      missingPermission:
        "Esta conexión no tiene acceso operator.pairing, por lo que no se pueden revisar las solicitudes de MD.",
      noAccounts: "Ninguna cuenta de canal configurada usa el emparejamiento de remitentes de MD.",
      noRequests: "No hay solicitudes de acceso a MD pendientes.",
      noFilteredRequests: "Ninguna solicitud pendiente coincide con estos filtros.",
      limits:
        "Las solicitudes vencen después de {minutes} minutos. Cada cuenta de canal puede tener hasta {count} solicitudes pendientes.",
      detailTitle: "Acceso a MD",
      detailSubtitle:
        "Las personas deben ser aprobadas antes de que sus mensajes directos lleguen al agente.",
      pendingCount: "{count} pendientes",
      noPending: "No hay solicitudes pendientes",
      review: "Revisar solicitudes",
      approveDialogTitle: "Aprobar acceso a mensajes directos",
      dismissDialogTitle: "Descartar solicitud de acceso a mensajes directos",
      approveExplanation:
        "Esto permite que el remitente hable con el agente en mensajes directos. No otorga acceso a grupos.",
      dismissExplanation:
        "Esto elimina la solicitud actual pero no bloquea al remitente. Puede solicitar acceso de nuevo más adelante.",
      notifyRequester: "Notificar al solicitante después de la aprobación",
      makeCommandOwner: "Hacer también que este remitente sea el primer propietario de comandos",
      commandOwnerHelp:
        "Los propietarios de comandos pueden ejecutar comandos privilegiados y aprobar acciones peligrosas. Esta opción solo está disponible mientras no haya ningún propietario configurado.",
      commandOwnerNeedsAdmin:
        "No hay ningún propietario de comandos configurado. Esta conexión necesita operator.admin para asignar el primer propietario.",
      approvedNotice: "Acceso a mensajes directos aprobado.",
      approvedOwnerNotice:
        "Acceso a mensajes directos aprobado y se configuró el primer propietario de comandos.",
      approvedNotificationFailedNotice:
        "Acceso a mensajes directos aprobado, pero no se pudo entregar la notificación al solicitante.",
      approvedOwnerFailedNotice:
        "Acceso a mensajes directos aprobado, pero no se pudo configurar el primer propietario de comandos.",
      approvedFollowupsFailedNotice:
        "Acceso a mensajes directos aprobado, pero la notificación al solicitante y la configuración del propietario de comandos fallaron.",
      dismissedNotice:
        "Solicitud de acceso a mensajes directos descartada. El remitente puede solicitar acceso de nuevo.",
    },
    setup: {
      ...
      working: "Procesando…",
      sessionExpired:
        "Esta sesión de configuración expiró después de que se reiniciara el Gateway. Cierra este diálogo y luego inicia la configuración del canal de nuevo.",
      continue: "Continuar",
      finish: "Finalizar",
      copyText: "Copiar",
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "No se borró ninguna sesión de WhatsApp almacenada. Puede que ya no exista o que su directorio de autenticación requiera limpieza manual.",
    },
  ...
  nodes: {
    pairing: {
      ...
      getApps: "Obtén las aplicaciones",
  ...
  agentChip: {
    ...
    agents: "Agentes",
    openChat: "Chatear con {name}",
    offlineOpenSettings: "Sin conexión — abrir Configuración",
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "Los workers en la nube requieren el entorno de ejecución de OpenClaw; {runtime} está seleccionado.",
    ...
    cloudSyncsFolder: "Sincroniza {folder} con el worker en la nube",
    folder: "Carpeta",
    folderPlaceholder: "Espacio de trabajo del agente",
    places: "Lugares",
    recentFolders: "Recientes",
    runsOn: "Se ejecuta en {place}",
    ...
    worktree: "Worktree",
    checkingGit: "Comprobando la disponibilidad de Git…",
    gitCheckUnavailable:
      "No se pudo verificar Git para esta carpeta. Selecciónala de nuevo para reintentar.",
  ...
  sessionsView: {
    ...
    global: "Global",
    unknown: "Desconocido",
    sessionState: "Estado del hilo",
    all: "Todos",
    sessionArchived: "Hilo archivado",
    sessionsArchived: "Se archivaron {count} hilos",
    deleteAllArchived: "Eliminar todos los archivados…",
    deleteAllArchivedConfirm: "¿Eliminar {count} hilos archivados y sus transcripciones?",
    ...
    runFailedReason: "Ejecución fallida: {reason}",
    runErrorTimedOut: "Tiempo de espera agotado",
    runErrorUnknown: "Error desconocido",
    attentionRequired: "La sesión requiere atención",
    model: "Modelo",
    provider: "Proveedor",
    ...
    showChildSessions: "Mostrar {count} sesiones secundarias de {session}",
    hideChildSessions: "Ocultar {count} sesiones secundarias de {session}",
    childSessions: "Sesiones secundarias",
    showMoreChildren: "Mostrar {count} más",
    archived: "Archivada",
    pinned: "Fijadas",
    unread: "Unread",
    ...
    cloudWorkerPlacementConflicts:
      "Worker en la nube: {state} · {count} conflictos de espacio de trabajo",
    cloudWorkerDescendantConflict:
      "Worker secundario en la nube: 1 conflicto de espacio de trabajo",
    cloudWorkerDescendantConflicts:
      "Workers secundarios en la nube: {count} conflictos de espacio de trabajo",
    ...
    invalidEmojiIcon: "Introduce exactamente un emoji.",
    ...
    stopCloudWorker: "Detener el worker en la nube…",
    stopCloudWorkerConfirm: '¿Detener el worker en la nube de "{session}"?',
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileIdentity: "Tu perfil de gateway",
      ...
      profileHint:
        "JPEG, PNG o WebP. Las imágenes se recortan desde el centro y se redimensionan a 512px.",
      profileLoadFailed: "No se pudo cargar tu perfil.",
      profileSaveFailed: "No se pudo guardar tu perfil.",
      avatarInvalid: "Elige una imagen JPEG, PNG o WebP válida.",
      avatarTooLarge: "El avatar procesado sigue siendo demasiado grande.",
  ...
  configView: {
    ...
    syncedHint: "Sincronizado entre tus dispositivos a través del gateway.",
    notifications: {
      title: "Notificaciones push",
      nativeTitle: "Notificaciones",
      hint: "Recibe notificaciones push del navegador desde tu gateway.",
      nativeHint:
        "Las notificaciones se muestran de forma nativa por la app de OpenClaw en este Mac.",
      ...
      nativeBlockedHint:
        "Las notificaciones están desactivadas para OpenClaw en macOS. Permítelas en Ajustes del Sistema > Notificaciones.",
    },
    appearance: {
      theme: "Tema",
    ...
    sidebarPrefs: {
      title: "Barra lateral",
      hint: "Elige qué aparece mientras hay sesiones en ejecución.",
      liveActivity: "Mostrar actividad del agente en vivo en la barra lateral",
      liveActivityHint:
        "Muestra la última actividad del asistente o de herramientas debajo de las sesiones en ejecución.",
    },
    sessionObserver: {
      title: "Observador de sesiones",
      hint: "Resume las sesiones de larga duración con un modelo de utilidad pequeño.",
      toggle: "Observador de sesiones",
      toggleHint: "Genera resúmenes de estado en vivo para las sesiones de Control UI suscritas.",
      resolvedModel: "Modelo pequeño resuelto",
      modelAuto: "auto ({model})",
      modelConfigured: "configurado ({model})",
      modelDisabled: "deshabilitado",
      modelUnavailable: "no disponible (sin modelo pequeño)",
      modelPicker: "Modelo pequeño",
      modelPickerHint:
        "Se usa para los resúmenes del observador y otras tareas de utilidad breves.",
      modelCatalogUnavailable: "Catálogo de modelos explícito no disponible",
      auto: "Auto (predeterminado del proveedor)",
      disabled: "Desactivado",
      toggleNote: "Actualizar el observador de sesiones de Control UI",
      modelNote: "Actualizar el modelo de utilidad predeterminado",
    },
    connection: {
      title: "Conexión",
      gateway: "Gateway",
  ...
  execApproval: {
    ...
    otherPending: "Otras solicitudes pendientes",
    reviewRequest: "Revisar aprobación de {agent}: {command}",
    agentPendingOne: "{count} aprobación pendiente",
    agentPending: "{count} aprobaciones pendientes",
  ...
  terminal: {
    ...
    connecting: "Conectando con la sesión…",
    connectionTimedOut: "La sesión no se conectó en un plazo de 30 segundos.",
    tabLabel: "Shell {n}",
    tabHint: "{agent} · {cwd}",
  ...
  tabs: {
    ...
    modelSetup: "Configuración del modelo",
  ...
  subtitles: {
    ...
    apps: "Aplicaciones complementarias para teléfono, reloj, escritorio y navegador.",
    ...
    modelSetup: "Conecta un modelo de IA verificado",
    modelProviders: "Configured providers with plan, quota, and cost.",
    memoryImport: "Incorpora la memoria de Codex y Claude Code al espacio de trabajo de un agente.",
    notifications: "Notificaciones push del navegador desde tu gateway.",
    security: "Autenticación del Gateway, política de exec, perfil de herramientas y aprobaciones.",
    advanced:
      "Todas las secciones de configuración restantes, además del editor de archivos sin procesar.",
  ...
  modelSetup: {
    ...
    candidates: {
      ...
      signInNeeded: "Se requiere iniciar sesión",
      detected: "Detectado",
    ...
    failure: {
      ...
      rateLimit: "Límite de solicitudes alcanzado",
    ...
    errors: {
      requestFailed: "La solicitud de configuración del modelo falló.",
      activationFailed: "No se pudo activar el modelo.",
    },
    wizard: {
      ...
      copy: "Copiar",
      expires: "Caduca en {count} minutos",
      cancelled: "Se canceló el inicio de sesión con el proveedor.",
      sessionExpired:
        "Esta sesión de configuración expiró después de que se reiniciara el Gateway. Cierra este cuadro de diálogo y luego inicia de nuevo la configuración del modelo.",
      notComplete:
        "El inicio de sesión finalizó, pero la configuración del modelo aún no está completa.",
    },
  },
  memoryImport: {
  ...
  custodian: {
    ...
    subtitleCaretaker: "Configuración y cuidado del sistema.",
    exitSetup: "Salir de la configuración",
    newAgent: "Nuevo agente",
    hatchDraft: "¡Despierta, amigo!",
    placeholder: "Enviar mensaje a OpenClaw…",
    sensitivePlaceholder: "Introduce el valor sensible…",
    sensitiveReply: "Respuesta sensible enviada",
    send: "Enviar",
    thinking: "OpenClaw está pensando",
    earlier: "Anteriores",
    requestFailed: "OpenClaw no pudo responder. Inténtalo de nuevo.",
    connectionChanged:
      "La conexión con el Gateway cambió. Reintenta para continuar esta configuración.",
    sessionRestarted:
    ...
    history: {
      ...
      description: "Lo que cambió en este sistema, más reciente primero.",
      loading: "Cargando cambios recientes…",
      empty: "Aún no hay cambios registrados.",
      requestFailed: "OpenClaw no pudo cargar el historial de cambios.",
      loadMore: "Cargar más",
      loadingMore: "Cargando más…",
      changedPaths: "Rutas modificadas ({count})",
      invalidEdit: "Esta edición manual no pasó la validación de la configuración.",
      opaqueChange:
        "Se cambiaron el formato o los comentarios sin cambios visibles en las rutas de configuración.",
      sources: {
    ...
    nudge: {
      configReload: "La recarga de la configuración se detuvo — pregúntame qué pasó",
      channelAuth: "La autenticación de {channel} se degradó — pregúntame qué pasó",
      channelDisconnected: "{channel} acaba de desconectarse — pregúntame qué pasó",
  ...
  mcpServers: {
    ...
    addedSuccess: "Servidor MCP {name} añadido.",
    enabledSuccess: "Servidor MCP {name} habilitado.",
    disabledSuccess: "Servidor MCP {name} deshabilitado.",
    removedSuccess: "Servidor MCP {name} eliminado.",
    configUnavailable: "La configuración no está disponible; actualiza e inténtalo de nuevo.",
    connectRequired: "Conéctate al gateway para cambiar los servidores MCP.",
    adminRequired: "Los cambios en los servidores MCP requieren acceso de operator.admin.",
    enable: "Activar",
    disable: "Desactivar",
  ...
  mcpPage: {
    connectorsLink: "Descubre conectores de un clic en la página de Plugins.",
    servers: "Servidores",
    oauth: "OAuth",
    filtered: "Filtrado",
  ...
  labsPage: {
    intro:
      "Labs contiene capacidades experimentales que pueden cambiar, fallar o desaparecer entre versiones.",
    sectionTitle: "Funciones experimentales",
    sectionDescription:
      "Los cambios se guardan de inmediato y se aplican a las futuras ejecuciones del agente.",
    documentation: "Documentación",
    restartRequired: "Se requiere reiniciar el Gateway.",
    saveErrorTitle: "No se pudo actualizar la función",
    saveFailed: "No se pudo guardar la configuración de la función.",
    codeMode: {
      title: "Code Mode",
      description:
        "Permite que los agentes combinen herramientas en flujos de trabajo de JavaScript compactos y aislados.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    heroTagline:
      "Aplicaciones complementarias para tu teléfono, reloj, escritorio y navegador, además de plugins para ampliar lo que tu agente puede hacer.",
    sectionMobile: "En tu teléfono",
    havePhone: "¿Ya tienes la aplicación?",
    pairDevice: "Vincula tu dispositivo",
    sectionWatch: "En tu muñeca",
    sectionDesktop: "En tu escritorio",
    sectionBrowser: "En tu navegador",
    sectionCommunity: "Comunidad",
    badgeBundledIos: "Incluido con la aplicación de iOS",
    badgeBundledAndroid: "Incluido con la aplicación de Android",
    ctaAppStore: "App Store",
    ctaPlayStore: "Google Play",
    ctaDownload: "Descargar",
    ctaDocs: "Documentación",
    ctaSetupGuide: "Guía de configuración",
    ctaOpenPlugins: "Abrir Plugins",
    ctaBrowseClawHub: "Explorar ClawHub",
    linkDiscord: "Comunidad de Discord",
    linkDocs: "Documentación",
    cards: {
      ios: {
        title: "iPhone",
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Chats de un vistazo y respuestas rápidas desde tu muñeca.",
      },
      wearOs: {
        title: "Wear OS",
        desc: "La aplicación complementaria de Android extiende OpenClaw a tu reloj.",
      },
      macos: {
        title: "macOS",
        desc: "Complemento en la barra de menús para tu Gateway: notificaciones, aprobaciones y chat rápido.",
      },
      windows: {
        title: "Windows",
        desc: "La aplicación complementaria de Windows conecta tu PC como un nodo de OpenClaw.",
      },
      linux: {
        title: "Linux",
        desc: "Aplicación de escritorio nativa: compilaciones .deb y AppImage.",
      },
      chrome: {
        title: "Extensión de Chrome",
        desc: "Deja que OpenClaw controle tu Chrome existente: pestañas, páginas y formularios.",
      },
      plugins: {
        title: "Plugins y ClawHub",
        desc: "Amplía OpenClaw con canales, herramientas y Skills de la comunidad.",
      },
    },
  },
  presence: {
    rosterLabel: "Mostrar quién está en línea",
    rosterTitle: "En línea",
  ...
  profilePage: {
    ...
    identity: {
      ...
      notSet: "La identidad no está configurada.",
      setIdentity: "Establecer identidad",
      avatar: "Avatar",
      avatarDescription: "PNG, JPEG o WebP. Las imágenes se redimensionan a 256 × 256 o menos.",
      chooseAvatar: "Elegir imagen",
      processingAvatar: "Procesando…",
      displayName: "Nombre para mostrar",
      displayNameDescription: "Se muestra a otras personas que usan este gateway.",
      linkedEmails: "Correos vinculados",
      linkedEmailsDescription: "Direcciones de correo conectadas a este perfil.",
      openSettings: "Abrir la configuración de identidad de {name}",
      avatarErrors: {
        invalid: "No se pudo procesar esa imagen.",
        sourceTooLarge: "Elige una imagen de 10 MB o menos.",
        tooLarge: "El avatar procesado es mayor de 512 KB.",
      },
    },
  },
  tasksPage: {
  ...
  gatewayLogs: {
    title: "Registros",
    subtitle: "Registros de archivo del Gateway (JSONL).",
    ...
    empty: "No hay entradas de registro.",
  },
  pluginTabs: {
  ...
  board: {
    label: "Panel de hilos",
    tabsLabel: "Pestañas del panel",
    moreTabs: "Más pestañas del panel",
    gridLabel: "Widgets del panel",
    emptyTitle: "Un panel despejado, listo para trabajar",
    emptyHint: "Tu agente puede fijar widgets aquí; prueba a pedir una tarjeta de estado.",
    actionFailed: "No se pudo guardar el cambio del panel.",
    actionInProgress: "Aún se está guardando otro cambio del panel.",
    announcement: {
      moved: "Se movió {title}.",
      resized: "Se cambió el tamaño de {title}.",
      removed: "Se eliminó {title}.",
      granted: "Acceso al widget permitido.",
      rejected: "Acceso al widget rechazado.",
    },
    widget: {
      cellLabel:
        "Widget del panel: {title}. Usa las teclas de flecha para navegar. Mantén Alt y pulsa una tecla de flecha para moverlo.",
      moveHandle: "Mover {title}",
      resizeHandle: "Cambiar el tamaño de {title}",
      menuLabel: "Opciones del widget",
      moveToTab: "Mover a la pestaña",
      noOtherTabs: "No hay otras pestañas",
      ...
      rejectedDetail: "Este widget permanece inactivo hasta que se elimine o reemplace.",
      appLoading: "Restaurando app…",
      appStaleTitle: "Esta app fijada está obsoleta",
      ...
      sandboxUnavailable: "El host del sandbox del widget no está disponible.",
      frameAuthorizationFailed:
        "La autorización del widget falló tras varios intentos de actualización.",
      sandboxOriginRequired:
        "La autorización del widget falló tras varios intentos de actualización. Si el gateway se ejecuta detrás de un proxy inverso o túnel que no enruta el puerto del sandbox del widget, establece mcp.apps.sandboxOrigin en un origen público dedicado enrutado al listener del sandbox.",
      errorTitle: "No se pudo cargar este widget",
      errorDetail: "El problema está contenido en esta tarjeta.",
      actionErrorTitle: "Error al cambiar el widget",
      actionErrorDetail: "El panel mantuvo el estado anterior del widget.",
      errorShow: "Mostrar detalles",
      kindMcp: "MCP",
      kindHtml: "HTML",
      kindPlugin: "Plugin",
      pluginLoading: "Cargando widget del complemento…",
      disabledPlugin: "Widget del complemento deshabilitado {pluginId}",
    },
  },
  workboard: {
    widget: {
      cardLabel: "Tarjeta de Workboard",
      summaryLabel: "Resumen de Workboard",
      loading: "Cargando Workboard…",
      cardIdRequired: "Este widget necesita una propiedad cardId.",
      cardMissing: "Esta tarjeta de Workboard ya no está disponible.",
      unassigned: "Sin asignar",
      openBoard: "Abrir tablero",
      statusCounts: "Tarjetas por estado",
      noActiveCards: "No hay tarjetas listas o en ejecución.",
    },
    ...
    dashboardEmpty: "Aún no hay panel — el agente en funcionamiento puede fijar widgets.",
    openSession: "Abrir sesión",
  ...
  modelProviders: {
    ...
    globalUsage: "Uso y coste globales",
  ...
  usage: {
    ...
    details: {
      ...
      loadFailed: "No se pudo cargar {detail}: {error}",
  ...
  chat: {
    ...
    startupStatus: {
      ...
      provisioningEnvironment: "Aprovisionando entorno…",
    ...
    sessionHeader: {
      ...
      branchSwitchRequiresAdmin: "El cambio de rama requiere acceso de administrador de operador.",
    ...
    board: {
      ...
      chatFace: "Chat",
      dashboardFace: "Panel",
      dockMenu: "Dock de chat: {dock}",
      dockLeft: "Anclar chat a la izquierda",
      dockRight: "Anclar chat a la derecha",
      dockBottom: "Anclar chat abajo",
      dockHidden: "Ocultar chat",
      resizeDock: "Redimensionar panel de chat",
      reopenChat: "Mostrar chat",
      workboardCard: "Tarjeta del tablero: {title}, {status}",
      defaultTab: "Principal",
      mockPlaceholder: "Vista del tablero · {tabs} pestañas · {widgets} widgets",
      mockOverview: "Descripción general",
      mockResearch: "Investigación",
      mockSessionStatus: "Estado del hilo",
      mockRecentFindings: "Hallazgos recientes",
      mockSourceMap: "Mapa de fuentes",
      resetTitle: "¿Restablecer la conversación?",
      resetDescription: "El contexto de la conversación se restablece. Tu panel se mantiene.",
    },
    catalog: {
    ...
    workspaceConflict: {
      titleOne: "1 conflicto de espacio de trabajo en la nube",
      titleMany: "{count} conflictos de espacio de trabajo en la nube",
      description:
        "OpenClaw conservó tus versiones locales y aplicó los otros cambios de la nube. Inspecciona el resultado preparado o toma su versión para una ruta en conflicto.",
      morePaths: "+{count} rutas más",
      stagedResult: "Resultado preparado de la nube",
      copyStagedResult: "Copiar referencia del resultado preparado",
      inspectCloud: "Inspeccionar la primera versión en la nube",
      takeCloud: "Tomar la primera versión en la nube",
      copyInspectCommand: "Copiar comando de inspección de la nube",
      copyTakeCommand: "Copiar comando take-cloud",
      commandHelp:
        "Ejecuta estos en Bash o zsh (Git Bash en Windows). Si la inspección indica que la ruta no existe, la nube la eliminó; verifica y elimina la ruta local manualmente. Si checkout informa un conflicto de archivo/directorio, mueve o elimina la ruta local que lo bloquea y vuelve a intentarlo. Si falta la referencia preparada, el aviso está obsoleto; no cambies la ruta local.",
      commandsUnavailable:
        "Este nombre de archivo contiene caracteres de control de terminal, por lo que OpenClaw no creará un comando de shell copiable para él. Inspecciona directamente la referencia preparada e introduce la ruta manualmente con cuidado.",
      dismiss: "Descartar aviso de conflicto del espacio de trabajo",
      eventSender: "Espacio de trabajo en la nube",
      eventTitleOne: "Resultado en la nube aplicado con 1 conflicto",
      eventTitleMany: "Resultado en la nube aplicado con {count} conflictos",
      eventDescription:
        "Se conservaron las versiones locales para estas rutas; se aplicaron otros cambios de la nube.",
    },
    compaction: {
    ...
    sidebar: {
      ...
      updateMacAndGateway: "Actualizar la app para Mac y Gateway",
    ...
    questions: {
      ...
      skipping: "Omitiendo…",
      skipped: "Omitidas",
      collapse: "Contraer pregunta",
      expand: "Expandir pregunta",
      eyebrow: "Pregunta",
      cardLabel: "Pregunta del asistente",
      summaryLabel: "Resultado de la pregunta",
      timeRemaining: "Tiempo restante",
      ownAnswer: "Tu propia respuesta…",
      ownAnswerFor: "Tu propia respuesta para {header}",
      submitting: "Enviando…",
      submitFailed: "No se pudo enviar: {error}",
      answered: "Respondida",
      answeredElsewhere: "Respondida en otro lugar",
      unavailable: "No disponible",
      expired: "Caducado",
      cancelled: "Cancelado",
    },
    imageLightbox: {
      label: "Vista previa de imagen: {title}",
      open: "Abrir imagen {title}",
    ...
    messages: {
      ...
      hide: "Ocultar",
      hideConfirm: "¿Ocultar este mensaje en este navegador? El agente sigue viéndolo.",
      hideMessage: "Ocultar mensaje",
      hideTooltip: "Ocultar solo en este navegador",
      ...
      rewindUnavailable: "Rebobinar no está disponible mientras el agente trabaja",
      forkUnavailable: "Bifurcar no está disponible mientras el agente trabaja",
    ...
    modelControls: {
      ...
      reasoning: "Razonamiento",
      speed: "Velocidad",
      sessionOverride: "Anulación del hilo",
      usingDefault: "Usando el valor predeterminado de Configuración",
      resetToDefault: "Restablecer al valor predeterminado ({model})",
    },
    sideChat: {
      title: "Chat lateral",
    ...
    observer: {
      title: "Observador de sesión",
      expand: "Expandir observador de sesión",
      collapse: "Contraer observador de sesión",
      hide: "Ocultar observador de sesión",
      show: "Mostrar observador de sesión",
      plan: "Plan",
      progress: "{completed} de {total}",
      pullRequests: "Pull requests",
      running: "En ejecución",
      checksPassing: "{count} correctas",
      checksFailing: "{count} fallidas",
      checksPending: "{count} en ejecución",
      askLabel: "Pregunta sobre esta sesión",
      askPlaceholder: "¿Por qué hace eso?",
      askSubmit: "Preguntar",
      askPending: "Comprobando las observaciones…",
      askBusy: "El observador ya está respondiendo una pregunta.",
      askUnavailable: "El observador no puede responder ahora mismo.",
      boardCurrentStatus: "Estado actual",
      boardTimeline: "Cronología de estado",
      boardCurrentRun: "Ejecución actual",
      boardPreviousRun: "Ejecución anterior",
      boardUnknownRun: "Ejecución no identificada",
      boardSinceYouLeft: "Desde que te fuiste",
      health: {
        "on-track": "En marcha",
        grinding: "Trabajando",
        stuck: "Atascado",
        "waiting-on-user": "Esperándote",
    ...
    composer: {
      ...
      cameraFallback: "Cámara {number}",
      cameraInput: "Cámara",
      cameraListUnsupported: "Este navegador no puede enumerar las cámaras.",
      cameraNoneFound: "No se encontró ninguna cámara.",
      cameraPageInactive: "Las cámaras no están disponibles mientras esta página está inactiva.",
      ...
      microphoneAppliesNextSession:
        "Los cambios se aplican cuando inicies tu próxima sesión de Talk.",
      microphoneListUnsupported: "Este navegador no puede listar las entradas de micrófono.",
      noCameras: "No se encontraron cámaras adicionales",
      ...
      holdToRecordSetting: "Mantén presionado el botón del micrófono para dictar",
      holdToRecordSettingDescription:
        "Mantén presionado el botón del micrófono del redactor, habla y luego suéltalo para insertar el texto sin enviarlo.",
      dictationAudioUnsupported:
        "El Gateway devolvió un formato de audio de dictado no compatible.",
      dictationBrowserAudioUnsupported:
        "Este navegador no puede capturar audio de dictado a 8 kHz.",
      dictationConnecting: "Iniciando dictado…",
      dictationDisconnected: "El dictado se detuvo porque el Gateway se desconectó.",
      dictationFailed: "El dictado falló.",
      dictationFinalizing: "Finalizando dictado…",
      dictationFinalizationTimedOut:
        "El dictado se detuvo antes de poder finalizar la última transcripción parcial.",
      dictationProviderUnavailable:
        "No hay ningún proveedor de transcripción configurado para el dictado.",
      dictationRecording: "Grabando {elapsed}",
      dictationReleaseToInsert: "Suelta para insertar el dictado",
      ...
      selectedCameraUnavailable:
        "La cámara seleccionada no está disponible. Elige otra cámara o la predeterminada del sistema.",
      ...
      systemDefaultCamera: "Predeterminado del sistema",
    ...
    toolCards: {
      ...
      widgetExportRerender: "Este widget debe volver a renderizarse para exportarlo como imagen.",
      widgetExportFailed: "Error al exportar el widget. Inténtalo de nuevo.",
      pinToDashboard: "Fijar al panel",
      pinToDashboardPending: "Fijando…",
      pinnedToDashboard: "Fijadas",
    ...
    sessionDiscussion: {
      ...
      opening: "Abriendo debate…",
      requiresWriteAccess: "Se requiere acceso de escritura de operador para abrir este debate.",
      openExternal: "Abrir debate en una nueva pestaña",
      frameTitle: "Debate de la sesión",
      unavailable: "Este debate no se puede incrustar.",
    },
    workspaceFiles: {
  ...
  cron: {
    ...
    form: {
      ...
      repeatStream: "Fuente de transmisión",
      onExitHelp:
      ...
      summaryEverySecondOne: "Se ejecuta cada segundo",
      ...
      summaryEverySeconds: "Se ejecuta cada {amount} segundos",
      ...
      script: "Script",
      readOnlyPayloadHelp:
        "Este payload se creó fuera de Control UI. Su contenido permanece de solo lectura y se conserva cuando guardas otros cambios.",
