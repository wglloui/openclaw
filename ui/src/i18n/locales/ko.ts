...
export const ko: TranslationMap = {
  ...
  channels: {
    ...
    pairing: {
      title: "DM 접근 요청",
      subtitle:
        "페어링으로 보호된 채널에 다이렉트 메시지를 보내려고 대기 중인 사람들을 검토하세요.",
      channelFilter: "채널",
      accountFilter: "계정",
      allChannels: "모든 채널",
      allAccounts: "모든 계정",
      approve: "승인",
      dismiss: "무시",
      approveAria: "{channel} 채널, 계정 {account}에 대해 {sender} 승인",
      dismissAria: "{channel} 채널, 계정 {account}에 대해 {sender} 무시",
      requested: "{ago}에 요청됨",
      expires: "{ago}에 만료",
      senderDetails: "발신자 세부 정보",
      missingPermission:
        "이 연결에는 operator.pairing 접근 권한이 없어 DM 요청을 검토할 수 없습니다.",
      noAccounts: "DM 발신자 페어링을 사용하는 채널 계정이 없습니다.",
      noRequests: "대기 중인 DM 접근 요청이 없습니다.",
      noFilteredRequests: "이 필터와 일치하는 대기 중인 요청이 없습니다.",
      limits:
        "요청은 {minutes}분 후에 만료됩니다. 각 채널 계정은 최대 {count}개의 대기 중인 요청을 보유할 수 있습니다.",
      detailTitle: "DM 접근",
      detailSubtitle: "직접 메시지가 에이전트에 도달하려면 먼저 승인을 받아야 합니다.",
      pendingCount: "{count}개 대기 중",
      noPending: "대기 중인 요청 없음",
      review: "요청 검토",
      approveDialogTitle: "DM 액세스 승인",
      dismissDialogTitle: "DM 액세스 요청 해제",
      approveExplanation:
        "이렇게 하면 발신자가 직접 메시지에서 에이전트와 대화할 수 있습니다. 그룹 액세스 권한은 부여되지 않습니다.",
      dismissExplanation:
        "현재 요청을 제거하지만 발신자를 차단하지는 않습니다. 발신자는 나중에 다시 액세스를 요청할 수 있습니다.",
      notifyRequester: "승인 후 요청자에게 알림",
      makeCommandOwner: "이 발신자를 첫 번째 명령 소유자로도 지정",
      commandOwnerHelp:
        "명령 소유자는 권한이 필요한 명령을 실행하고 위험한 작업을 승인할 수 있습니다. 이 옵션은 소유자가 구성되지 않은 경우에만 사용할 수 있습니다.",
      commandOwnerNeedsAdmin:
        "명령 소유자가 구성되지 않았습니다. 첫 번째 소유자를 지정하려면 이 연결에 operator.admin이 필요합니다.",
      approvedNotice: "DM 액세스가 승인되었습니다.",
      approvedOwnerNotice: "DM 액세스가 승인되고 첫 번째 명령 소유자가 구성되었습니다.",
      approvedNotificationFailedNotice:
        "DM 액세스가 승인되었지만 요청자 알림을 전달할 수 없습니다.",
      approvedOwnerFailedNotice:
        "DM 액세스가 승인되었지만 첫 번째 명령 소유자를 구성할 수 없습니다.",
      approvedFollowupsFailedNotice:
        "DM 액세스가 승인되었지만 요청자 알림과 명령 소유자 설정이 모두 실패했습니다.",
      dismissedNotice:
        "DM 액세스 요청이 해제되었습니다. 발신자는 다시 액세스를 요청할 수 있습니다.",
    },
    setup: {
      ...
      working: "작업 중…",
      sessionExpired:
        "이 설정 세션은 Gateway가 다시 시작된 후 만료되었습니다. 이 대화 상자를 닫은 다음 채널 설정을 다시 시작하세요.",
      continue: "계속",
      finish: "완료",
      copyText: "복사",
      openLink: "링크 열기",
    ...
    whatsapp: {
      ...
      loggedOut: "로그아웃되었습니다.",
      logoutNotCleared:
        "저장된 WhatsApp 세션이 지워지지 않았습니다. 이미 없거나 인증 디렉터리를 수동으로 정리해야 할 수 있습니다.",
    },
  ...
  agentChip: {
    menuLabel: "에이전트 메뉴",
    agents: "에이전트",
    openChat: "{name}와(과) 채팅",
    offlineOpenSettings: "오프라인 — 설정 열기",
    switchAgent: "에이전트 전환",
    working: "작업 중…",
    ready: "채팅할 준비가 되었습니다",
  ...
  newSession: {
    ...
    hiddenFolder: "숨김 폴더",
    worktree: "Worktree",
    checkingGit: "Git 사용 가능 여부 확인 중…",
    gitCheckUnavailable: "이 폴더의 Git을 확인할 수 없습니다. 다시 선택하여 재시도하세요.",
  ...
  sessionsView: {
    ...
    sessionState: "스레드 상태",
    all: "전체",
    sessionArchived: "스레드 보관됨",
    sessionsArchived: "스레드 {count}개 보관됨",
    deleteAllArchived: "보관된 항목 모두 삭제…",
    deleteAllArchivedConfirm: "보관된 스레드 {count}개와 그 대화 기록을 삭제할까요?",
    ...
    sessionId: "세션 ID",
    activeRun: "활성 실행",
    showChildSessions: "{session}의 하위 세션 {count}개 표시",
    hideChildSessions: "{session}의 하위 세션 {count}개 숨기기",
    childSessions: "하위 세션",
    showMoreChildren: "{count}개 더 보기",
    archived: "보관됨",
    pinned: "고정됨",
    unread: "Unread",
    ...
    cloudWorkerDescendantConflict: "클라우드 워커 하위: 작업 공간 충돌 1개",
    cloudWorkerDescendantConflicts: "클라우드 워커 하위: 작업 공간 충돌 {count}개",
    ...
    changeIcon: "아이콘 변경",
    customEmoji: "커스텀 이모지",
    invalidEmojiIcon: "이모지를 정확히 하나만 입력하세요.",
    removeIcon: "아이콘 제거",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      saving: "저장 중…",
      uploading: "처리 중…",
      profileHint: "JPEG, PNG 또는 WebP. 이미지는 중앙을 기준으로 잘리고 512px로 조정됩니다.",
      profileLoadFailed: "프로필을 불러올 수 없습니다.",
      profileSaveFailed: "프로필을 저장할 수 없습니다.",
      avatarInvalid: "유효한 JPEG, PNG 또는 WebP 이미지를 선택하세요.",
      avatarTooLarge: "처리된 아바타가 여전히 너무 큽니다.",
  ...
  configView: {
    ...
    syncedHint: "gateway를 통해 여러 기기에서 동기화됩니다.",
    notifications: {
      title: "푸시 알림",
      nativeTitle: "알림",
    ...
    sidebarPrefs: {
      title: "사이드바",
      hint: "세션이 실행 중일 때 표시할 항목을 선택합니다.",
      liveActivity: "사이드바에 실시간 에이전트 활동 표시",
      liveActivityHint: "실행 중인 세션 아래에 최신 어시스턴트 또는 도구 활동을 표시합니다.",
    },
    sessionObserver: {
      title: "세션 관찰자",
      hint: "소형 유틸리티 모델로 장기 실행 세션을 요약합니다.",
      toggle: "세션 관찰자",
      toggleHint: "구독된 Control UI 세션에 대해 실시간 상태 요약을 생성합니다.",
      resolvedModel: "확정된 소형 모델",
      modelAuto: "자동 ({model})",
      modelConfigured: "구성됨 ({model})",
      modelDisabled: "비활성화됨",
      modelUnavailable: "사용 불가 (소형 모델 없음)",
      modelPicker: "소형 모델",
      modelPickerHint: "관찰자 요약 및 기타 짧은 유틸리티 작업에 사용됩니다.",
      modelCatalogUnavailable: "명시적 모델 카탈로그를 사용할 수 없음",
      auto: "자동 (제공자 기본값)",
      disabled: "비활성화됨",
      toggleNote: "Control UI 세션 관찰자 업데이트",
      modelNote: "기본 유틸리티 모델 업데이트",
    },
    connection: {
      title: "연결",
      gateway: "Gateway",
  ...
  execApproval: {
    ...
    otherPending: "기타 대기 중인 요청",
    reviewRequest: "{agent}의 승인 검토: {command}",
    agentPendingOne: "대기 중인 승인 {count}개",
    agentPending: "대기 중인 승인 {count}개",
  ...
  terminal: {
    ...
    uploadProgress: "{total}개 중 {current}개 업로드 중",
    uploadFailed: "업로드 실패",
    retryUpload: "재시도",
  ...
  subtitles: {
    ...
    apps: "휴대폰, 워치, 데스크톱, 브라우저용 동반 앱입니다.",
    approvals: "최근 실행, 플러그인 및 시스템 에이전트 승인입니다.",
    ...
    modelSetup: "검증된 AI 모델 연결",
    modelProviders: "Configured providers with plan, quota, and cost.",
    memoryImport: "Codex와 Claude Code 메모리를 에이전트 작업 공간으로 가져옵니다.",
    notifications: "Gateway에서 보내는 브라우저 푸시 알림입니다.",
    security: "Gateway 인증, 실행 정책, 도구 프로필, 승인.",
    advanced: "나머지 모든 구성 섹션과 원본 파일 편집기입니다.",
    debug: "스냅샷, 이벤트, RPC.",
    logs: "실시간 Gateway 로그.",
  ...
  modelSetup: {
    ...
    errors: {
      requestFailed: "모델 설정 요청에 실패했습니다.",
      activationFailed: "모델을 활성화할 수 없습니다.",
    },
    wizard: {
      ...
      continue: "계속",
      submit: "제출",
      openSignIn: "로그인 페이지 열기",
      copy: "복사",
      expires: "{count}분 후 만료",
      cancelled: "제공업체 로그인이 취소되었습니다.",
      sessionExpired:
        "이 설정 세션은 Gateway가 다시 시작된 후 만료되었습니다. 이 대화 상자를 닫은 다음 모델 설정을 다시 시작하세요.",
      notComplete: "로그인은 완료되었지만 모델 설정은 아직 완료되지 않았습니다.",
    },
  },
  memoryImport: {
  ...
  custodian: {
    ...
    history: {
      ...
      invalidEdit: "이 수동 편집은 구성 검증을 통과하지 못했습니다.",
      opaqueChange: "표시되는 구성 경로 변경 없이 서식이나 주석이 변경되었습니다.",
      sources: {
    ...
    nudge: {
      configReload: "구성 다시 로드가 중지되었습니다 — 무슨 일이 있었는지 물어보세요",
      channelAuth: "{channel} 인증이 저하되었습니다 — 무슨 일이 있었는지 물어보세요",
      channelDisconnected: "{channel} 연결이 방금 끊어졌습니다 — 무슨 일이 있었는지 물어보세요",
  ...
  mcpServers: {
    ...
    addedSuccess: "MCP 서버 {name}을(를) 추가했습니다.",
    enabledSuccess: "MCP 서버 {name}을(를) 활성화했습니다.",
    disabledSuccess: "MCP 서버 {name}을(를) 비활성화했습니다.",
    removedSuccess: "MCP 서버 {name}을(를) 제거했습니다.",
    configUnavailable: "구성을 사용할 수 없습니다. 새로고침 후 다시 시도하세요.",
    connectRequired: "MCP 서버를 변경하려면 게이트웨이에 연결하세요.",
    adminRequired: "MCP 서버 변경에는 operator.admin 접근 권한이 필요합니다.",
    enable: "활성화",
    disable: "비활성화",
    removeNamed: "{name} 제거",
    working: "작업 중…",
  ...
  labsPage: {
    intro: "Labs에는 릴리스 간에 변경, 중단 또는 사라질 수 있는 실험적 기능이 포함되어 있습니다.",
    sectionTitle: "실험적 기능",
    sectionDescription: "변경 사항은 즉시 저장되며 이후 에이전트 실행에 적용됩니다.",
    documentation: "문서",
    restartRequired: "Gateway 재시작이 필요합니다.",
    saveErrorTitle: "기능을 업데이트할 수 없음",
    saveFailed: "기능 설정을 저장할 수 없습니다.",
    codeMode: {
      title: "Code Mode",
      description:
        "에이전트가 컴팩트하고 샌드박스화된 JavaScript 워크플로에서 도구를 결합할 수 있게 합니다.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    sectionMobile: "휴대폰에서",
    havePhone: "이미 앱이 있으신가요?",
    pairDevice: "기기 페어링",
    sectionWatch: "손목에서",
    sectionDesktop: "데스크톱에서",
    sectionBrowser: "브라우저에서",
    sectionCommunity: "커뮤니티",
    badgeBundledIos: "iOS 앱에 포함됨",
    badgeBundledAndroid: "Android 앱에 포함됨",
    ctaAppStore: "App Store",
    ctaPlayStore: "Google Play",
    ctaDownload: "다운로드",
    ctaDocs: "문서",
    ctaSetupGuide: "설정 가이드",
    ctaOpenPlugins: "플러그인 열기",
    ctaBrowseClawHub: "ClawHub 둘러보기",
    linkDiscord: "Discord 커뮤니티",
    linkDocs: "문서",
    cards: {
      ios: {
        title: "iPhone",
      ...
      macos: {
        title: "macOS",
        desc: "Gateway용 메뉴 막대 컴패니언 — 알림, 승인, 빠른 채팅.",
      },
      windows: {
        title: "Windows",
      ...
      linux: {
        title: "Linux",
        desc: "네이티브 데스크톱 앱 — .deb 및 AppImage 빌드.",
      },
      chrome: {
  ...
  profilePage: {
    ...
    identity: {
      ...
      notSet: "신원이 설정되지 않았습니다.",
      setIdentity: "신원 설정",
      avatar: "아바타",
      avatarDescription: "PNG, JPEG 또는 WebP. 이미지는 256 × 256 이하로 크기가 조정됩니다.",
      chooseAvatar: "이미지 선택",
      processingAvatar: "처리 중…",
      displayName: "표시 이름",
      displayNameDescription: "이 게이트웨이를 사용하는 다른 사람에게 표시됩니다.",
      linkedEmails: "연결된 이메일",
      linkedEmailsDescription: "이 프로필에 연결된 이메일 주소입니다.",
      openSettings: "{name}의 ID 설정 열기",
      avatarErrors: {
        invalid: "해당 이미지를 처리할 수 없습니다.",
        sourceTooLarge: "10MB 이하의 이미지를 선택하세요.",
        tooLarge: "처리된 아바타가 512KB보다 큽니다.",
      },
    },
  },
  tasksPage: {
  ...
  gatewayLogs: {
    title: "로그",
    subtitle: "Gateway 파일 로그(JSONL)입니다.",
    ...
    autoFollow: "자동 따라가기",
    file: "파일: {file}",
    truncated: "로그 출력이 잘렸습니다. 최신 청크를 표시합니다.",
    empty: "로그 항목이 없습니다.",
  },
  pluginTabs: {
  ...
  board: {
    label: "스레드 대시보드",
    tabsLabel: "대시보드 탭",
    moreTabs: "대시보드 탭 더 보기",
    gridLabel: "대시보드 위젯",
    emptyTitle: "작업 준비가 된 깨끗한 보드",
    emptyHint: "에이전트가 여기에 위젯을 고정할 수 있습니다 — 상태 카드를 요청해 보세요.",
    actionFailed: "대시보드 변경 사항을 저장할 수 없습니다.",
    actionInProgress: "다른 대시보드 변경 사항을 아직 저장하는 중입니다.",
    announcement: {
      moved: "{title}을(를) 이동했습니다.",
      resized: "{title} 크기를 조정했습니다.",
      removed: "{title}을(를) 제거했습니다.",
      granted: "위젯 액세스가 허용되었습니다.",
      rejected: "위젯 액세스가 거부되었습니다.",
    },
    widget: {
      cellLabel:
        "대시보드 위젯: {title}. 화살표 키로 이동하세요. Alt를 누른 상태에서 화살표 키를 누르면 위젯을 옮길 수 있습니다.",
      moveHandle: "{title} 이동",
      resizeHandle: "{title} 크기 조정",
      menuLabel: "위젯 옵션",
      moveToTab: "탭으로 이동",
      noOtherTabs: "다른 탭 없음",
      resize: "크기 조정",
      ...
      remove: "제거",
      needsApproval: "승인 필요",
      needsApprovalDetail: "이 위젯이 추가 액세스를 요청했습니다.",
      ...
      reject: "거부",
      rejected: "액세스가 거부됨",
      rejectedDetail: "이 위젯은 제거되거나 교체될 때까지 비활성 상태로 유지됩니다.",
      appLoading: "앱 복원 중…",
      appStaleTitle: "이 고정된 앱은 오래되었습니다",
      ...
      frameAuthorizationFailed: "여러 차례 새로 고침을 시도했지만 위젯 인증에 실패했습니다.",
      sandboxOriginRequired:
        "여러 차례 새로 고침을 시도했지만 위젯 인증에 실패했습니다. Gateway가 위젯 샌드박스 포트를 라우팅하지 않는 리버스 프록시 또는 터널 뒤에서 실행되는 경우, mcp.apps.sandboxOrigin을 샌드박스 리스너로 라우팅되는 전용 공개 origin으로 설정하세요.",
      errorTitle: "이 위젯을 로드할 수 없습니다",
      errorDetail: "문제는 이 카드에만 국한됩니다.",
      actionErrorTitle: "위젯 변경 실패",
      actionErrorDetail: "대시보드가 이전 위젯 상태를 유지했습니다.",
      errorShow: "세부 정보 표시",
      kindMcp: "MCP",
      kindHtml: "HTML",
      kindPlugin: "플러그인",
      pluginLoading: "플러그인 위젯 로드 중…",
      disabledPlugin: "비활성화된 플러그인 {pluginId}의 위젯",
    },
  },
  workboard: {
    widget: {
      cardLabel: "워크보드 카드",
      summaryLabel: "Workboard 요약",
      loading: "Workboard 로드 중…",
      cardIdRequired: "이 위젯에는 cardId prop이 필요합니다.",
      cardMissing: "이 Workboard 카드를 더 이상 사용할 수 없습니다.",
      unassigned: "할당되지 않음",
      openBoard: "보드 열기",
      statusCounts: "상태별 카드",
      noActiveCards: "준비 또는 실행 중인 카드가 없습니다.",
    },
    ...
    detailAddNote: "메모 추가",
    dashboardTitle: "대시보드",
    dashboardEmpty: "아직 대시보드가 없습니다 — 작업 에이전트가 위젯을 고정할 수 있습니다.",
    openSession: "세션 열기",
  ...
  attention: {
    ...
    pendingApproval: "대기 중인 승인 {count}개",
    pendingApprovals: "대기 중인 승인 {count}개",
  },
  approvalHistory: {
    description:
      "이 Gateway에서 기록된 터미널 실행, 플러그인 및 시스템 에이전트 승인입니다. 최신순으로 표시됩니다.",
    loading: "승인 기록을 불러오는 중…",
    loadingMore: "불러오는 중…",
    loadMore: "더 보기",
    empty: "최근 30일 동안 처리된 승인이 없습니다.",
    retention: "승인 기록은 최근 30일 동안 보관됩니다.",
    offline: "승인 기록을 불러오려면 Gateway에 연결하세요.",
    invalidResponse: "Gateway에서 잘못된 승인 기록 응답을 반환했습니다.",
    unknown: "알 수 없음",
    notApplicable: "해당 없음",
    columns: {
      resolved: "처리됨",
    ...
    reasons: {
      user: "사용자 결정",
      timeout: "시간 초과",
      malformedVerdict: "잘못된 형식의 판정",
      noRoute: "경로 없음",
      runAborted: "실행 중단됨",
      gatewayRestart: "Gateway 재시작",
      storageCorrupt: "저장소 손상",
    },
  },
  palette: {
  ...
  usage: {
    ...
    details: {
      ...
      loadFailed: "{detail} 불러오기 실패: {error}",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      renameAria: "세션 {title} 이름 변경",
      renameInputAria: "세션 제목",
      renameInputPlaceholder: "세션 제목",
      workspaceAria: "{workspace}에 대한 워크스페이스 작업",
      revealFinder: "Finder에서 보기",
      revealFileExplorer: "파일 탐색기에서 보기",
      revealFileManager: "파일 관리자에서 열기",
      copyPath: "경로 복사",
    ...
    board: {
      ...
      dockBottom: "채팅 하단 고정",
      dockHidden: "채팅 숨기기",
      resizeDock: "채팅 도크 크기 조정",
      reopenChat: "채팅 표시",
      workboardCard: "워크보드 카드: {title}, {status}",
      defaultTab: "메인",
      mockPlaceholder: "보드 뷰 심 · 탭 {tabs}개 · 위젯 {widgets}개",
      mockOverview: "개요",
      mockResearch: "리서치",
      mockSessionStatus: "스레드 상태",
      mockRecentFindings: "최근 발견 사항",
      mockSourceMap: "소스 맵",
      resetTitle: "대화를 초기화할까요?",
      resetDescription: "대화 컨텍스트가 초기화됩니다. 대시보드는 유지됩니다.",
    },
    catalog: {
    ...
    followUpModeServer: "서버 기본값 ({mode})",
    followUpModeLoading: "불러오는 중…",
    ...
    workspaceConflict: {
      ...
      inspectCloud: "첫 번째 클라우드 버전 검사",
      takeCloud: "첫 번째 클라우드 버전 선택",
      copyInspectCommand: "클라우드 검사 명령 복사",
      copyTakeCommand: "take-cloud 명령 복사",
      commandHelp:
      ...
      eventTitleMany: "충돌 {count}건과 함께 클라우드 결과 적용됨",
      eventDescription:
        "이 경로에는 로컬 버전이 유지되었으며, 다른 클라우드 변경 사항이 적용되었습니다.",
    },
    compaction: {
      label: "압축된 기록",
    ...
    sidebar: {
      ...
      updateMacAndGateway: "Mac 앱 + Gateway 업데이트",
      updateGateway: "Gateway 업데이트",
      allSessions: "모든 세션",
      threads: "스레드",
      groups: "그룹",
      coding: "코딩",
      groupCatalogSessionsByProject: "프로젝트별 그룹화",
    ...
    questions: {
      ...
      timeRemaining: "남은 시간",
      ownAnswer: "직접 답변…",
      ownAnswerFor: "{header}에 대한 직접 답변",
      submitting: "제출 중…",
      submitFailed: "제출할 수 없습니다: {error}",
      answered: "응답 완료",
      answeredElsewhere: "다른 곳에서 답변됨",
      unavailable: "사용 불가",
      expired: "만료됨",
      cancelled: "취소됨",
    },
    imageLightbox: {
      label: "이미지 미리보기: {title}",
      open: "이미지 {title} 열기",
      openOriginal: "원본 열기",
      close: "이미지 미리보기 닫기",
      untitled: "이미지",
    ...
    messages: {
      activity: "활동",
      copySelection: "복사",
      forkFromHere: "여기서부터 분기",
      hide: "숨기기",
      hideConfirm: "이 브라우저에서 이 메시지를 숨길까요? 에이전트에게는 계속 표시됩니다.",
      hideMessage: "메시지 숨기기",
      hideTooltip: "이 브라우저에서만 숨기기",
      ...
      rewindUnavailable: "에이전트가 작업 중일 때는 되감기를 사용할 수 없습니다",
      forkUnavailable: "에이전트가 작업 중일 때는 분기를 사용할 수 없습니다",
      showLess: "간략히 보기",
      showMore: "더 보기",
    ...
    modelControls: {
      ...
      reasoning: "추론",
      speed: "속도",
      sessionOverride: "스레드 재정의",
      usingDefault: "설정의 기본값 사용",
      resetToDefault: "기본값으로 재설정 ({model})",
    },
    sideChat: {
      title: "사이드 채팅",
    ...
    observer: {
      ...
      show: "세션 관찰자 표시",
      plan: "계획",
      progress: "{total}개 중 {completed}개",
      pullRequests: "풀 리퀘스트",
      running: "실행 중",
      checksPassing: "{count}개 통과",
      checksFailing: "{count}개 실패",
      checksPending: "{count}개 실행 중",
      askLabel: "이 세션에 대해 질문하기",
      askPlaceholder: "왜 그렇게 하고 있나요?",
      askSubmit: "확인",
      askPending: "관찰 내용을 확인하는 중…",
      askBusy: "관찰자가 이미 질문에 답변하고 있습니다.",
      askUnavailable: "지금은 관찰자가 답변할 수 없습니다.",
      boardCurrentStatus: "현재 상태",
      boardTimeline: "상태 타임라인",
      boardCurrentRun: "현재 실행",
      boardPreviousRun: "이전 실행",
      boardUnknownRun: "식별되지 않은 실행",
      boardSinceYouLeft: "떠난 이후",
      health: {
        "on-track": "순조로움",
        grinding: "작업 중",
        stuck: "막힘",
        "waiting-on-user": "대기 중",
        "wrapping-up": "마무리 중",
        done: "완료",
        failed: "실패",
      },
    ...
    composer: {
      ...
      takePhoto: "사진 촬영",
      cameraAccessFailed: "카메라에 접근할 수 없습니다.",
      cameraBusy: "카메라가 사용 중이거나 브라우저에서 사용할 수 없습니다.",
      cameraFallback: "카메라 {number}",
      cameraInput: "카메라",
      cameraListUnsupported: "이 브라우저는 카메라 목록을 표시할 수 없습니다.",
      cameraNoneFound: "카메라를 찾을 수 없습니다.",
      cameraPageInactive: "이 페이지가 비활성 상태인 동안에는 카메라를 사용할 수 없습니다.",
      cameraPermissionBlocked:
        "카메라 접근이 차단되었습니다. 브라우저 사이트 설정에서 카메라 및 마이크 접근을 허용하세요.",
      ...
      microphoneAppliesNextSession: "변경 사항은 다음 Talk 세션을 시작할 때 적용됩니다.",
      microphoneListUnsupported: "이 브라우저는 마이크 입력 목록 표시를 지원하지 않습니다.",
      noCameras: "추가 카메라를 찾을 수 없습니다",
      ...
      holdToRecordSetting: "받아쓰기하려면 마이크 버튼을 길게 누르세요",
      holdToRecordSettingDescription:
        "작성창 마이크 버튼을 길게 누르고 말한 뒤 놓으면 전송하지 않고 텍스트가 삽입됩니다.",
      dictationAudioUnsupported: "Gateway가 지원되지 않는 받아쓰기 오디오 형식을 반환했습니다.",
      dictationBrowserAudioUnsupported:
        "이 브라우저는 8kHz로 받아쓰기 오디오를 캡처할 수 없습니다.",
      dictationConnecting: "받아쓰기를 시작하는 중…",
      dictationDisconnected: "Gateway 연결이 끊어져 받아쓰기가 중지되었습니다.",
      dictationFailed: "받아쓰기에 실패했습니다.",
      dictationFinalizing: "받아쓰기를 마무리하는 중…",
      dictationFinalizationTimedOut: "마지막 부분 전사가 완료되기 전에 받아쓰기가 중지되었습니다.",
      dictationProviderUnavailable: "받아쓰기에 사용할 전사 공급자가 구성되지 않았습니다.",
      dictationRecording: "녹음 중 {elapsed}",
      dictationReleaseToInsert: "놓으면 받아쓰기가 삽입됩니다",
    ...
    toolCards: {
      ...
      widgetExportRerender: "이 위젯을 이미지로 내보내려면 다시 렌더링해야 합니다.",
      widgetExportFailed: "위젯 내보내기에 실패했습니다. 다시 시도하세요.",
      pinToDashboard: "대시보드에 고정",
      pinToDashboardPending: "고정하는 중…",
      pinnedToDashboard: "고정됨",
    ...
    backgroundTasks: {
      ...
      expandTask: "{title}의 세부 정보 표시",
      collapseTask: "{title}의 세부 정보 숨기기",
      detailLoading: "작업 세부 정보를 불러오는 중…",
      detailFailed: "작업 세부 정보를 불러올 수 없습니다.",
      prompt: "프롬프트",
      output: "출력",
      promptUnavailable: "프롬프트를 사용할 수 없습니다.",
      outputPending: "아직 출력이 없습니다.",
    },
    sessionDiff: {
      title: "변경 사항",
      show: "세션 변경 사항 표시",
  ...
  cron: {
    ...
    form: {
      ...
      script: "스크립트",
      readOnlyPayloadHelp:
        "이 페이로드는 Control UI 외부에서 생성되었습니다. 내용은 읽기 전용으로 유지되며 다른 변경 사항을 저장할 때 보존됩니다.",
