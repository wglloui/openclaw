...
export const ja_JP: TranslationMap = {
  ...
  chat: {
    ...
    sidebar: {
      ...
      groups: "グループ",
      coding: "コーディング",
      groupCatalogSessionsByProject: "プロジェクトでグループ化",
    ...
    observer: {
      ...
      askPlaceholder: "なぜそうしているのですか？",
      askSubmit: "確認",
      askPending: "観察内容を確認中…",
      askBusy: "オブザーバーはすでに質問に回答中です。",
      askUnavailable: "オブザーバーは現在回答できません。",
