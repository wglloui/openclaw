...
export const fr: TranslationMap = {
  common: {
    ...
    refresh: "Actualiser",
    retry: "Réessayer",
    staleData: "Des données obsolètes sont affichées.",
    reload: "Recharger",
    reset: "Réinitialiser",
    restore: "Restaurer",
  ...
  channels: {
    ...
    pairing: {
      title: "Demandes d'accès aux MP",
      subtitle:
        "Examinez les personnes qui attendent d'envoyer des messages directs aux canaux protégés par appairage.",
      channelFilter: "Canal",
      ...
      approve: "Approuver",
      dismiss: "Ignorer",
      approveAria: "Approuver {sender} pour {channel}, compte {account}",
      dismissAria: "Ignorer {sender} pour {channel}, compte {account}",
      requested: "Demandé {ago}",
      expires: "Expire {ago}",
      senderDetails: "Détails de l'expéditeur",
      missingPermission:
        "Cette connexion ne dispose pas de l'accès operator.pairing, les demandes de MP ne peuvent donc pas être examinées.",
      noAccounts: "Aucun compte de canal configuré n'utilise l'appairage d'expéditeur de MP.",
      noRequests: "Aucune demande d'accès aux MP en attente.",
      noFilteredRequests: "Aucune demande en attente ne correspond à ces filtres.",
      limits:
        "Les demandes expirent après {minutes} minutes. Chaque compte de canal peut contenir jusqu'à {count} demandes en attente.",
      detailTitle: "Accès aux MP",
      detailSubtitle:
        "Les personnes doivent être approuvées avant que leurs messages directs n'atteignent l'agent.",
      pendingCount: "{count} en attente",
      noPending: "Aucune demande en attente",
      review: "Examiner les demandes",
      approveDialogTitle: "Approuver l'accès aux messages privés",
      dismissDialogTitle: "Ignorer la demande d'accès aux messages privés",
      approveExplanation:
        "Ceci permet à l'expéditeur de parler à l'agent en messages directs. Cela n'accorde pas l'accès aux groupes.",
      dismissExplanation:
        "Ceci supprime la demande actuelle mais ne bloque pas l'expéditeur. Il peut redemander l'accès plus tard.",
      notifyRequester: "Notifier le demandeur après approbation",
      makeCommandOwner: "Faire également de cet expéditeur le premier propriétaire de commandes",
      commandOwnerHelp:
        "Les propriétaires de commandes peuvent exécuter des commandes privilégiées et approuver des actions dangereuses. Cette option n'est disponible que lorsqu'aucun propriétaire n'est configuré.",
      commandOwnerNeedsAdmin:
        "Aucun propriétaire de commandes n'est configuré. Cette connexion nécessite operator.admin pour attribuer le premier propriétaire.",
      approvedNotice: "Accès aux messages privés approuvé.",
      approvedOwnerNotice:
        "Accès aux messages privés approuvé et le premier propriétaire de commandes a été configuré.",
      approvedNotificationFailedNotice:
        "Accès aux messages privés approuvé, mais la notification au demandeur n'a pas pu être délivrée.",
      approvedOwnerFailedNotice:
        "Accès aux messages privés approuvé, mais le premier propriétaire de commandes n'a pas pu être configuré.",
      approvedFollowupsFailedNotice:
        "Accès aux messages privés approuvé, mais la notification au demandeur et la configuration du propriétaire de commandes ont toutes deux échoué.",
      dismissedNotice:
        "Demande d'accès aux messages privés ignorée. L'expéditeur peut redemander l'accès.",
    },
    setup: {
      ...
      sessionExpired:
        "Cette session de configuration a expiré après le redémarrage du Gateway. Fermez cette boîte de dialogue, puis relancez la configuration du canal.",
      continue: "Continuer",
      finish: "Terminer",
      copyText: "Copier",
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Aucune session WhatsApp stockée n'a été effacée. Elle est peut-être déjà absente, ou son répertoire d'authentification nécessite un nettoyage manuel.",
    },
  ...
  nodes: {
    pairing: {
      ...
      getApps: "Obtenir les applications",
  ...
  agentChip: {
    ...
    agents: "Agents",
    openChat: "Discuter avec {name}",
    offlineOpenSettings: "Hors ligne — ouvrir les Réglages",
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "Les workers cloud nécessitent le runtime OpenClaw ; {runtime} est sélectionné.",
    ...
    places: "Emplacements",
    recentFolders: "Récentes",
    runsOn: "S'exécute sur {place}",
  ...
  sessionsView: {
    ...
    global: "Global",
    unknown: "Inconnu",
    sessionState: "État du fil",
    all: "Tous",
    sessionArchived: "Fil archivé",
    sessionsArchived: "{count} fils archivés",
    deleteAllArchived: "Supprimer tout ce qui est archivé…",
    deleteAllArchivedConfirm: "Supprimer {count} fils archivés et leurs transcriptions ?",
    ...
    runFailedReason: "Échec de l'exécution : {reason}",
    ...
    showChildSessions: "Afficher {count} sessions enfants pour {session}",
    hideChildSessions: "Masquer {count} sessions enfants pour {session}",
    childSessions: "Sessions enfants",
    showMoreChildren: "Afficher {count} de plus",
    archived: "Archivée",
    pinned: "Épinglée",
    unread: "Unread",
    ...
    cloudWorkerDescendantConflict: "Enfant du cloud worker : 1 conflit d'espace de travail",
    cloudWorkerDescendantConflicts:
      "Enfants du cloud worker : {count} conflits d'espace de travail",
    ...
    invalidEmojiIcon: "Saisissez exactement un emoji.",
    ...
    stopCloudWorker: "Arrêter le worker cloud…",
    stopCloudWorkerConfirm: "Arrêter le worker cloud pour « {session} » ?",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileIdentity: "Votre profil de gateway",
      ...
      profileHint:
        "JPEG, PNG ou WebP. Les images sont recadrées au centre et redimensionnées à 512 px.",
      profileLoadFailed: "Impossible de charger votre profil.",
      profileSaveFailed: "Impossible d'enregistrer votre profil.",
      avatarInvalid: "Choisissez une image JPEG, PNG ou WebP valide.",
      avatarTooLarge: "L'avatar traité est encore trop volumineux.",
  ...
  configView: {
    ...
    syncedHint: "Synchronisé entre vos appareils via le gateway.",
    notifications: {
      title: "Notifications push",
      nativeTitle: "Notifications",
      hint: "Recevez des notifications push du navigateur depuis votre gateway.",
      nativeHint:
        "Les notifications sont affichées de manière native par l'application OpenClaw sur ce Mac.",
      ...
      nativeBlockedHint:
        "Les notifications sont désactivées pour OpenClaw dans macOS. Autorisez-les dans Réglages système > Notifications.",
    },
    appearance: {
      theme: "Thème",
    ...
    sidebarPrefs: {
      ...
      hint: "Choisissez ce qui s'affiche pendant l'exécution des sessions.",
      liveActivity: "Afficher l'activité en direct de l'agent dans la barre latérale",
      liveActivityHint:
        "Afficher la dernière activité de l'assistant ou d'un outil sous les sessions en cours.",
    },
    sessionObserver: {
      title: "Observateur de session",
      hint: "Résumez les sessions de longue durée avec un petit modèle utilitaire.",
      toggle: "Observateur de session",
      toggleHint: "Générer des synthèses d'état en direct pour les sessions Control UI abonnées.",
      ...
      modelPickerHint:
        "Utilisé pour les synthèses de l'observateur et d'autres tâches utilitaires courtes.",
    ...
    autoSaveConflict: "Paramètres modifiés ailleurs",
    retry: "Réessayer",
    applyBannerText: "Enregistré dans openclaw.json — redémarrez le gateway pour appliquer.",
    applyBannerAction: "Redémarrer et appliquer",
    rawDiscard: "Abandonner",
    rawDraftBlocksApply:
      "Modifications brutes non enregistrées — enregistrez-les ou annulez-les dans l'éditeur brut avant de redémarrer.",
    rawDraftPendingFormTitle:
      "Modifications brutes non enregistrées — enregistrez-les ou annulez-les avant de passer au formulaire.",
    rawDraftBlocksFormEdit:
      "Les modifications brutes non enregistrées n'ont pas pu être analysées ; corrigez-les dans l'éditeur brut avant de modifier les paramètres.",
    invalidConfig:
  ...
  execApproval: {
    ...
    otherPending: "Autres demandes en attente",
    reviewRequest: "Examiner l'approbation de {agent} : {command}",
    agentPendingOne: "{count} approbation en attente",
    agentPending: "{count} approbations en attente",
  ...
  nav: {
    ...
    askOpenClaw: "Demander à OpenClaw",
    settingsGroupConnections: "Connexions",
    settingsGroupAgents: "Agents et outils",
    settingsGroupSecurity: "Confidentialité et sécurité",
  ...
  terminal: {
    ...
    uploadProgress: "Téléversement de {current} sur {total}",
    ...
    noSessions: "Aucune session de terminal active",
    currentSession: "actuelle",
    sessionAttached: "connectée",
    attachSession: "Se connecter à la session",
    attachFailed: "Impossible de se connecter à la session de terminal",
    starting: "Starting terminal…",
    connecting: "Connexion à la session…",
    connectionTimedOut: "La connexion à la session n’a pas été établie dans les 30 secondes.",
    tabLabel: "Shell {n}",
    tabHint: "{agent} · {cwd}",
  ...
  tabs: {
    ...
    modelSetup: "Configuration du modèle",
  ...
  subtitles: {
    ...
    apps: "Applications compagnons pour téléphone, montre, ordinateur et navigateur.",
    ...
    modelSetup: "Connectez un modèle d’IA vérifié",
    modelProviders: "Configured providers with plan, quota, and cost.",
    memoryImport:
      "Importez la mémoire de Codex et de Claude Code dans l’espace de travail d’un agent.",
    notifications: "Notifications push du navigateur depuis votre gateway.",
    security:
      "Authentification du Gateway, politique d'exécution, profil d'outils et approbations.",
    advanced:
      "Toutes les sections de configuration restantes, ainsi que l'éditeur de fichier brut.",
    debug: "Captures, événements, RPC.",
    logs: "Journaux Gateway en direct.",
    plugin: "Panneau fourni par le plugin.",
  },
  modelSetup: {
    heading: "Connectez votre IA",
    intro:
      "OpenClaw réutilise l’accès à l’IA dont vous disposez déjà — une connexion CLI, une clé API ou une connexion à un fournisseur.",
    loading: "Recherche des accès à l’IA disponibles sur ce Gateway…",
    retry: "Réessayer",
    checkAgain: "Vérifier à nouveau",
    verify: {
      title: "Connexion actuelle",
      button: "Vérifier la connexion",
      checking: "Vérification — demande d’une réponse rapide à {modelRef}…",
      answered: "Réponse reçue",
      answeredIn: "Réponse reçue en {latencyMs} ms",
    },
    access: {
      adminRequired: "La configuration du modèle nécessite l’accès operator.admin.",
      gatewayTooOld: "Le Gateway utilise une ancienne version d’OpenClaw",
    },
    candidates: {
      title: "Trouvés sur ce Gateway",
      recommended: "Recommandé",
      credentialsReady: "Identifiants prêts",
      signInNeeded: "Connexion requise",
      detected: "Détecté",
    ...
    errors: {
      requestFailed: "La demande de configuration du modèle a échoué.",
      activationFailed: "Le modèle n’a pas pu être activé.",
    },
    wizard: {
      ...
      continue: "Continuer",
      submit: "Envoyer",
      openSignIn: "Ouvrir la page de connexion",
      copy: "Copier",
      expires: "Expire dans {count} minutes",
      cancelled: "La connexion au fournisseur a été annulée.",
      sessionExpired:
        "Cette session de configuration a expiré après le redémarrage du Gateway. Fermez cette boîte de dialogue, puis relancez la configuration du modèle.",
      notComplete:
        "La connexion est terminée, mais la configuration du modèle n’est pas encore terminée.",
    },
  },
  memoryImport: {
  ...
  onboarding: {
    memoryImport: {
      title: "Emportez la mémoire de votre assistant avec vous",
      body: "OpenClaw a trouvé des données de mémoire provenant d’autres assistants de programmation. Voulez-vous les importer dans l’espace de travail de votre agent ?",
      plannedCount: "{count} prêts à être importés",
      alreadyImported: "Déjà importés : {count}",
      sourceUnavailable: "Chemin source indisponible",
      import: "Importer",
      skip: "Ignorer",
      reviewDetails: "Examiner les détails",
      importingProvider: "Importation…",
      providerResult: "{migrated} migrés, {skipped} ignorés",
      providerIncomplete:
        "{migrated} migrés, {skipped} ignorés, {errors} échecs, {conflicts} conflits",
      providerError: "Échec de l’importation : {error}",
      connectionChanged: "Ignoré : la connexion au Gateway a changé pendant l’importation",
      unknownError: "Échec de la requête",
      doneTitle: "Importation de la mémoire terminée",
      doneBody:
        "{migrated} migrés, {skipped} ignorés. Vous pouvez poursuivre la configuration d’OpenClaw.",
    },
  },
  custodian: {
    title: "OpenClaw",
    subtitle: "Votre guide de configuration du système",
    subtitleCaretaker: "Configuration et entretien du système.",
    exitSetup: "Quitter la configuration",
    newAgent: "Nouvel agent",
    hatchDraft: "Réveille-toi, mon ami !",
    placeholder: "Envoyer un message à OpenClaw…",
    sensitivePlaceholder: "Saisir une valeur sensible…",
    sensitiveReply: "Réponse sensible envoyée",
    send: "Envoyer",
    thinking: "OpenClaw réfléchit",
    earlier: "Plus tôt",
    requestFailed: "OpenClaw n'a pas pu répondre. Réessayez.",
    connectionChanged:
      "La connexion au Gateway a changé. Réessayez pour poursuivre cette configuration.",
    sessionRestarted:
      "{error} OpenClaw a démarré une nouvelle session ; les messages précédents restent disponibles comme contexte.",
    unsupportedGateway: "Mettez à jour le Gateway pour poursuivre la configuration avec OpenClaw.",
    history: {
      button: "Historique",
      title: "Modifications récentes",
      description: "Ce qui a changé sur ce système, du plus récent au plus ancien.",
      loading: "Chargement des modifications récentes…",
      empty: "Aucune modification enregistrée pour l'instant.",
      requestFailed: "OpenClaw n'a pas pu charger l'historique des modifications.",
      loadMore: "Charger davantage",
      loadingMore: "Chargement…",
      changedPaths: "Chemins modifiés ({count})",
      invalidEdit: "Cette modification manuelle n'a pas passé la validation de la configuration.",
      opaqueChange:
        "Le formatage ou les commentaires ont changé sans modification visible du chemin de configuration.",
      sources: {
    ...
    nudge: {
      configReload:
        "Le rechargement de la configuration s'est arrêté — demandez-moi ce qui s'est passé",
      channelAuth: "L'authentification {channel} est dégradée — demandez-moi ce qui s'est passé",
      channelDisconnected: "{channel} vient de se déconnecter — demandez-moi ce qui s'est passé",
  ...
  mcpServers: {
    ...
    addedSuccess: "Serveur MCP {name} ajouté.",
    enabledSuccess: "Serveur MCP {name} activé.",
    disabledSuccess: "Serveur MCP {name} désactivé.",
    removedSuccess: "Serveur MCP {name} supprimé.",
    configUnavailable: "La configuration n’est pas disponible ; actualisez et réessayez.",
    connectRequired: "Connectez-vous au gateway pour modifier les serveurs MCP.",
    adminRequired: "Les modifications des serveurs MCP nécessitent l'accès operator.admin.",
    enable: "Activer",
    disable: "Désactiver",
  ...
  mcpPage: {
    connectorsLink: "Découvrez les connecteurs en un clic sur la page Plugins.",
    servers: "Serveurs",
    oauth: "OAuth",
    filtered: "Filtré",
  ...
  labsPage: {
    intro:
      "Labs contient des fonctionnalités expérimentales qui peuvent changer, se briser ou disparaître entre les versions.",
    sectionTitle: "Fonctionnalités expérimentales",
    sectionDescription:
      "Les modifications sont enregistrées immédiatement et s'appliquent aux futures exécutions de l'agent.",
    documentation: "Documentation",
    restartRequired: "Redémarrage du Gateway requis.",
    saveErrorTitle: "Impossible de mettre à jour la fonctionnalité",
    saveFailed: "Le paramètre de la fonctionnalité n'a pas pu être enregistré.",
    codeMode: {
      title: "Code Mode",
      description:
        "Permettez aux agents de combiner des outils dans des workflows JavaScript compacts et isolés.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    heroTitle: "Emportez OpenClaw partout",
    heroTagline:
      "Des applications compagnons pour votre téléphone, votre montre, votre ordinateur et votre navigateur — ainsi que des plugins pour étendre les capacités de votre agent.",
    sectionMobile: "Sur votre téléphone",
    havePhone: "Vous avez déjà l'application ?",
    pairDevice: "Associer votre appareil",
    sectionWatch: "À votre poignet",
    sectionDesktop: "Sur votre ordinateur",
    sectionBrowser: "Dans votre navigateur",
    sectionCommunity: "Communauté",
    badgeBundledIos: "Inclus avec l'application iOS",
    badgeBundledAndroid: "Inclus avec l'application Android",
    ctaAppStore: "App Store",
    ctaPlayStore: "Google Play",
    ctaDownload: "Télécharger",
    ctaDocs: "Documentation",
    ctaSetupGuide: "Guide de configuration",
    ctaOpenPlugins: "Ouvrir les plugins",
    ctaBrowseClawHub: "Parcourir ClawHub",
    linkDiscord: "Communauté Discord",
    linkDocs: "Documentation",
    cards: {
      ios: {
        title: "iPhone",
        desc: "Discutez, parlez, approuvez des actions et partagez vers OpenClaw depuis iOS.",
      },
      android: {
        title: "Android",
        desc: "Votre téléphone Android comme nœud OpenClaw complet — chat, caméra et Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
        desc: "Consultez vos conversations et répondez rapidement depuis votre poignet.",
      },
      wearOs: {
        title: "Wear OS",
        desc: "L'application compagnon Android étend OpenClaw à votre montre.",
      },
      macos: {
        title: "macOS",
        desc: "Application compagnon dans la barre de menus pour votre Gateway — notifications, approbations, chat rapide.",
      },
      windows: {
        title: "Windows",
        desc: "L'application compagnon Windows connecte votre PC en tant que nœud OpenClaw.",
      },
      linux: {
        title: "Linux",
        desc: "Application de bureau native — versions .deb et AppImage.",
      },
      chrome: {
        title: "Extension Chrome",
        desc: "Laissez OpenClaw piloter votre Chrome existant — onglets, pages et formulaires.",
      },
      plugins: {
        title: "Plugins et ClawHub",
        desc: "Étendez OpenClaw avec des canaux, outils et compétences de la communauté.",
      },
    },
  },
  presence: {
    rosterLabel: "Afficher qui est en ligne",
    rosterTitle: "En ligne",
    serverRegion: "Serveur",
    you: "vous",
  },
  profilePage: {
    ...
    identity: {
      ...
      notSet: "L'identité n'est pas définie.",
      setIdentity: "Définir l'identité",
      avatar: "Avatar",
      avatarDescription: "PNG, JPEG ou WebP. Les images sont redimensionnées à 256 × 256 ou moins.",
      chooseAvatar: "Choisir une image",
      processingAvatar: "Traitement…",
      displayName: "Nom d'affichage",
      displayNameDescription: "Affiché aux autres personnes utilisant ce gateway.",
      linkedEmails: "E-mails associés",
      linkedEmailsDescription: "Adresses e-mail connectées à ce profil.",
      openSettings: "Ouvrir les paramètres d'identité pour {name}",
      avatarErrors: {
        invalid: "Cette image n'a pas pu être traitée.",
        sourceTooLarge: "Choisissez une image de 10 Mo ou moins.",
        tooLarge: "L'avatar traité dépasse 512 Ko.",
      },
    },
  },
  tasksPage: {
  ...
  gatewayLogs: {
    title: "Journaux",
    subtitle: "Journaux de fichiers du Gateway (JSONL).",
    exportButton: "Exporter {label}",
    exportLabels: {
      filtered: "filtré",
      visible: "visible",
    },
    ...
    autoFollow: "Suivi automatique",
    file: "Fichier : {file}",
    truncated: "Sortie du journal tronquée ; affichage du dernier segment.",
  ...
  board: {
    label: "Tableau de bord des fils",
    tabsLabel: "Onglets du tableau de bord",
    moreTabs: "Plus d'onglets du tableau de bord",
    gridLabel: "Widgets du tableau de bord",
    emptyTitle: "Un tableau vierge, prêt à l'emploi",
    emptyHint:
      "Votre agent peut épingler des widgets ici — essayez de demander une carte de statut.",
    actionFailed: "La modification du tableau de bord n'a pas pu être enregistrée.",
    actionInProgress:
      "Une autre modification du tableau de bord est encore en cours d'enregistrement.",
    announcement: {
      moved: "{title} déplacé.",
      resized: "{title} redimensionné.",
      removed: "{title} supprimé.",
      granted: "Accès au widget autorisé.",
      rejected: "Accès au widget refusé.",
    },
    widget: {
      cellLabel:
        "Widget du tableau de bord : {title}. Utilisez les touches fléchées pour naviguer. Maintenez Alt et appuyez sur une touche fléchée pour le déplacer.",
      moveHandle: "Déplacer {title}",
      resizeHandle: "Redimensionner {title}",
      menuLabel: "Options du widget",
      moveToTab: "Déplacer vers l'onglet",
      noOtherTabs: "Aucun autre onglet",
      resize: "Redimensionner",
      autoHeight: "Hauteur automatique",
      remove: "Supprimer",
      needsApproval: "Approbation requise",
      needsApprovalDetail: "Ce widget a demandé un accès supplémentaire.",
      networkAccess: "Origines réseau",
      hostTools: "Outils et données de l'hôte",
      activeCapabilities: "Capacités actives du widget",
      networkCapability: "Réseau : {capability}",
      toolCapability: "Outil : {capability}",
      granted: "Accordée",
      allow: "Autoriser",
      reject: "Rejeter",
      rejected: "Accès refusé",
      rejectedDetail: "Ce widget reste inactif jusqu'à ce qu'il soit supprimé ou remplacé.",
      appLoading: "Restauration de l'application…",
      appStaleTitle: "Cette application épinglée est obsolète",
      appStaleDetail:
        "Son serveur, sa ressource ou sa transcription d'origine n'est plus disponible.",
      retry: "Réessayer",
      frameResolverMissing: "Le contenu du widget est indisponible.",
      sandboxUnavailable: "L'hôte du bac à sable du widget est indisponible.",
      frameAuthorizationFailed:
        "Échec de l'autorisation du widget après plusieurs tentatives d'actualisation.",
      sandboxOriginRequired:
        "Échec de l'autorisation du widget après plusieurs tentatives d'actualisation. Si le gateway s'exécute derrière un proxy inverse ou un tunnel qui ne route pas le port du bac à sable du widget, définissez mcp.apps.sandboxOrigin sur une origine publique dédiée routée vers l'écouteur du bac à sable.",
      errorTitle: "Ce widget n'a pas pu se charger",
      errorDetail: "Le problème est limité à cette carte.",
      actionErrorTitle: "Échec de la modification du widget",
      actionErrorDetail: "Le tableau de bord a conservé l'état précédent du widget.",
  ...
  workboard: {
    widget: {
      ...
      loading: "Chargement du Workboard…",
      cardIdRequired: "Ce widget nécessite une prop cardId.",
      cardMissing: "Cette carte Workboard n'est plus disponible.",
      unassigned: "Non attribué",
      openBoard: "Ouvrir le tableau",
      statusCounts: "Cartes par statut",
      noActiveCards: "Aucune carte prête ou en cours.",
    },
    ...
    dashboardEmpty: "Pas encore de tableau de bord — l'agent de travail peut épingler des widgets.",
    openSession: "Ouvrir la session",
  ...
  usage: {
    ...
    details: {
      ...
      loadFailed: "Impossible de charger {detail} : {error}",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      renameAria: "Renommer la session {title}",
      renameInputAria: "Titre de la session",
      renameInputPlaceholder: "Titre de la session",
      workspaceAria: "Actions de l'espace de travail pour {workspace}",
      revealFinder: "Afficher dans le Finder",
      revealFileExplorer: "Afficher dans l'Explorateur de fichiers",
      revealFileManager: "Ouvrir dans le gestionnaire de fichiers",
      ...
      branchSwitchRequiresAdmin:
        "Le changement de branche nécessite un accès administrateur opérateur.",
      untitledBranch: "Branche sans titre",
    ...
    board: {
      ...
      chatFace: "Discussion",
      dashboardFace: "Tableau de bord",
      dockMenu: "Panneau de chat : {dock}",
      dockLeft: "Ancrer le chat à gauche",
      dockRight: "Ancrer le chat à droite",
      dockBottom: "Ancrer le chat en bas",
      dockHidden: "Masquer le chat",
      resizeDock: "Redimensionner le panneau de chat",
      reopenChat: "Afficher le chat",
      workboardCard: "Carte du plan de travail : {title}, {status}",
      defaultTab: "Principal",
      mockPlaceholder: "Vue en tableau · {tabs} onglets · {widgets} widgets",
      mockOverview: "Aperçu",
      mockResearch: "Recherche",
      mockSessionStatus: "État du fil",
      mockRecentFindings: "Résultats récents",
      mockSourceMap: "Carte des sources",
      resetTitle: "Réinitialiser la conversation ?",
      resetDescription:
        "Le contexte de la conversation est réinitialisé. Votre tableau de bord est conservé.",
    },
    catalog: {
    ...
    followUpModeServer: "Valeur par défaut du serveur ({mode})",
    followUpModeLoading: "chargement…",
    ...
    workspaceConflict: {
      titleOne: "1 conflit d'espace de travail cloud",
      titleMany: "{count} conflits d'espace de travail cloud",
      description:
        "OpenClaw a conservé vos versions locales et appliqué les autres modifications cloud. Inspectez le résultat préparé ou adoptez sa version pour un chemin en conflit.",
      morePaths: "+{count} chemins supplémentaires",
      stagedResult: "Résultat cloud indexé",
      copyStagedResult: "Copier la réf du résultat indexé",
      inspectCloud: "Inspecter la première version cloud",
      takeCloud: "Prendre la première version cloud",
      copyInspectCommand: "Copier la commande d'inspection cloud",
      copyTakeCommand: "Copier la commande take-cloud",
      commandHelp:
        "Exécutez ces commandes dans Bash ou zsh (Git Bash sous Windows). Si l'inspection indique que le chemin n'existe pas, le cloud l'a supprimé ; vérifiez et supprimez le chemin local manuellement. Si le checkout signale un conflit de fichier/répertoire, déplacez ou supprimez le chemin local bloquant, puis réessayez. Si la réf indexée est manquante, l'avis est obsolète ; ne modifiez pas le chemin local.",
      commandsUnavailable:
        "Ce nom de fichier contient des caractères de contrôle de terminal, donc OpenClaw ne créera pas de commande shell copiable pour celui-ci. Inspectez directement la réf indexée et saisissez le chemin manuellement avec précaution.",
      dismiss: "Ignorer l'avis de conflit d'espace de travail",
      eventSender: "Espace de travail cloud",
      eventTitleOne: "Résultat cloud appliqué avec 1 conflit",
      eventTitleMany: "Résultat cloud appliqué avec {count} conflits",
      eventDescription:
        "Les versions locales ont été conservées pour ces chemins ; les autres modifications cloud ont été appliquées.",
    },
    compaction: {
    ...
    sidebar: {
      ...
      toolActivity: "Utilisation de {tool}",
    },
    welcome: {
    ...
    questions: {
      ...
      skipping: "Ignorer…",
      skipped: "Ignorées",
      collapse: "Réduire la question",
      expand: "Développer la question",
      eyebrow: "Question",
      cardLabel: "Question de l'assistant",
      summaryLabel: "Résultat de la question",
      timeRemaining: "Temps restant",
      ownAnswer: "Votre propre réponse…",
      ownAnswerFor: "Votre propre réponse pour {header}",
      submitting: "Envoi…",
      submitFailed: "Impossible d'envoyer : {error}",
      answered: "Réponse reçue",
      answeredElsewhere: "Répondu ailleurs",
      unavailable: "Indisponible",
      expired: "Expiré",
      cancelled: "Annulé",
    },
    imageLightbox: {
      label: "Aperçu de l'image : {title}",
      open: "Ouvrir l'image {title}",
    ...
    messages: {
      ...
      hide: "Masquer",
      hideConfirm: "Masquer ce message dans ce navigateur ? L'agent le voit toujours.",
      hideMessage: "Masquer le message",
      hideTooltip: "Masquer dans ce navigateur uniquement",
      ...
      rewindUnavailable: "Le retour en arrière est indisponible pendant que l'agent travaille",
      forkUnavailable: "La bifurcation est indisponible pendant que l'agent travaille",
    ...
    modelControls: {
      ...
      reasoning: "Raisonnement",
      speed: "Vitesse",
      sessionOverride: "Remplacement du fil",
      usingDefault: "Utilisation de la valeur par défaut des Paramètres",
      resetToDefault: "Réinitialiser à la valeur par défaut ({model})",
    },
    sideChat: {
    ...
    observer: {
      ...
      hide: "Masquer l'observateur de session",
      show: "Afficher l'observateur de session",
      plan: "Plan",
      progress: "{completed} sur {total}",
      pullRequests: "Pull requests",
      running: "En cours",
      checksPassing: "{count} réussis",
      checksFailing: "{count} échoués",
      ...
      boardCurrentStatus: "Statut actuel",
      boardTimeline: "Chronologie de santé",
      boardCurrentRun: "Exécution actuelle",
      boardPreviousRun: "Exécution précédente",
      boardUnknownRun: "Exécution non identifiée",
      boardSinceYouLeft: "Depuis votre départ",
      health: {
        "on-track": "Sur la bonne voie",
        grinding: "En cours",
        stuck: "Bloqué",
        "waiting-on-user": "En attente de votre part",
    ...
    composer: {
      ...
      cameraBusy: "La caméra est occupée ou indisponible pour le navigateur.",
      cameraFallback: "Caméra {number}",
      cameraInput: "Caméra",
      cameraListUnsupported: "Ce navigateur ne peut pas répertorier les caméras.",
      cameraNoneFound: "Aucune caméra n'a été trouvée.",
      cameraPageInactive: "Les caméras sont indisponibles lorsque cette page est inactive.",
      cameraPermissionBlocked:
        "L'accès à la caméra est bloqué. Autorisez l'accès à la caméra et au microphone dans les paramètres du site du navigateur.",
      ...
      microphoneAppliesNextSession:
        "Les modifications s'appliquent au démarrage de votre prochaine session Talk.",
      microphoneListUnsupported: "Ce navigateur ne peut pas lister les entrées microphone.",
      noCameras: "Aucune caméra supplémentaire trouvée",
      ...
      holdToRecordSetting: "Maintenir le bouton du microphone pour dicter",
      holdToRecordSettingDescription:
        "Maintenez le bouton du microphone du composeur, parlez, puis relâchez pour insérer le texte sans l'envoyer.",
      dictationAudioUnsupported:
        "Le Gateway a renvoyé un format audio de dictée non pris en charge.",
      dictationBrowserAudioUnsupported:
        "Ce navigateur ne peut pas capturer l'audio de dictée à 8 kHz.",
      dictationConnecting: "Démarrage de la dictée…",
      dictationDisconnected: "La dictée s'est arrêtée car le Gateway s'est déconnecté.",
      dictationFailed: "Échec de la dictée.",
      dictationFinalizing: "Finalisation de la dictée…",
      dictationFinalizationTimedOut:
        "La dictée s'est arrêtée avant que la dernière transcription partielle ait pu être finalisée.",
      dictationProviderUnavailable:
        "Aucun fournisseur de transcription n'est configuré pour la dictée.",
      dictationRecording: "Enregistrement {elapsed}",
      dictationReleaseToInsert: "Relâchez pour insérer la dictée",
      ...
      selectedCameraUnavailable:
        "La caméra sélectionnée n'est pas disponible. Choisissez une autre caméra ou l'option Système par défaut.",
      ...
      systemDefaultCamera: "Par défaut du système",
    ...
    toolCards: {
      ...
      widgetExportRerender:
        "Ce widget doit être rendu à nouveau pour être exporté en tant qu'image.",
      widgetExportFailed: "Échec de l'exportation du widget. Réessayez.",
      pinToDashboard: "Épingler au tableau de bord",
      pinToDashboardPending: "Épinglage…",
      pinnedToDashboard: "Épinglée",
    ...
    backgroundTasks: {
      ...
      prompt: "Invite",
      output: "Sortie",
      promptUnavailable: "Invite indisponible.",
      outputPending: "Aucune sortie pour le moment.",
    },
    sessionDiff: {
      title: "Modifications",
    ...
    sessionDiscussion: {
      ...
      hide: "Masquer la discussion",
      disconnected: "Gateway est déconnecté.",
      loading: "Chargement de la discussion…",
      opening: "Ouverture de la discussion…",
      requiresWriteAccess:
        "Un accès en écriture opérateur est requis pour ouvrir cette discussion.",
      openExternal: "Ouvrir la discussion dans un nouvel onglet",
      frameTitle: "Discussion de la session",
      unavailable: "Cette discussion ne peut pas être intégrée.",
    },
    workspaceFiles: {
  ...
  cron: {
    ...
    form: {
      ...
      summaryEverySecondOne: "S'exécute chaque seconde",
      ...
      summaryEverySeconds: "S'exécute toutes les {amount} secondes",
