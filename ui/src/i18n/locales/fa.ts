...
export const fa: TranslationMap = {
  common: {
    ...
    refresh: "تازه‌سازی",
    retry: "تلاش مجدد",
    staleData: "داده‌های قدیمی نمایش داده می‌شوند.",
  ...
  channels: {
    ...
    hub: {
      connectedTitle: "کانال‌های شما",
      addTitle: "افزودن کانال",
      addSubtitle: "یک سرویس را انتخاب کنید و مراحل راه‌اندازی هدایت‌شده را دنبال کنید.",
      updatedAgo: "به‌روزرسانی‌شده در {ago}",
      noneConnected:
        "هنوز هیچ کانالی متصل نشده است. برای شروع، یکی از گزینه‌های زیر را انتخاب کنید.",
      partialSnapshot: "برخی بررسی‌های کانال پیش از پایان مهلت رابط کاربری تکمیل نشدند.",
      stateRunning: "در حال اجرا",
      stateConfigured: "پیکربندی‌شده",
      stateAttention: "نیازمند توجه",
      setUp: "راه‌اندازی",
      guidedSetup: "راه‌اندازی هدایت‌شده گام‌به‌گام",
      openDetails: "باز کردن جزئیات",
      lastMessageAgo: "آخرین پیام {ago}",
      browseAllTitle: "کانال‌های بیشتر…",
      browseAllSubtitle: "همه کانال‌های موجود، از جمله افزونه‌های قابل نصب، را مرور کنید.",
      runSetup: "اجرای راه‌اندازی",
      saveBeforeSetup:
        "تغییرات ذخیره‌نشده‌ای در پیکربندی کانال دارید. پیش از اجرای راه‌اندازی هدایت‌شده، آن‌ها را ذخیره یا دوباره بارگذاری کنید.",
    },
    pairing: {
      title: "درخواست‌های دسترسی پیام مستقیم",
      subtitle:
        "افرادی را که منتظر ارسال پیام مستقیم به کانال‌های محافظت‌شده با جفت‌سازی هستند بررسی کنید.",
      channelFilter: "کانال",
      accountFilter: "حساب",
      ...
      approve: "تأیید",
      dismiss: "رد کردن",
      approveAria: "تأیید {sender} برای {channel}، حساب {account}",
      dismissAria: "رد کردن {sender} برای {channel}، حساب {account}",
      requested: "درخواست‌شده {ago}",
      expires: "انقضا {ago}",
      senderDetails: "جزئیات فرستنده",
      missingPermission:
        "این اتصال دسترسی operator.pairing ندارد، بنابراین درخواست‌های پیام مستقیم قابل بررسی نیستند.",
      noAccounts: "هیچ حساب کانال پیکربندی‌شده‌ای از جفت‌سازی فرستنده پیام مستقیم استفاده نمی‌کند.",
      noRequests: "هیچ درخواست دسترسی پیام مستقیم در انتظار نیست.",
      noFilteredRequests: "هیچ درخواست در انتظاری با این فیلترها مطابقت ندارد.",
      limits:
        "درخواست‌ها پس از {minutes} دقیقه منقضی می‌شوند. هر حساب کانال می‌تواند تا {count} درخواست در انتظار را نگه دارد.",
      detailTitle: "دسترسی پیام مستقیم",
      detailSubtitle: "افراد باید پیش از رسیدن پیام‌های مستقیمشان به عامل، تأیید شوند.",
      pendingCount: "{count} در انتظار",
      noPending: "درخواست در انتظاری وجود ندارد",
      review: "بررسی درخواست‌ها",
      approveDialogTitle: "تأیید دسترسی پیام مستقیم",
      dismissDialogTitle: "رد درخواست دسترسی پیام مستقیم",
      approveExplanation:
        "این کار به فرستنده اجازه می‌دهد در پیام‌های مستقیم با عامل صحبت کند. این دسترسی گروهی نمی‌دهد.",
      dismissExplanation:
        "این کار درخواست فعلی را حذف می‌کند اما فرستنده را مسدود نمی‌کند. آن‌ها می‌توانند بعداً دوباره درخواست دسترسی دهند.",
      notifyRequester: "اطلاع به درخواست‌کننده پس از تأیید",
      makeCommandOwner: "همچنین این فرستنده را اولین مالک فرمان قرار بده",
      commandOwnerHelp:
        "مالکان فرمان می‌توانند فرمان‌های ممتاز را اجرا کنند و اقدامات خطرناک را تأیید کنند. این گزینه فقط زمانی در دسترس است که هیچ مالکی پیکربندی نشده باشد.",
      commandOwnerNeedsAdmin:
        "هیچ مالک فرمانی پیکربندی نشده است. این اتصال برای تعیین اولین مالک به operator.admin نیاز دارد.",
      approvedNotice: "دسترسی پیام مستقیم تأیید شد.",
      approvedOwnerNotice: "دسترسی پیام مستقیم تأیید و اولین مالک فرمان پیکربندی شد.",
      approvedNotificationFailedNotice:
        "دسترسی پیام مستقیم تأیید شد، اما اطلاع‌رسانی به درخواست‌کننده تحویل داده نشد.",
      approvedOwnerFailedNotice: "دسترسی پیام مستقیم تأیید شد، اما اولین مالک فرمان پیکربندی نشد.",
      approvedFollowupsFailedNotice:
        "دسترسی پیام مستقیم تأیید شد، اما هم اطلاع‌رسانی به درخواست‌کننده و هم راه‌اندازی مالک فرمان ناموفق بود.",
      dismissedNotice:
        "درخواست دسترسی پیام مستقیم رد شد. فرستنده می‌تواند دوباره درخواست دسترسی دهد.",
    },
    setup: {
      dialogLabel: "راه‌اندازی {channel}",
      title: "راه‌اندازی {channel}",
      genericTitle: "یک کانال",
      subtitle: "راه‌اندازی کوتاه و گام‌به‌گام — بعداً می‌توانید همه‌چیز را دقیق‌تر تنظیم کنید.",
      starting: "در حال شروع راه‌اندازی…",
      working: "در حال کار…",
      sessionExpired:
        "این جلسه راه‌اندازی پس از راه‌اندازی مجدد Gateway منقضی شد. این پنجره را ببندید، سپس راه‌اندازی کانال را دوباره شروع کنید.",
      continue: "ادامه",
      finish: "پایان",
      copyText: "کپی",
      ...
      whatsappQrLoading: "در حال ایجاد کد QR…",
      whatsappQrHint: "برای ایجاد کد جفت‌سازی، روی نمایش کد QR کلیک کنید.",
      whatsappLinked: "WhatsApp متصل و آماده است.",
      regenerateQr: "کد QR جدید",
      linkLater: "بعداً متصل شود",
    },
    config: {
    ...
    whatsapp: {
      ...
      loggedOut: "خارج شدید.",
      logoutNotCleared:
        "هیچ نشست ذخیره‌شده‌ای از WhatsApp پاک نشد. ممکن است از قبل موجود نباشد یا پوشه احراز هویت آن نیاز به پاک‌سازی دستی داشته باشد.",
    },
  ...
  nodes: {
    ...
    inventory: {
      ...
      remove: "حذف",
      removeName: "حذف {name}",
      removePromptTitle: "{name} حذف شود؟",
      removePromptBody: "این دستگاه پیش از اتصال مجدد باید دوباره جفت شود.",
      removeStalePromptTitle: "{count} جفت‌سازی قدیمی حذف شوند؟",
      removeStalePromptTitleOne: "۱ جفت‌سازی قدیمی حذف شود؟",
      removeStalePromptBody: "کلاینت‌های تحت تأثیر در اتصال بعدی خود، بدون اعلان دوباره جفت می‌شوند.",
      gateway: "gateway",
      unpaired: "جفت‌نشده",
  ...
  agentChip: {
    menuLabel: "منوی عامل",
    agents: "عامل‌ها",
    openChat: "گفتگو با {name}",
    offlineOpenSettings: "آفلاین — تنظیمات را باز کنید",
    switchAgent: "تعویض عامل",
    working: "در حال کار…",
    ready: "آماده گفت‌وگو",
  ...
  newSession: {
    ...
    worktree: "Worktree",
    checkingGit: "در حال بررسی در دسترس بودن Git…",
    gitCheckUnavailable:
      "بررسی Git برای این پوشه ممکن نشد. برای تلاش مجدد دوباره آن را انتخاب کنید.",
  ...
  sessionsView: {
    ...
    global: "سراسری",
    unknown: "نامشخص",
    sessionState: "وضعیت رشته",
    all: "همه",
    sessionArchived: "رشته بایگانی شد",
    sessionsArchived: "{count} رشته بایگانی شد",
    deleteAllArchived: "حذف همه بایگانی‌شده‌ها…",
    deleteAllArchivedConfirm: "{count} رشته بایگانی‌شده و رونوشت‌های آن‌ها حذف شوند؟",
    ...
    runFailedReason: "اجرا ناموفق بود: {reason}",
    ...
    showChildSessions: "نمایش {count} نشست فرزند برای {session}",
    hideChildSessions: "پنهان کردن {count} نشست فرزند برای {session}",
    childSessions: "نشست‌های فرزند",
    showMoreChildren: "نمایش {count} مورد دیگر",
    ...
    cloudWorkerDescendantConflict: "زیرمجموعه کارگر ابری: ۱ تداخل فضای کاری",
    cloudWorkerDescendantConflicts: "زیرمجموعه‌های کارگر ابری: {count} تداخل فضای کاری",
    ...
    invalidEmojiIcon: "دقیقاً یک ایموجی وارد کنید.",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileIdentity: "نمایه Gateway شما",
      assistantIdentity: "هویت دستیار",
      displayName: "نام نمایشی",
      displayNamePlaceholder: "نام شما",
      saveProfile: "ذخیره نام",
      saving: "در حال ذخیره…",
      uploading: "در حال پردازش…",
      profileHint:
        "JPEG، PNG یا WebP. تصاویر از مرکز برش داده و به ۵۱۲ پیکسل تغییر اندازه داده می‌شوند.",
      profileLoadFailed: "بارگذاری نمایه شما ممکن نشد.",
      profileSaveFailed: "ذخیره نمایه شما ممکن نشد.",
      avatarInvalid: "یک تصویر معتبر JPEG، PNG یا WebP انتخاب کنید.",
      avatarTooLarge: "آواتار پردازش‌شده هنوز بیش از حد بزرگ است.",
  ...
  configView: {
    ...
    syncedHint: "از طریق Gateway بین دستگاه‌های شما همگام‌سازی می‌شود.",
    notifications: {
    ...
    sidebarPrefs: {
      title: "نوار کناری",
      hint: "انتخاب کنید چه چیزی هنگام اجرای نشست‌ها نمایش داده شود.",
      liveActivity: "نمایش فعالیت زنده عامل در نوار کناری",
      liveActivityHint: "نمایش آخرین فعالیت دستیار یا ابزار زیر نشست‌های در حال اجرا.",
    },
    sessionObserver: {
      title: "ناظر نشست",
      hint: "خلاصه‌سازی نشست‌های طولانی با یک مدل کاربردی کوچک.",
      toggle: "ناظر نشست",
      toggleHint: "تولید خلاصه‌های وضعیت زنده برای نشست‌های مشترک‌شده Control UI.",
      resolvedModel: "مدل کوچک تعیین‌شده",
      modelAuto: "خودکار ({model})",
      modelConfigured: "پیکربندی‌شده ({model})",
      modelDisabled: "غیرفعال",
      modelUnavailable: "در دسترس نیست (بدون مدل کوچک)",
      modelPicker: "مدل کوچک",
      modelPickerHint: "برای خلاصه‌های ناظر و دیگر وظایف کاربردی کوتاه استفاده می‌شود.",
      modelCatalogUnavailable: "کاتالوگ مدل صریح در دسترس نیست",
      auto: "خودکار (پیش‌فرض ارائه‌دهنده)",
      disabled: "غیرفعال",
      toggleNote: "به‌روزرسانی ناظر نشست Control UI",
      modelNote: "به‌روزرسانی مدل کاربردی پیش‌فرض",
    },
    connection: {
      title: "اتصال",
      gateway: "Gateway",
    ...
    autoSaveSaving: "در حال ذخیره…",
    autoSaveSaved: "ذخیره شد",
    autoSaveFailed: "ذخیره ناموفق بود",
    ...
    rawDraftBlocksApply:
      "ویرایش‌های ذخیره‌نشده در پیکربندی خام — قبل از راه‌اندازی مجدد، آن‌ها را در ویرایشگر Raw ذخیره یا لغو کنید.",
    rawDraftPendingFormTitle:
      "ویرایش‌های ذخیره‌نشده در پیکربندی خام — قبل از جابه‌جایی به Form، آن‌ها را ذخیره یا لغو کنید.",
    rawDraftBlocksFormEdit:
      "ویرایش‌های ذخیره‌نشده پیکربندی خام قابل تجزیه نیستند؛ قبل از تغییر تنظیمات، آن‌ها را در ویرایشگر Raw برطرف کنید.",
  ...
  execApproval: {
    ...
    otherPending: "سایر درخواست‌های در انتظار",
    reviewRequest: "بررسی تأیید از {agent}: {command}",
    agentPendingOne: "{count} تأیید در انتظار",
    agentPending: "{count} تأیید در انتظار",
  ...
  terminal: {
    ...
    uploadProgress: "در حال بارگذاری {current} از {total}",
    ...
    noSessions: "هیچ نشست ترمینال فعالی وجود ندارد",
    currentSession: "فعلی",
    sessionAttached: "متصل",
  ...
  subtitles: {
    ...
    apps: "برنامه‌های همراه برای تلفن، ساعت، دسکتاپ و مرورگر.",
    ...
    modelSetup: "اتصال یک مدل هوش مصنوعی تأییدشده",
    modelProviders: "Configured providers with plan, quota, and cost.",
    memoryImport: "حافظه Codex و Claude Code را به فضای کاری عامل وارد کنید.",
    notifications: "اعلان‌های Push مرورگر از Gateway شما.",
    security: "احراز هویت Gateway، سیاست اجرا، نمایه ابزار و تأییدها.",
    advanced: "تمام بخش‌های پیکربندی باقی‌مانده، به‌همراه ویرایشگر فایل خام.",
  ...
  modelSetup: {
    ...
    candidates: {
      ...
      credentialsReady: "اطلاعات ورود آماده است",
      signInNeeded: "نیاز به ورود",
    ...
    signIn: {
      title: "ورود با حساب ارائه‌دهنده",
      signIn: "ورود",
      pair: "جفت‌سازی",
    ...
    failure: {
      ...
      rateLimit: "محدودیت نرخ درخواست اعمال شد",
      billing: "مشکل در صورت‌حساب",
    ...
    errors: {
      requestFailed: "درخواست راه‌اندازی مدل ناموفق بود.",
      activationFailed: "مدل فعال نشد.",
    },
    wizard: {
      ...
      continue: "ادامه",
      submit: "ارسال",
      openSignIn: "باز کردن صفحه ورود",
      copy: "کپی",
      expires: "تا {count} دقیقه دیگر منقضی می‌شود",
      cancelled: "ورود به ارائه‌دهنده لغو شد.",
      sessionExpired:
        "این جلسه راه‌اندازی پس از راه‌اندازی مجدد Gateway منقضی شد. این پنجره را ببندید، سپس راه‌اندازی مدل را دوباره شروع کنید.",
      notComplete: "ورود به پایان رسید، اما تنظیم مدل هنوز کامل نشده است.",
    },
  },
  memoryImport: {
    unknownCollection: "مجموعه حافظه",
    claudeCode: "Claude Code",
    fileCountOne: "{count} فایل",
    fileCount: "{count} فایل",
    alreadyImported: "{count} مورد موجود",
    ready: "آماده",
    existing: "موجود",
    importComplete: "درون‌ریزی کامل شد",
    importIncomplete: "درون‌ریزی ناقص است",
    importedCount: "{count} فایل درون‌ریزی شد",
    importedWithIssues: "{migrated} مورد درون‌ریزی شد · {errors} مورد ناموفق · {conflicts} تداخل",
    reportSaved: "گزارش ذخیره شد",
    recoveryFile: "فایل بازیابی",
    recoveryJournal: "گزارش بازیابی",
    itemBackup: "پشتیبان مورد",
    codexDescription: "فایل‌های حافظه یکپارچه‌شده Codex.",
    claudeDescription: "فایل‌های حافظه خودکار Claude Code برای هر پروژه.",
    providerFallback: "حافظه دستیار را به این فضای کاری عامل وارد کنید.",
    reviewFiles: "بازبینی فایل‌ها",
    notFound: "یافت نشد",
    noMemoryFound: "هیچ حافظه قابل درون‌ریزی در این رایانه یافت نشد.",
    source: "منبع",
    destination: "مقصد",
    selectedCount: "{count} انتخاب‌شده",
    selectAtLeastOne: "حداقل یک فایل را انتخاب کنید",
    importSelected: "درون‌ریزی موارد انتخاب‌شده",
    confirmTitle: "از {provider} وارد شود؟",
    confirmDescription: "{count} فایل حافظه انتخاب‌شده را در فضای کاری این عامل کپی کنید.",
    confirmReplace:
  ...
  custodian: {
    ...
    history: {
      ...
      invalidEdit: "این ویرایش دستی اعتبارسنجی پیکربندی را رد نکرد.",
      opaqueChange: "قالب‌بندی یا نظرات بدون تغییرات مسیر پیکربندی قابل مشاهده تغییر کرد.",
      sources: {
    ...
    nudge: {
      configReload: "بارگذاری مجدد پیکربندی متوقف شد — از من بپرسید چه اتفاقی افتاد",
      channelAuth: "احراز هویت {channel} تضعیف شد — از من بپرسید چه اتفاقی افتاد",
      channelDisconnected: "{channel} همین الان قطع شد — از من بپرسید چه اتفاقی افتاد",
  ...
  mcpServers: {
    ...
    addedSuccess: "سرور MCP {name} افزوده شد.",
    enabledSuccess: "سرور MCP {name} فعال شد.",
    disabledSuccess: "سرور MCP {name} غیرفعال شد.",
    removedSuccess: "سرور MCP {name} حذف شد.",
    configUnavailable: "پیکربندی در دسترس نیست؛ تازه‌سازی کنید و دوباره تلاش کنید.",
    connectRequired: "برای تغییر سرورهای MCP به Gateway متصل شوید.",
    adminRequired: "تغییرات سرور MCP به دسترسی operator.admin نیاز دارد.",
    enable: "فعال‌سازی",
  ...
  labsPage: {
    intro:
      "Labs شامل قابلیت‌های آزمایشی است که ممکن است بین نسخه‌ها تغییر کنند، خراب شوند یا ناپدید شوند.",
    sectionTitle: "ویژگی‌های آزمایشی",
    sectionDescription: "تغییرات بلافاصله ذخیره می‌شوند و برای اجراهای آینده عامل اعمال می‌شوند.",
    documentation: "مستندات",
    restartRequired: "راه‌اندازی مجدد Gateway لازم است.",
    saveErrorTitle: "به‌روزرسانی ویژگی ممکن نشد",
    saveFailed: "تنظیمات ویژگی ذخیره نشد.",
    codeMode: {
      title: "حالت کد",
      description:
        "به عامل‌ها اجازه دهید ابزارها را در گردش‌کارهای فشرده و ایزوله‌شده جاوااسکریپت ترکیب کنند.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    havePhone: "قبلاً برنامه را دارید؟",
    pairDevice: "دستگاه خود را جفت کنید",
    sectionWatch: "روی مچ شما",
    sectionDesktop: "روی دسکتاپ شما",
    sectionBrowser: "در مرورگر شما",
    sectionCommunity: "جامعه",
    badgeBundledIos: "همراه با برنامه iOS",
    badgeBundledAndroid: "همراه با برنامه Android",
    ctaAppStore: "App Store",
    ctaPlayStore: "Google Play",
    ctaDownload: "دانلود",
    ctaDocs: "مستندات",
    ctaSetupGuide: "راهنمای راه‌اندازی",
    ctaOpenPlugins: "باز کردن افزونه‌ها",
    ctaBrowseClawHub: "مرور ClawHub",
    linkDiscord: "انجمن Discord",
    linkDocs: "مستندات",
    cards: {
      ios: {
        title: "iPhone",
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "گفت‌وگوهای قابل مشاهده در یک نگاه و پاسخ‌های سریع از روی مچ دست شما.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      macos: {
        title: "macOS",
        desc: "همراه نوار منو برای Gateway شما — اعلان‌ها، تأییدها، گفت‌وگوی سریع.",
      },
      windows: {
        title: "Windows",
      ...
      linux: {
        title: "Linux",
        desc: "برنامه دسکتاپ بومی — بیلدهای .deb و AppImage.",
      },
      chrome: {
        title: "افزونه Chrome",
  ...
  presence: {
    rosterLabel: "نمایش افراد آنلاین",
    rosterTitle: "آنلاین",
    serverRegion: "سرور",
    you: "شما",
  },
  profilePage: {
    ...
    identity: {
      ...
      notSet: "هویت تنظیم نشده است.",
      setIdentity: "تنظیم هویت",
      avatar: "آواتار",
      avatarDescription:
        "PNG، JPEG یا WebP. تصاویر به اندازه ۲۵۶ × ۲۵۶ یا کوچک‌تر تغییر اندازه داده می‌شوند.",
      chooseAvatar: "انتخاب تصویر",
      processingAvatar: "در حال پردازش…",
      displayName: "نام نمایشی",
      displayNameDescription: "برای دیگر افرادی که از این Gateway استفاده می‌کنند نمایش داده می‌شود.",
      linkedEmails: "ایمیل‌های پیوندشده",
      linkedEmailsDescription: "آدرس‌های ایمیل متصل به این نمایه.",
      openSettings: "باز کردن تنظیمات هویت برای {name}",
      avatarErrors: {
        invalid: "آن تصویر پردازش نشد.",
        sourceTooLarge: "تصویری با حجم ۱۰ مگابایت یا کمتر انتخاب کنید.",
        tooLarge: "آواتار پردازش‌شده بزرگ‌تر از ۵۱۲ کیلوبایت است.",
      },
    },
  },
  tasksPage: {
  ...
  gatewayLogs: {
    title: "گزارش‌ها",
    subtitle: "گزارش‌های فایلی Gateway (JSONL).",
    exportButton: "صادر کردن {label}",
    exportLabels: {
      filtered: "فیلترشده",
      visible: "قابل مشاهده",
    },
    ...
    autoFollow: "دنبال‌کردن خودکار",
    file: "فایل: {file}",
    truncated: "خروجی گزارش کوتاه شد؛ در حال نمایش آخرین بخش.",
    empty: "هیچ ورودی گزارشی وجود ندارد.",
  },
  pluginTabs: {
  ...
  board: {
    label: "داشبورد رشته",
    tabsLabel: "زبانه‌های داشبورد",
    moreTabs: "زبانه‌های بیشتر داشبورد",
    gridLabel: "ابزارک‌های داشبورد",
    emptyTitle: "یک تخته خالی، آماده کار",
    emptyHint: "عامل شما می‌تواند ابزارک‌ها را اینجا سنجاق کند — یک کارت وضعیت درخواست کنید.",
    actionFailed: "تغییر داشبورد ذخیره نشد.",
    actionInProgress: "تغییر دیگری در داشبورد هنوز در حال ذخیره‌شدن است.",
    announcement: {
      moved: "{title} جابجا شد.",
      resized: "اندازه {title} تغییر کرد.",
      removed: "{title} حذف شد.",
      granted: "دسترسی ویجت مجاز شد.",
      rejected: "دسترسی ویجت رد شد.",
    },
    widget: {
      cellLabel:
        "ویجت داشبورد: {title}. برای حرکت از کلیدهای جهت‌نما استفاده کنید. برای جابه‌جایی آن، Alt را نگه دارید و یک کلید جهت‌نما را فشار دهید.",
      moveHandle: "جابه‌جایی {title}",
      resizeHandle: "تغییر اندازه {title}",
      menuLabel: "گزینه‌های ویجت",
      moveToTab: "انتقال به برگه",
      noOtherTabs: "برگه دیگری وجود ندارد",
      resize: "تغییر اندازه",
      autoHeight: "ارتفاع خودکار",
      remove: "حذف",
      needsApproval: "نیازمند تأیید",
      needsApprovalDetail: "این ویجت دسترسی بیشتری درخواست کرد.",
      networkAccess: "مبداهای شبکه",
      ...
      appStaleTitle: "این برنامه سنجاق‌شده منسوخ است",
      appStaleDetail: "سرور، منبع یا رونوشت مبدأ آن دیگر در دسترس نیست.",
      retry: "تلاش مجدد",
      frameResolverMissing: "محتوای ویجت در دسترس نیست.",
      sandboxUnavailable: "میزبان جعبه‌شنی ویجت در دسترس نیست.",
      frameAuthorizationFailed: "پس از تلاش‌های مکرر برای تازه‌سازی، مجوز ویجت ناموفق بود.",
      sandboxOriginRequired:
        "پس از تلاش‌های مکرر برای تازه‌سازی، مجوز ویجت ناموفق بود. اگر gateway پشت یک reverse proxy یا تونل اجرا می‌شود که پورت جعبه‌شنی ویجت را مسیریابی نمی‌کند، mcp.apps.sandboxOrigin را روی یک مبدأ عمومی اختصاصی که به شنونده جعبه‌شنی مسیریابی شده است تنظیم کنید.",
      errorTitle: "این ویجت بارگذاری نشد",
      errorDetail: "مشکل محدود به همین کارت است.",
      actionErrorTitle: "تغییر ویجت ناموفق بود",
      actionErrorDetail: "داشبورد وضعیت قبلی ویجت را حفظ کرد.",
      errorShow: "نمایش جزئیات",
      kindMcp: "MCP",
      kindHtml: "HTML",
      kindPlugin: "افزونه",
      pluginLoading: "در حال بارگذاری ویجت افزونه…",
      disabledPlugin: "ویجت از افزونه غیرفعال {pluginId}",
    },
  },
  workboard: {
    widget: {
      cardLabel: "کارت Workboard",
      summaryLabel: "خلاصه Workboard",
      loading: "در حال بارگذاری Workboard…",
      cardIdRequired: "این ویجت به یک ویژگی cardId نیاز دارد.",
      cardMissing: "این کارت Workboard دیگر در دسترس نیست.",
      unassigned: "واگذارنشده",
      openBoard: "باز کردن برد",
      statusCounts: "کارت‌ها بر اساس وضعیت",
      noActiveCards: "هیچ کارت آماده یا در حال اجرا نیست.",
    },
    ...
    dashboardEmpty: "هنوز داشبوردی وجود ندارد — عامل فعال می‌تواند ویجت‌ها را سنجاق کند.",
  ...
  modelProviders: {
    ...
    globalUsage: "مصرف و هزینه سراسری",
    ...
    credentials: {
      label: "اعتبارنامه‌ها برای {agent}",
      oauth: "نمایه‌های OAuth: {count}",
      tokenProfiles: "نمایه‌های توکن: {count}",
      configKey: "کلید API در پیکربندی تنظیم شده است",
      envKey: "کلید API از محیط",
      envKeyNamed: "کلید API از محیط ({name})",
      profileKey: "نمایه‌های کلید API: {count}",
      none: "پیکربندی نشده",
    },
    apiKey: {
      label: "کلید API",
      placeholder: "کلید API ارائه‌دهنده را وارد کنید",
      replacePlaceholder: "کلید محرمانه ذخیره شد. برای جایگزینی، کلید جدیدی وارد کنید.",
      set: "تنظیم کلید API",
      replace: "جایگزینی کلید",
      remove: "حذف کلید",
      saved: "رمز ذخیره شد.",
      removed: "کلید API حذف شد.",
      authModeBlocked:
        'تا زمانی که حالت احراز هویت روی "{mode}" است، تغییر کلید API امکان‌پذیر نیست.',
    },
    probe: {
      test: "آزمایش اتصال",
      testing: "در حال آزمایش…",
      unavailable: "آزمایش اتصال به Gateway جدیدتری نیاز دارد.",
      latency: "{ms} میلی‌ثانیه",
      status: {
        ok: "متصل",
        auth: "احراز هویت ناموفق بود",
        rate_limit: "محدودیت نرخ اعمال شد",
        billing: "مشکل در صورت‌حساب",
    ...
    logout: {
      action: "خروج",
      confirm: "از {provider} خارج می‌شوید؟ پروفایل‌های ذخیره‌شده OAuth و توکن حذف خواهند شد.",
      loggingOut: "در حال خروج…",
      done: "خارج شدید.",
    },
    add: {
      title: "افزودن ارائه‌دهنده",
      subtitle: "یک ارائه‌دهنده مدل شناخته‌شده را انتخاب و کلید API آن را ذخیره کنید.",
      action: "افزودن ارائه‌دهنده",
      none: "همه ارائه‌دهندگان شناخته‌شده از قبل پیکربندی شده‌اند.",
      provider: "ارائه‌دهنده",
      selectProvider: "یک ارائه‌دهنده انتخاب کنید",
      save: "ذخیره ارائه‌دهنده",
      saved: "ارائه‌دهنده {provider} اضافه شد.",
    },
    defaults: {
      title: "مدل‌های پیش‌فرض",
      subtitle: "مدل اصلی، مدل‌های جایگزین به‌ترتیب و مدل کاربردی را انتخاب کنید.",
      primary: "مدل پیش‌فرض",
      utility: "مدل کاربردی",
      automatic: "خودکار (پیش‌فرض ارائه‌دهنده)",
      disabled: "غیرفعال",
      savedSelection: "انتخاب ذخیره‌شده",
      fallbacks: "جایگزین‌ها",
      noFallbacks: "هیچ مدل جایگزینی پیکربندی نشده است.",
      unsaved: "تغییرات ذخیره‌نشده",
      addFallback: "افزودن مدل جایگزین",
      selectModel: "یک مدل انتخاب کنید",
      selectFallback: "یک مدل جایگزین انتخاب کنید",
      noModels: "پیش از انتخاب مدل‌های پیش‌فرض، یک ارائه‌دهنده را پیکربندی کنید.",
      saved: "مدل‌های پیش‌فرض ذخیره شدند.",
    },
    readOnly: {
      disconnected: "برای تغییر تنظیمات مدل، به Gateway متصل شوید.",
      adminRequired: "فقط مرور. تغییرات مدل به دسترسی operator.admin نیاز دارد.",
    },
    notes: {
      saveKey: "ذخیره کلید API برای {provider} از Control UI",
      removeKey: "حذف کلید API برای {provider} از Control UI",
      addProvider: "افزودن ارائه‌دهنده مدل {provider} از Control UI",
      defaultModel: "به‌روزرسانی انتخاب مدل پیش‌فرض از Control UI",
    },
  },
  usage: {
    common: {
    ...
    details: {
      ...
      loadFailed: "امکان بارگذاری {detail} وجود نداشت: {error}",
  ...
  chat: {
    ...
    startupStatus: {
      ...
      provisioningEnvironment: "در حال آماده‌سازی محیط…",
    ...
    sessionHeader: {
      ...
      renameAria: "تغییر نام جلسه {title}",
      renameInputAria: "عنوان جلسه",
      renameInputPlaceholder: "عنوان جلسه",
      workspaceAria: "کنش‌های فضای کاری برای {workspace}",
      revealFinder: "نمایش در Finder",
      revealFileExplorer: "نمایش در File Explorer",
      revealFileManager: "باز کردن در مدیر فایل",
      copyPath: "کپی مسیر",
      ...
      untitledBranch: "شاخه بدون عنوان",
    ...
    board: {
      faceLabel: "نمای رشته",
      chatFace: "گفتگو",
      dashboardFace: "داشبورد",
      dockMenu: "داک گفتگو: {dock}",
      dockLeft: "داک گفتگو چپ",
      dockRight: "داک گفتگو راست",
      dockBottom: "داک گفتگو پایین",
      dockHidden: "پنهان کردن گفتگو",
      resizeDock: "تغییر اندازه داک گفتگو",
      reopenChat: "نمایش گفتگو",
      workboardCard: "کارت تخته کار: {title}، {status}",
      defaultTab: "اصلی",
      mockPlaceholder: "درز نمای تخته · {tabs} زبانه · {widgets} ویجت",
      mockOverview: "نمای کلی",
      mockResearch: "تحقیق",
      mockSessionStatus: "وضعیت رشته",
      mockRecentFindings: "یافته‌های اخیر",
      mockSourceMap: "نقشه منبع",
      resetTitle: "گفتگو بازنشانی شود؟",
      resetDescription: "زمینه گفتگو بازنشانی می‌شود. داشبورد شما باقی می‌ماند.",
    },
    catalog: {
    ...
    followUpModeServer: "پیش‌فرض سرور ({mode})",
    followUpModeLoading: "در حال بارگذاری…",
    ...
    workspaceConflict: {
      ...
      inspectCloud: "بررسی اولین نسخه ابری",
      takeCloud: "گرفتن اولین نسخه ابری",
      copyInspectCommand: "کپی فرمان بررسی ابری",
      copyTakeCommand: "کپی فرمان take-cloud",
      commandHelp:
      ...
      eventTitleMany: "نتیجه ابری با {count} تعارض اعمال شد",
      eventDescription: "نسخه‌های محلی برای این مسیرها حفظ شدند؛ سایر تغییرات ابری اعمال شد.",
    },
    compaction: {
    ...
    progressLabels: {
      ...
      cracking: "ترکاندن",
      sifting: "غربال کردن",
      brining: "نمک‌سود کردن",
      nautiling: "ناتیلوس‌پیمایی",
      krilling: "کریل‌پیمایی",
      barnacling: "چسبیدن",
      lobstering: "شاه‌میگوگیری",
      tidepooling: "آبگیرگردی",
      pearling: "مرواریدگیری",
      snapping: "تق‌تق کردن",
      surfacing: "سر برآوردن",
    },
    turnRecap: {
      doneIn: "انجام‌شده در {duration}",
      tokens: "{count} توکن",
      tokensOne: "۱ توکن",
    },
    commands: {
    ...
    sidebar: {
      ...
      updateMacAndGateway: "به‌روزرسانی برنامه Mac و Gateway",
      updateGateway: "به‌روزرسانی Gateway",
      ...
      toolActivity: "در حال استفاده از {tool}",
    },
    welcome: {
    ...
    questions: {
      ...
      skipping: "در حال رد کردن…",
      skipped: "ردشده",
      collapse: "جمع کردن پرسش",
      expand: "گسترش پرسش",
      eyebrow: "پرسش",
      cardLabel: "پرسش از دستیار",
      summaryLabel: "نتیجه پرسش",
      timeRemaining: "زمان باقی‌مانده",
      ownAnswer: "پاسخ خودتان…",
      ownAnswerFor: "پاسخ خودتان برای {header}",
      submitting: "در حال ارسال…",
      submitFailed: "ارسال ممکن نشد: {error}",
      answered: "پاسخ داده شد",
      answeredElsewhere: "جای دیگری پاسخ داده شد",
      unavailable: "در دسترس نیست",
      expired: "منقضی‌شده",
      cancelled: "لغوشده",
    },
    imageLightbox: {
      label: "پیش‌نمایش تصویر: {title}",
      open: "باز کردن تصویر {title}",
      openOriginal: "باز کردن نسخه اصلی",
      close: "بستن پیش‌نمایش تصویر",
      untitled: "تصویر",
    },
    messages: {
      activity: "فعالیت",
      copySelection: "کپی",
      forkFromHere: "انشعاب از اینجا",
      hide: "پنهان کردن",
      hideConfirm: "این پیام در این مرورگر پنهان شود؟ عامل همچنان آن را می‌بیند.",
      hideMessage: "پنهان کردن پیام",
      hideTooltip: "پنهان کردن فقط در این مرورگر",
      ...
      rewindUnavailable: "بازگشت هنگام کار کردن عامل در دسترس نیست",
      forkUnavailable: "انشعاب هنگام کار کردن عامل در دسترس نیست",
      showLess: "نمایش کمتر",
    ...
    modelControls: {
      ...
      reasoning: "استدلال",
      speed: "سرعت",
      sessionOverride: "بازنویسی رشته",
      usingDefault: "استفاده از پیش‌فرض تنظیمات",
      resetToDefault: "بازنشانی به پیش‌فرض ({model})",
    },
    sideChat: {
    ...
    observer: {
      title: "ناظر جلسه",
      expand: "گسترش ناظر جلسه",
      collapse: "جمع‌کردن ناظر جلسه",
      hide: "پنهان‌کردن ناظر جلسه",
      show: "نمایش ناظر جلسه",
      plan: "برنامه",
      progress: "{completed} از {total}",
      pullRequests: "درخواست‌های ادغام",
      running: "در حال اجرا",
      checksPassing: "{count} موفق",
      checksFailing: "{count} ناموفق",
      checksPending: "{count} در حال اجرا",
      askLabel: "درباره این جلسه بپرسید",
      askPlaceholder: "چرا این کار را انجام می‌دهد؟",
      askSubmit: "پرسش",
      askPending: "در حال بررسی مشاهدات…",
      askBusy: "ناظر در حال پاسخ به یک پرسش دیگر است.",
      askUnavailable: "ناظر اکنون نمی‌تواند پاسخ دهد.",
      boardCurrentStatus: "وضعیت فعلی",
      boardTimeline: "خط زمانی سلامت",
      boardCurrentRun: "اجرای فعلی",
      boardPreviousRun: "اجرای قبلی",
      boardUnknownRun: "اجرای ناشناس",
      boardSinceYouLeft: "از زمانی که رفتید",
      health: {
        "on-track": "در مسیر درست",
        grinding: "در حال کار",
        stuck: "گیر کرده",
        "waiting-on-user": "منتظر شما",
        "wrapping-up": "در حال جمع‌بندی",
        done: "انجام شد",
        failed: "ناموفق",
      },
    },
    ...
    composer: {
      ...
      takePhoto: "عکس گرفتن",
      cameraAccessFailed: "دسترسی به دوربین ممکن نیست.",
      cameraBusy: "دوربین مشغول است یا برای مرورگر در دسترس نیست.",
      cameraFallback: "دوربین {number}",
      cameraInput: "دوربین",
      cameraListUnsupported: "این مرورگر نمی‌تواند دوربین‌ها را فهرست کند.",
      cameraNoneFound: "هیچ دوربینی یافت نشد.",
      cameraPageInactive: "زمانی که این صفحه غیرفعال است، دوربین‌ها در دسترس نیستند.",
      cameraPermissionBlocked:
        "دسترسی به دوربین مسدود است. دسترسی دوربین و میکروفون را در تنظیمات سایت مرورگر مجاز کنید.",
      ...
      microphoneAppliesNextSession: "تغییرات هنگام شروع جلسه Talk بعدی شما اعمال می‌شوند.",
      microphoneListUnsupported: "این مرورگر نمی‌تواند ورودی‌های میکروفون را فهرست کند.",
      noCameras: "دوربین دیگری یافت نشد",
      ...
      holdToRecordSetting: "برای دیکته، دکمه میکروفون را نگه دارید",
      holdToRecordSettingDescription:
        "دکمه میکروفون کامپوزر را نگه دارید، صحبت کنید، سپس برای درج متن بدون ارسال رها کنید.",
      dictationAudioUnsupported: "Gateway یک قالب صوتی دیکته پشتیبانی‌نشده برگرداند.",
      dictationBrowserAudioUnsupported:
        "این مرورگر نمی‌تواند صدای دیکته را با نرخ ۸ کیلوهرتز ضبط کند.",
      dictationConnecting: "در حال شروع دیکته…",
      dictationDisconnected: "دیکته متوقف شد زیرا اتصال Gateway قطع شد.",
      dictationFailed: "دیکته ناموفق بود.",
      dictationFinalizing: "در حال اتمام دیکته…",
      dictationFinalizationTimedOut: "دیکته پیش از آنکه آخرین رونوشت جزئی نهایی شود متوقف شد.",
      dictationProviderUnavailable: "هیچ ارائه‌دهنده رونویسی برای دیکته پیکربندی نشده است.",
      dictationRecording: "در حال ضبط {elapsed}",
      dictationReleaseToInsert: "برای درج دیکته رها کنید",
      ...
      selectedCameraUnavailable:
        "دوربین انتخاب‌شده در دسترس نیست. دوربین دیگری یا حالت پیش‌فرض سیستم را انتخاب کنید.",
      ...
      systemDefaultCamera: "پیش‌فرض سیستم",
      switchCamera: "تعویض دوربین",
      turnCameraOff: "خاموش کردن دوربین",
      turnCameraOn: "روشن کردن دوربین",
    ...
    toolCards: {
      ...
      widgetActions: "کنش‌های ویجت",
      copyToClipboard: "کپی در کلیپ‌بورد",
      downloadFile: "دانلود فایل",
      widgetExportRerender: "این ویجت باید دوباره رندر شود تا به‌عنوان تصویر خروجی گرفته شود.",
      widgetExportFailed: "خروجی گرفتن از ویجت ناموفق بود. دوباره تلاش کنید.",
      pinToDashboard: "سنجاق به داشبورد",
      pinToDashboardPending: "در حال سنجاق کردن…",
      pinnedToDashboard: "سنجاق‌شده",
    ...
    backgroundTasks: {
      ...
      expandTask: "نمایش جزئیات {title}",
      collapseTask: "پنهان کردن جزئیات {title}",
      detailLoading: "در حال بارگذاری جزئیات وظیفه…",
      detailFailed: "جزئیات وظیفه بارگذاری نشد.",
      prompt: "پرامپت",
      output: "خروجی",
      promptUnavailable: "پرامپت در دسترس نیست.",
      outputPending: "هنوز خروجی‌ای وجود ندارد.",
    },
    sessionDiff: {
      title: "تغییرات",
    ...
    sessionDiscussion: {
      ...
      openExternal: "باز کردن گفت‌وگو در زبانه جدید",
      frameTitle: "گفت‌وگوی جلسه",
      unavailable: "این گفت‌وگو قابل جاسازی نیست.",
    },
    workspaceFiles: {
  ...
  cron: {
    ...
    form: {
      ...
      script: "اسکریپت",
      readOnlyPayloadHelp:
        "این payload خارج از Control UI ایجاد شده است. محتوای آن فقط‌خواندنی می‌ماند و هنگام ذخیره سایر تغییرات حفظ می‌شود.",
