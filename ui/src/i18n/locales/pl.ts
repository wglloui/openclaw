...
export const pl: TranslationMap = {
  ...
  configForm: {
    showAdvanced: "Pokaż zaawansowane",
    advancedCount: "Zaawansowane ({count})",
  ...
  chat: {
    ...
    observer: {
      title: "Obserwator sesji",
      expand: "Rozwiń obserwatora sesji",
      collapse: "Zwiń obserwatora sesji",
      hide: "Ukryj obserwatora sesji",
      show: "Pokaż obserwatora sesji",
      plan: "Plan",
    ...
    backgroundTasks: {
      ...
      collapseTask: "Ukryj szczegóły zadania {title}",
