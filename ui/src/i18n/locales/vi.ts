...
export const vi: TranslationMap = {
  ...
  chat: {
    ...
    observer: {
      title: "Trình quan sát phiên",
      expand: "Mở rộng trình quan sát phiên",
      collapse: "Thu gọn trình quan sát phiên",
      hide: "Ẩn trình quan sát phiên",
      show: "Hiện trình quan sát phiên",
      plan: "Kế hoạch",
      ...
      askLabel: "Hỏi về phiên này",
      askPlaceholder: "Tại sao nó lại làm vậy?",
      askSubmit: "Hỏi",
      askPending: "Đang kiểm tra các quan sát…",
      askBusy: "Trình quan sát đang trả lời một câu hỏi khác.",
      askUnavailable: "Trình quan sát không thể trả lời ngay lúc này.",
    ...
    backgroundTasks: {
      ...
      collapseTask: "Ẩn chi tiết về {title}",
