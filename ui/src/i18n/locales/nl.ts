...
export const nl: TranslationMap = {
  common: {
    ...
    staleData: "Verouderde gegevens worden weergegeven.",
  ...
  channels: {
    ...
    hub: {
      connectedTitle: "Je kanalen",
      addTitle: "Een kanaal toevoegen",
      addSubtitle: "Kies een service en volg de begeleide configuratie.",
      updatedAgo: "Bijgewerkt {ago}",
      noneConnected:
        "Er zijn nog geen kanalen verbonden. Kies er hieronder een om aan de slag te gaan.",
      partialSnapshot: "Sommige kanaalcontroles zijn niet voltooid binnen de beschikbare UI-tijd.",
      stateRunning: "Actief",
      stateConfigured: "Geconfigureerd",
      stateAttention: "Vereist aandacht",
      setUp: "Configureren",
      guidedSetup: "Begeleide stapsgewijze configuratie",
      openDetails: "Details openen",
      lastMessageAgo: "Laatste bericht {ago}",
      browseAllTitle: "Meer kanalen…",
      browseAllSubtitle: "Bekijk alle beschikbare kanalen, inclusief installeerbare plug-ins.",
      runSetup: "Configuratie starten",
      saveBeforeSetup:
        "Je hebt niet-opgeslagen wijzigingen in de kanaalconfiguratie. Sla ze op of laad ze opnieuw voordat je de begeleide configuratie start.",
    },
    pairing: {
      title: "DM-toegangsverzoeken",
      subtitle:
        "Bekijk personen die wachten om directe berichten te sturen naar met koppeling beveiligde kanalen.",
      channelFilter: "Kanaal",
      accountFilter: "Account",
      allChannels: "Alle kanalen",
      allAccounts: "Alle accounts",
      approve: "Goedkeuren",
      dismiss: "Negeren",
      approveAria: "{sender} goedkeuren voor {channel}, account {account}",
      dismissAria: "{sender} negeren voor {channel}, account {account}",
      requested: "Aangevraagd {ago}",
      expires: "Verloopt {ago}",
      senderDetails: "Afzenderdetails",
      missingPermission:
        "Deze verbinding heeft geen operator.pairing-toegang, dus DM-verzoeken kunnen niet worden beoordeeld.",
      noAccounts: "Geen geconfigureerde kanaalaccounts gebruiken DM-afzenderkoppeling.",
      noRequests: "Geen openstaande DM-toegangsverzoeken.",
      noFilteredRequests: "Geen openstaande verzoeken komen overeen met deze filters.",
      limits:
        "Verzoeken verlopen na {minutes} minuten. Elk kanaalaccount kan maximaal {count} openstaande verzoeken bevatten.",
      detailTitle: "DM-toegang",
      detailSubtitle:
        "Personen moeten worden goedgekeurd voordat hun directe berichten de agent bereiken.",
      pendingCount: "{count} in behandeling",
      noPending: "Geen openstaande verzoeken",
      review: "Verzoeken beoordelen",
      approveDialogTitle: "DM-toegang goedkeuren",
      dismissDialogTitle: "Verzoek om DM-toegang afwijzen",
      approveExplanation:
        "Hiermee kan de afzender met de agent praten via directe berichten. Dit verleent geen groepstoegang.",
      dismissExplanation:
        "Hiermee wordt het huidige verzoek verwijderd, maar de afzender wordt niet geblokkeerd. Ze kunnen later opnieuw toegang aanvragen.",
      notifyRequester: "Verzoeker na goedkeuring op de hoogte stellen",
      makeCommandOwner: "Maak deze afzender ook de eerste command owner",
      commandOwnerHelp:
        "Command owners kunnen bevoegde opdrachten uitvoeren en gevaarlijke acties goedkeuren. Deze optie is alleen beschikbaar zolang er geen owner is geconfigureerd.",
      commandOwnerNeedsAdmin:
        "Er is geen command owner geconfigureerd. Deze verbinding heeft operator.admin nodig om de eerste owner toe te wijzen.",
      approvedNotice: "DM-toegang goedgekeurd.",
      approvedOwnerNotice: "DM-toegang goedgekeurd en de eerste command owner is geconfigureerd.",
      approvedNotificationFailedNotice:
        "DM-toegang goedgekeurd, maar de melding aan de verzoeker kon niet worden bezorgd.",
      approvedOwnerFailedNotice:
        "DM-toegang goedgekeurd, maar de eerste command owner kon niet worden geconfigureerd.",
      approvedFollowupsFailedNotice:
        "DM-toegang goedgekeurd, maar zowel de melding aan de verzoeker als het instellen van de command owner is mislukt.",
      dismissedNotice:
        "Verzoek om DM-toegang afgewezen. De afzender kan opnieuw toegang aanvragen.",
    },
    setup: {
      dialogLabel: "{channel} configureren",
      title: "{channel} configureren",
      genericTitle: "een kanaal",
      subtitle: "Een korte begeleide configuratie — je kunt alles later verfijnen.",
      starting: "Configuratie wordt gestart…",
      working: "Bezig…",
      sessionExpired:
        "Deze installatiesessie is verlopen nadat de Gateway opnieuw is opgestart. Sluit dit dialoogvenster en start de kanaalinstallatie opnieuw.",
      continue: "Doorgaan",
      finish: "Voltooien",
      copyText: "Kopiëren",
      ...
      whatsappQrLoading: "QR-code genereren…",
      whatsappQrHint: "Klik op QR tonen om een koppelingscode te genereren.",
      whatsappLinked: "WhatsApp is gekoppeld en klaar voor gebruik.",
      regenerateQr: "Nieuwe QR-code",
      linkLater: "Later koppelen",
    },
    config: {
    ...
    whatsapp: {
      ...
      loggedOut: "Afgemeld.",
      logoutNotCleared:
        "Er is geen opgeslagen WhatsApp-sessie gewist. Deze is mogelijk al afwezig, of de auth-map moet handmatig worden opgeschoond.",
    },
  ...
  agentChip: {
    menuLabel: "Agentmenu",
    agents: "Agents",
    openChat: "Chat met {name}",
    offlineOpenSettings: "Offline — open Instellingen",
    switchAgent: "Agent wisselen",
    working: "Bezig…",
  ...
  newSession: {
    ...
    worktree: "Worktree",
    checkingGit: "Git-beschikbaarheid controleren…",
    gitCheckUnavailable:
      "Kon Git niet verifiëren voor deze map. Kies deze opnieuw om het nogmaals te proberen.",
  ...
  sessionsView: {
    ...
    global: "Globaal",
    unknown: "Onbekend",
    sessionState: "Threadstatus",
    all: "Alle",
    sessionArchived: "Thread gearchiveerd",
    sessionsArchived: "{count} threads gearchiveerd",
    deleteAllArchived: "Alle gearchiveerde verwijderen…",
    deleteAllArchivedConfirm: "{count} gearchiveerde threads en hun transcripties verwijderen?",
    ...
    waitingForAnswer: "Wacht op je antwoord",
    waitingForApproval: "Wacht op goedkeuring",
    runFailedReason: "Uitvoering mislukt: {reason}",
    ...
    showChildSessions: "Toon {count} onderliggende sessies voor {session}",
    hideChildSessions: "Verberg {count} onderliggende sessies voor {session}",
    childSessions: "Onderliggende sessies",
    showMoreChildren: "Nog {count} weergeven",
    ...
    cloudWorkerDescendantConflict: "Cloud worker-kind: 1 workspaceconflict",
    cloudWorkerDescendantConflicts: "Cloud worker-kinderen: {count} workspaceconflicten",
    ...
    customEmoji: "Aangepaste emoji",
    invalidEmojiIcon: "Voer precies één emoji in.",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileIdentity: "Je gatewayprofiel",
      assistantIdentity: "Assistent-identiteit",
      displayName: "Weergavenaam",
      displayNamePlaceholder: "Je naam",
      saveProfile: "Naam opslaan",
      saving: "Opslaan…",
      uploading: "Verwerken…",
      profileHint:
        "JPEG, PNG of WebP. Afbeeldingen worden vanuit het midden bijgesneden en verkleind naar 512px.",
      profileLoadFailed: "Kon je profiel niet laden.",
      profileSaveFailed: "Kon je profiel niet opslaan.",
      avatarInvalid: "Kies een geldige JPEG-, PNG- of WebP-afbeelding.",
      avatarTooLarge: "De verwerkte avatar is nog steeds te groot.",
  ...
  configView: {
    categories: {
      ...
      security: "Privacy en beveiliging",
      automation: "Automatisering",
    ...
    syncedHint: "Gesynchroniseerd tussen je apparaten via de gateway.",
    notifications: {
      title: "Pushmeldingen",
    ...
    sidebarPrefs: {
      title: "Zijbalk",
      hint: "Kies wat er wordt weergegeven terwijl sessies actief zijn.",
      liveActivity: "Toon live agentactiviteit in zijbalk",
      liveActivityHint: "Toon de recentste assistent- of toolactiviteit onder actieve sessies.",
    },
    sessionObserver: {
      title: "Sessieobservator",
      hint: "Vat langlopende sessies samen met een klein hulpmodel.",
      toggle: "Sessieobservator",
      toggleHint: "Genereer live statusoverzichten voor geabonneerde Control UI-sessies.",
      resolvedModel: "Opgelost klein model",
      ...
      modelPickerHint: "Gebruikt voor observatoroverzichten en andere korte hulptaken.",
      modelCatalogUnavailable: "Expliciete modelcatalogus niet beschikbaar",
      auto: "Auto (providerstandaard)",
      disabled: "Uitgeschakeld",
      toggleNote: "Werk de Control UI-sessieobservator bij",
      modelNote: "Werk het standaard hulpmodel bij",
    },
    connection: {
      title: "Verbinding",
      gateway: "Gateway",
    ...
    rawDraftBlocksApply:
      "Niet-opgeslagen ruwe configuratiewijzigingen — sla ze op of verwerp ze in de Raw-editor voordat je herstart.",
    rawDraftPendingFormTitle:
      "Niet-opgeslagen ruwe configuratiewijzigingen — sla ze op of verwerp ze voordat je naar Formulier schakelt.",
    rawDraftBlocksFormEdit:
      "Niet-opgeslagen ruwe configuratiewijzigingen konden niet worden geparseerd; los ze op in de Raw-editor voordat je instellingen wijzigt.",
    invalidConfig:
  ...
  execApproval: {
    ...
    otherPending: "Andere openstaande verzoeken",
    reviewRequest: "Beoordeel goedkeuring van {agent}: {command}",
    agentPendingOne: "{count} goedkeuring in behandeling",
    agentPending: "{count} goedkeuringen in behandeling",
  ...
  terminal: {
    ...
    uploadProgress: "{current} van {total} uploaden",
    ...
    noSessions: "Geen actieve terminalsessies",
    currentSession: "huidig",
    sessionAttached: "gekoppeld",
  ...
  routeTitles: {
    modelProviders: "Modelaanbieders",
    notifications: "Meldingen",
    advanced: "Geavanceerd",
  },
  tabs: {
  ...
  subtitles: {
    ...
    apps: "Companion-apps voor telefoon, horloge, desktop en browser.",
    ...
    modelSetup: "Verbind een geverifieerd AI-model",
    modelProviders: "Configured providers with plan, quota, and cost.",
    memoryImport: "Importeer geheugen van Codex en Claude Code in een agentwerkruimte.",
    notifications: "Browserpushmeldingen van je gateway.",
    security: "Gateway-authenticatie, exec-beleid, toolprofiel en goedkeuringen.",
    advanced: "Alle overige configuratiesecties, plus de ruwe bestandseditor.",
  ...
  modelSetup: {
    ...
    candidates: {
      ...
      signInNeeded: "Aanmelding vereist",
      detected: "Gedetecteerd",
      testAndUse: "Testen en gebruiken",
    ...
    signIn: {
      title: "Aanmelden bij een provider",
      signIn: "Aanmelden",
      pair: "Koppelen",
    ...
    failure: {
      auth: "Verificatie mislukt",
      rateLimit: "Snelheidslimiet bereikt",
      billing: "Factureringsprobleem",
      timeout: "Time-out",
      format: "Ongeldig antwoord",
      unavailable: "Niet beschikbaar",
      unknown: "Verbinding mislukt",
    },
    errors: {
      requestFailed: "De aanvraag voor het instellen van het model is mislukt.",
      activationFailed: "Het model kon niet worden geactiveerd.",
    },
    wizard: {
      ...
      continue: "Doorgaan",
      submit: "Verzenden",
      openSignIn: "Aanmeldpagina openen",
      copy: "Kopiëren",
      expires: "Verloopt over {count} minuten",
      cancelled: "De aanmelding bij de provider is geannuleerd.",
      sessionExpired:
        "Deze installatiesessie is verlopen nadat de Gateway opnieuw is opgestart. Sluit dit venster en start de modelinstallatie opnieuw.",
      notComplete: "De aanmelding is voltooid, maar de modelconfiguratie is nog niet compleet.",
    },
  },
  memoryImport: {
    unknownCollection: "Geheugenverzameling",
    claudeCode: "Claude Code",
    fileCountOne: "{count} bestand",
    fileCount: "{count} bestanden",
    alreadyImported: "{count} bestaand",
    ready: "Gereed",
    existing: "Bestaand",
    importComplete: "Import voltooid",
    importIncomplete: "Import onvolledig",
    importedCount: "{count} bestanden geïmporteerd",
    importedWithIssues: "{migrated} geïmporteerd · {errors} mislukt · {conflicts} conflicten",
    reportSaved: "rapport opgeslagen",
    recoveryFile: "Herstelbestand",
    recoveryJournal: "Hersteljournaal",
    itemBackup: "Back-up van item",
    codexDescription: "Geconsolideerde geheugenbestanden van Codex.",
    claudeDescription: "Automatische geheugenbestanden per project van Claude Code.",
    providerFallback: "Importeer assistentgeheugen in deze agentwerkruimte.",
    reviewFiles: "Bestanden controleren",
    notFound: "Niet gevonden",
    noMemoryFound: "Geen importeerbaar geheugen gevonden op deze computer.",
    source: "Bron",
    destination: "Bestemming",
    selectedCount: "{count} geselecteerd",
    selectAtLeastOne: "Selecteer ten minste één bestand",
    importSelected: "Selectie importeren",
    confirmTitle: "Importeren uit {provider}?",
    confirmDescription:
      "Kopieer {count} geselecteerde geheugenbestanden naar de werkruimte van deze agent.",
    confirmReplace:
  ...
  custodian: {
    ...
    history: {
      ...
      invalidEdit: "Deze handmatige bewerking is niet geslaagd voor de configuratievalidatie.",
      opaqueChange:
        "Opmaak of opmerkingen zijn gewijzigd zonder zichtbare wijzigingen in het configuratiepad.",
      sources: {
    ...
    nudge: {
      configReload: "Configuratie opnieuw laden is gestopt — vraag me wat er is gebeurd",
      channelAuth: "{channel}-authenticatie verslechterd — vraag me wat er is gebeurd",
      channelDisconnected: "{channel} is zojuist losgekoppeld — vraag me wat er is gebeurd",
  ...
  mcpServers: {
    ...
    addedSuccess: "MCP-server {name} toegevoegd.",
    enabledSuccess: "MCP-server {name} ingeschakeld.",
    disabledSuccess: "MCP-server {name} uitgeschakeld.",
    removedSuccess: "MCP-server {name} verwijderd.",
    configUnavailable: "Configuratie is niet beschikbaar; vernieuw en probeer het opnieuw.",
    connectRequired: "Maak verbinding met de gateway om MCP-servers te wijzigen.",
    adminRequired: "Wijzigingen aan MCP-servers vereisen operator.admin-toegang.",
    enable: "Inschakelen",
  ...
  labsPage: {
    intro:
      "Labs bevat experimentele functies die tussen releases kunnen veranderen, kapotgaan of verdwijnen.",
    sectionTitle: "Experimentele functies",
    sectionDescription:
      "Wijzigingen worden meteen opgeslagen en toegepast op toekomstige agentruns.",
    documentation: "Documentatie",
    restartRequired: "Herstart van de gateway vereist.",
    saveErrorTitle: "Kan functie niet bijwerken",
    saveFailed: "De functie-instelling kon niet worden opgeslagen.",
    codeMode: {
      title: "Code Mode",
      description: "Laat agents tools combineren in compacte, sandboxed JavaScript-workflows.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    havePhone: "Heb je de app al?",
    pairDevice: "Koppel je apparaat",
    sectionWatch: "Om je pols",
    sectionDesktop: "Op je desktop",
    sectionBrowser: "In je browser",
    sectionCommunity: "Community",
    badgeBundledIos: "Inbegrepen bij de iOS-app",
    badgeBundledAndroid: "Inbegrepen bij de Android-app",
    ctaAppStore: "App Store",
    ctaPlayStore: "Google Play",
    ctaDownload: "Downloaden",
    ctaDocs: "Documentatie",
    ctaSetupGuide: "Installatiegids",
    ctaOpenPlugins: "Plug-ins openen",
    ctaBrowseClawHub: "Door ClawHub bladeren",
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Overzichtelijke chats en snelle antwoorden vanaf je pols.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      macos: {
        title: "macOS",
        desc: "Menubalk-companion voor je Gateway — meldingen, goedkeuringen, snelle chat.",
      },
      windows: {
        title: "Windows",
      ...
      linux: {
        title: "Linux",
        desc: "Native desktop-app — .deb- en AppImage-builds.",
      },
      chrome: {
  ...
  presence: {
    rosterLabel: "Toon wie online is",
    rosterTitle: "Online",
    serverRegion: "Server",
    you: "jij",
  },
  profilePage: {
    ...
    identity: {
      ...
      notSet: "Identiteit is niet ingesteld.",
      setIdentity: "Identiteit instellen",
      avatar: "Avatar",
      avatarDescription:
        "PNG, JPEG of WebP. Afbeeldingen worden verkleind naar 256 × 256 of kleiner.",
      chooseAvatar: "Afbeelding kiezen",
      processingAvatar: "Verwerken…",
      displayName: "Weergavenaam",
      displayNameDescription: "Zichtbaar voor andere personen die deze gateway gebruiken.",
      linkedEmails: "Gekoppelde e-mails",
      linkedEmailsDescription: "E-mailadressen die aan dit profiel zijn gekoppeld.",
      openSettings: "Open identiteitsinstellingen voor {name}",
      avatarErrors: {
        invalid: "Die afbeelding kon niet worden verwerkt.",
        sourceTooLarge: "Kies een afbeelding van 10 MB of kleiner.",
        tooLarge: "De verwerkte avatar is groter dan 512 KB.",
      },
    },
  },
  tasksPage: {
  ...
  gatewayLogs: {
    title: "Logboeken",
    subtitle: "Gateway-bestandslogboeken (JSONL).",
    exportButton: "{label} exporteren",
    exportLabels: {
      filtered: "gefilterd",
      visible: "zichtbaar",
    },
    filter: "Filter",
    searchPlaceholder: "Logboeken doorzoeken",
    autoFollow: "Automatisch volgen",
    file: "Bestand: {file}",
    truncated: "Loguitvoer ingekort; nieuwste deel wordt getoond.",
    empty: "Geen logvermeldingen.",
  },
  pluginTabs: {
  ...
  board: {
    ...
    tabsLabel: "Dashboardtabbladen",
    moreTabs: "Meer dashboardtabbladen",
    gridLabel: "Dashboardwidgets",
    emptyTitle: "Een leeg bord, klaar voor werk",
    emptyHint: "Je agent kan hier widgets vastzetten — vraag bijvoorbeeld om een statuskaart.",
    actionFailed: "De dashboardwijziging kon niet worden opgeslagen.",
    actionInProgress: "Er wordt nog een andere dashboardwijziging opgeslagen.",
    announcement: {
      moved: "{title} verplaatst.",
      resized: "Grootte van {title} aangepast.",
      removed: "{title} verwijderd.",
      granted: "Widgettoegang toegestaan.",
      rejected: "Widgettoegang geweigerd.",
    },
    widget: {
      cellLabel:
        "Dashboardwidget: {title}. Gebruik de pijltoetsen om te navigeren. Houd Alt ingedrukt en druk op een pijltoets om het te verplaatsen.",
      moveHandle: "{title} verplaatsen",
      resizeHandle: "Grootte van {title} aanpassen",
      menuLabel: "Widgetopties",
      moveToTab: "Verplaatsen naar tabblad",
      noOtherTabs: "Geen andere tabbladen",
      resize: "Formaat wijzigen",
      autoHeight: "Automatische hoogte",
      remove: "Verwijderen",
      needsApproval: "Vereist goedkeuring",
      needsApprovalDetail: "Deze widget vroeg om aanvullende toegang.",
      networkAccess: "Netwerkoorsprongen",
      ...
      appStaleTitle: "Deze vastgezette app is verouderd",
      appStaleDetail:
        "De server, resource of het oorspronkelijke transcript is niet meer beschikbaar.",
      retry: "Opnieuw proberen",
      frameResolverMissing: "Widgetinhoud is niet beschikbaar.",
      sandboxUnavailable: "Widget-sandboxhost is niet beschikbaar.",
      frameAuthorizationFailed: "Widgetautorisatie is mislukt na herhaalde vernieuwingspogingen.",
      sandboxOriginRequired:
        "Widgetautorisatie is mislukt na herhaalde vernieuwingspogingen. Als de gateway achter een reverse proxy of tunnel draait die de widget-sandboxpoort niet routeert, stel dan mcp.apps.sandboxOrigin in op een specifieke openbare oorsprong die naar de sandbox-listener wordt gerouteerd.",
      errorTitle: "Deze widget kon niet worden geladen",
      errorDetail: "Het probleem blijft beperkt tot deze kaart.",
      actionErrorTitle: "Wijzigen van widget mislukt",
      actionErrorDetail: "Het dashboard behield de vorige widgetstatus.",
  ...
  workboard: {
    widget: {
      ...
      summaryLabel: "Workboard-samenvatting",
      ...
      noActiveCards: "Geen gereedstaande of actieve kaarten.",
    },
    ...
    dashboardEmpty: "Nog geen dashboard — de werkende agent kan widgets vastzetten.",
    openSession: "Sessie openen",
  ...
  modelProviders: {
    ...
    globalUsage: "Globaal gebruik en kosten",
    ...
    credentials: {
      ...
      envKey: "API-sleutel uit de omgeving",
      envKeyNamed: "API-sleutel uit de omgeving ({name})",
      profileKey: "API-sleutelprofielen: {count}",
      none: "Niet geconfigureerd",
    },
    apiKey: {
      label: "API-sleutel",
      placeholder: "Voer de API-sleutel van de provider in",
      replacePlaceholder: "Geheim opgeslagen. Voer een nieuwe sleutel in om deze te vervangen.",
      set: "API-sleutel instellen",
      replace: "Sleutel vervangen",
      remove: "Sleutel verwijderen",
      saved: "Geheim opgeslagen.",
      removed: "API-sleutel verwijderd.",
      authModeBlocked:
        'Wijzigingen aan de API-sleutel zijn niet beschikbaar zolang de authenticatiemodus "{mode}" is.',
    },
    probe: {
      test: "Verbinding testen",
      testing: "Testen…",
      unavailable: "Voor het testen van de verbinding is een nieuwere Gateway vereist.",
      latency: "{ms} ms",
      status: {
        ok: "Verbonden",
        auth: "Authenticatie mislukt",
        rate_limit: "Snelheidslimiet bereikt",
        billing: "Factureringsprobleem",
        timeout: "Time-out",
        format: "Ongeldig antwoord",
        unknown: "Verbinding mislukt",
    ...
    logout: {
      action: "Uitloggen",
      confirm: "Uitloggen bij {provider}? Opgeslagen OAuth- en tokenprofielen worden verwijderd.",
      loggingOut: "Uitloggen…",
      done: "Uitgelogd.",
    },
    add: {
      title: "Provider toevoegen",
      subtitle: "Kies een bekende modelprovider en sla de API-sleutel op.",
      action: "Provider toevoegen",
      none: "Alle bekende providers zijn al geconfigureerd.",
      provider: "Provider",
      selectProvider: "Selecteer een provider",
      save: "Provider opslaan",
      saved: "Provider {provider} toegevoegd.",
    },
    defaults: {
      title: "Standaardmodellen",
      subtitle: "Kies het primaire model, de geordende fallbackmodellen en het hulpmodel.",
      primary: "Standaardmodel",
      utility: "Hulmodel",
      automatic: "Automatisch (standaard van provider)",
      disabled: "Uitgeschakeld",
      savedSelection: "Opgeslagen selectie",
      fallbacks: "Fallbacks",
      noFallbacks: "Geen fallbackmodellen geconfigureerd.",
      unsaved: "Niet-opgeslagen wijzigingen",
      addFallback: "Fallbackmodel toevoegen",
      selectModel: "Selecteer een model",
      selectFallback: "Selecteer een fallbackmodel",
      noModels: "Configureer een provider voordat u standaardmodellen selecteert.",
      saved: "Standaardmodellen opgeslagen.",
    },
    readOnly: {
      disconnected: "Maak verbinding met de Gateway om de modelinstellingen te wijzigen.",
      adminRequired: "Alleen bekijken. Voor modelwijzigingen is operator.admin-toegang vereist.",
    },
    notes: {
      saveKey: "API-sleutel voor {provider} opslaan vanuit Control UI",
      removeKey: "API-sleutel voor {provider} verwijderen vanuit Control UI",
      addProvider: "Modelprovider {provider} toevoegen vanuit Control UI",
      defaultModel: "Standaardmodelselectie bijwerken vanuit Control UI",
    },
  },
  usage: {
    common: {
    ...
    details: {
      ...
      loadFailed: "Kan {detail} niet laden: {error}",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      renameAria: "Sessie {title} hernoemen",
      renameInputAria: "Sessietitel",
      renameInputPlaceholder: "Sessietitel",
      workspaceAria: "Werkruimteacties voor {workspace}",
      revealFinder: "Tonen in Finder",
      revealFileExplorer: "Tonen in Verkenner",
      revealFileManager: "Openen in bestandsbeheer",
      ...
      branchSwitchRequiresAdmin:
        "Voor het wisselen van vertakkingen is beheerderstoegang van de operator vereist.",
      untitledBranch: "Naamloze vertakking",
    ...
    board: {
      ...
      dockMenu: "Chatdock: {dock}",
      dockLeft: "Chat links vastzetten",
      dockRight: "Chat rechts vastzetten",
      dockBottom: "Chat onderaan vastzetten",
      dockHidden: "Chat verbergen",
      resizeDock: "Chatdock vergroten/verkleinen",
      reopenChat: "Chat weergeven",
      workboardCard: "Workboard-kaart: {title}, {status}",
      defaultTab: "Hoofd",
      mockPlaceholder: "Bordweergavenaad · {tabs} tabbladen · {widgets} widgets",
      mockOverview: "Overzicht",
      mockResearch: "Onderzoek",
      mockSessionStatus: "Threadstatus",
      mockRecentFindings: "Recente bevindingen",
      mockSourceMap: "Bronkaart",
      resetTitle: "Gesprek opnieuw instellen?",
      resetDescription: "De gesprekscontext wordt opnieuw ingesteld. Je dashboard blijft behouden.",
    },
    catalog: {
    ...
    followUpModeServer: "Serverstandaard ({mode})",
    followUpModeLoading: "laden…",
    ...
    workspaceConflict: {
      ...
      inspectCloud: "De eerste cloudversie inspecteren",
      takeCloud: "De eerste cloudversie overnemen",
      copyInspectCommand: "Cloud-inspectiecommando kopiëren",
      copyTakeCommand: "Take-cloud-commando kopiëren",
      commandHelp:
      ...
      eventTitleMany: "Cloudresultaat toegepast met {count} conflicten",
      eventDescription:
        "Lokale versies zijn behouden voor deze paden; andere cloudwijzigingen zijn toegepast.",
    },
    compaction: {
    ...
    progressLabels: {
      shelling: "Schelpen verzamelen",
      scuttling: "Scharrelen",
      clawing: "Klauwen",
      pinching: "Knijpen",
      molting: "Vervellen",
      bubbling: "Borrelen",
      tiding: "Deinen",
      reefing: "Riffen verkennen",
      cracking: "Kraken",
      sifting: "Zeven",
      brining: "Pekelen",
      nautiling: "Nautilussen",
      krilling: "Krillen",
      barnacling: "Zeepokken",
      lobstering: "Kreeften",
      tidepooling: "Getijdenpoelen verkennen",
      pearling: "Parelen",
      snapping: "Happen",
      surfacing: "Bovenkomen",
    },
    turnRecap: {
      doneIn: "Klaar in {duration}",
      tokens: "{count} tokens",
      tokensOne: "1 token",
    },
    commands: {
    ...
    sidebar: {
      ...
      updateMacAndGateway: "Mac-app + Gateway bijwerken",
      updateGateway: "Gateway bijwerken",
    ...
    questions: {
      ...
      collapse: "Vraag samenvouwen",
      expand: "Vraag uitvouwen",
      eyebrow: "Vraag",
      cardLabel: "Vraag van de assistent",
      summaryLabel: "Uitkomst van de vraag",
      timeRemaining: "Resterende tijd",
      ownAnswer: "Je eigen antwoord…",
      ownAnswerFor: "Je eigen antwoord voor {header}",
      submitting: "Verzenden…",
      submitFailed: "Kon niet verzenden: {error}",
      answered: "Beantwoord",
    ...
    messages: {
      ...
      forkFromHere: "Vanaf hier vertakken",
      hide: "Verbergen",
      hideConfirm: "Dit bericht verbergen in deze browser? De agent ziet het nog steeds.",
      hideMessage: "Bericht verbergen",
      hideTooltip: "Alleen in deze browser verbergen",
      ...
      rewindUnavailable: "Terugspoelen is niet beschikbaar terwijl de agent bezig is",
      forkUnavailable: "Fork is niet beschikbaar terwijl de agent bezig is",
    ...
    modelControls: {
      ...
      reasoning: "Redenering",
      speed: "Snelheid",
      sessionOverride: "Thread-overschrijving",
      usingDefault: "Standaard uit Instellingen wordt gebruikt",
      resetToDefault: "Terugzetten naar standaard ({model})",
    },
    sideChat: {
      title: "Zijgesprek",
    ...
    observer: {
      title: "Sessieobservator",
      expand: "Sessieobservator uitvouwen",
      collapse: "Sessieobservator invouwen",
      hide: "Sessieobservator verbergen",
      show: "Sessieobservator tonen",
      plan: "Plan",
      ...
      askSubmit: "Vragen",
      askPending: "Observaties controleren…",
      askBusy: "De observer beantwoordt al een vraag.",
      askUnavailable: "De observer kan nu niet antwoorden.",
      boardCurrentStatus: "Huidige status",
      boardTimeline: "Gezondheidstijdlijn",
      boardCurrentRun: "Huidige run",
      boardPreviousRun: "Vorige run",
      boardUnknownRun: "Niet-geïdentificeerde run",
      boardSinceYouLeft: "Sinds je weg was",
      health: {
        "on-track": "Op koers",
        grinding: "Bezig",
        stuck: "Vastgelopen",
        "waiting-on-user": "Wacht op jou",
        "wrapping-up": "Afronden",
        done: "Klaar",
        failed: "Mislukt",
      },
    },
    ...
    composer: {
      ...
      cameraAccessFailed: "Kan geen toegang tot de camera krijgen.",
      cameraBusy: "De camera is bezet of niet beschikbaar voor de browser.",
      cameraFallback: "Camera {number}",
      cameraInput: "Camera",
      cameraListUnsupported: "Deze browser kan geen camera's weergeven.",
      cameraNoneFound: "Geen camera gevonden.",
      cameraPageInactive: "Camera's zijn niet beschikbaar terwijl deze pagina inactief is.",
      cameraPermissionBlocked:
        "Cameratoegang is geblokkeerd. Sta camera- en microfoontoegang toe in de site-instellingen van de browser.",
      ...
      microphoneAppliesNextSession:
        "Wijzigingen worden toegepast wanneer je je volgende Talk-sessie start.",
      microphoneListUnsupported: "Deze browser kan geen microfooningangen weergeven.",
      noCameras: "Geen extra camera's gevonden",
      ...
      holdToRecordSetting: "Houd de microfoonknop ingedrukt om te dicteren",
      holdToRecordSettingDescription:
        "Houd de microfoonknop van de composer ingedrukt, spreek en laat los om tekst in te voegen zonder te verzenden.",
      dictationAudioUnsupported: "De Gateway gaf een niet-ondersteund dicteeraudioformaat terug.",
      dictationBrowserAudioUnsupported: "Deze browser kan geen dicteeraudio opnemen op 8 kHz.",
      dictationConnecting: "Dicteren starten…",
      dictationDisconnected: "Dicteren gestopt omdat de Gateway de verbinding verbrak.",
      dictationFailed: "Dicteren mislukt.",
      dictationFinalizing: "Dicteren afronden…",
      dictationFinalizationTimedOut:
        "Dicteren gestopt voordat het laatste gedeeltelijke transcript kon worden afgerond.",
      dictationProviderUnavailable: "Er is geen transcriptieprovider geconfigureerd voor dicteren.",
      dictationRecording: "Opnemen {elapsed}",
      dictationReleaseToInsert: "Laat los om dictaat in te voegen",
      ...
      selectedCameraUnavailable:
        "De geselecteerde camera is niet beschikbaar. Kies een andere camera of Systeemstandaard.",
      ...
      systemDefaultCamera: "Systeemstandaard",
      switchCamera: "Camera wisselen",
      turnCameraOff: "Camera uitschakelen",
      turnCameraOn: "Camera inschakelen",
    ...
    toolCards: {
      ...
      widgetExportRerender:
        "Deze widget moet opnieuw worden weergegeven om als afbeelding te exporteren.",
      widgetExportFailed: "Widgetexport mislukt. Probeer het opnieuw.",
      pinToDashboard: "Vastmaken aan dashboard",
      pinToDashboardPending: "Vastmaken…",
      pinnedToDashboard: "Vastgezet",
    ...
    backgroundTasks: {
      ...
      expandTask: "Details weergeven voor {title}",
      collapseTask: "Details verbergen voor {title}",
      detailLoading: "Taakdetails laden…",
      detailFailed: "Kan taakdetails niet laden.",
      prompt: "Prompt",
      output: "Uitvoer",
      promptUnavailable: "Prompt niet beschikbaar.",
      outputPending: "Nog geen uitvoer.",
    },
    sessionDiff: {
      title: "Wijzigingen",
    ...
    sessionDiscussion: {
      ...
      unavailable: "Deze discussie kan niet worden ingesloten.",
    },
    workspaceFiles: {
  ...
  cron: {
    ...
    form: {
      ...
      summaryEverySecondOne: "Wordt elke seconde uitgevoerd",
      ...
      summaryEverySeconds: "Wordt elke {amount} seconden uitgevoerd",
      ...
      script: "Script",
      readOnlyPayloadHelp:
        "Deze payload is buiten Control UI gemaakt. De inhoud blijft alleen-lezen en wordt behouden wanneer je andere wijzigingen opslaat.",
